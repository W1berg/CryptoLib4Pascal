...
type
  ...
  class var
    ...
    class function CalculateS(const r, k, s: TCryptoLibByteArray): TCryptoLibByteArray; static;

    class function CheckContextVar(const ctx: TCryptoLibCustomByteArrayBuffer; phflag: Byte): Boolean; static; inline;

    class function CheckPointVar(const p: TCryptoLibByteArray): Boolean; static; inline;

    class function CheckScalarVar(const s: TCryptoLibByteArray): Boolean; static; inline;

    class function Decode24(const bs: TCryptoLibByteArray; off: Int32): UInt32; static; inline;

    class function Decode32(const bs: TCryptoLibByteArray; off: Int32): UInt32; overload; static; inline;

    class procedure Decode32(const bs: TCryptoLibByteArray; bsOff: Int32; const n: TCryptoLibUInt32Array; nOff, nLen: Int32); overload; static; inline;

    class function DecodePointVar(const p: TCryptoLibByteArray; pOff: Int32; ANegate: Boolean; var r: TPointAffine): Boolean; static;

    class procedure DecodeScalar(const k: TCryptoLibByteArray; kOff: Int32; const n: TCryptoLibUInt32Array); static; inline;

    class procedure Dom2(const d: IDigest; phflag: Byte; const ctx: TCryptoLibCustomByteArrayBuffer); static; inline;

    class procedure Encode24(n: UInt32; const bs: TCryptoLibByteArray; off: Int32); static; inline;

    class procedure Encode32(n: UInt32; const bs: TCryptoLibByteArray; off: Int32); static; inline;

    class procedure Encode56(n: UInt64; const bs: TCryptoLibByteArray; off: Int32); static; inline;

    class function EncodePoint(var p: TPointAccum; const r: TCryptoLibByteArray; rOff: Int32): Int32; static;

    class function GetWindow4(const X: TCryptoLibUInt32Array; n: Int32): Int32; static; inline;

    class function GetWnaf(const n: TCryptoLibUInt32Array; width: Int32): TCryptoLibShortIntArray; static;

    class procedure ImplSign(const d: IDigest; const h, s, pk: TCryptoLibByteArray; pkOff: Int32; const ctx: TCryptoLibCustomByteArrayBuffer; phflag: Byte; const m: TCryptoLibByteArray; mOff, mLen: Int32; const sig: TCryptoLibByteArray; sigOff: Int32); overload; static;

    procedure ImplSign(const sk: TCryptoLibByteArray; skOff: Int32; const ctx: TCryptoLibCustomByteArrayBuffer; phflag: Byte; const m: TCryptoLibByteArray; mOff: Int32; mLen: Int32; const sig: TCryptoLibByteArray; sigOff: Int32); overload;

    procedure ImplSign(const sk: TCryptoLibByteArray; skOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx: TCryptoLibCustomByteArrayBuffer; phflag: Byte; const m: TCryptoLibByteArray; mOff: Int32; mLen: Int32; const sig: TCryptoLibByteArray; sigOff: Int32); overload;

    function ImplVerify(const sig: TCryptoLibByteArray; sigOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx: TCryptoLibCustomByteArrayBuffer; phflag: Byte; const m: TCryptoLibByteArray; mOff, mLen: Int32): Boolean;

    class procedure PointAdd(var p: TPointExt; var r: TPointAccum); overload; static;

    class procedure PointAdd(var p, r: TPointExt); overload; static;

    class procedure PointAddVar(negate: Boolean; var p: TPointExt; var r: TPointAccum); overload; static;

    class procedure PointAddVar(negate: Boolean; var p, q, r: TPointExt); overload; static;

    class procedure PointAddPrecomp(var p: TPointPrecomp; var r: TPointAccum); overload; static;

    class function PointCopy(var p: TPointAffine): TPointExt; overload; static; inline;

    class function PointCopy(var p: TPointAccum): TPointExt; overload; static; inline;

    class function PointCopy(var p: TPointExt): TPointExt; overload; static; inline;

    class procedure PointCopy(var p: TPointAffine; var r: TPointAccum); overload; static; inline;
    ...
    class procedure PointLookup(block, index: Int32; var p: TPointPrecomp); overload; static;

    class procedure PointLookup(const X: TCryptoLibUInt32Array; n: Int32; const table: TCryptoLibInt32Array; var r: TPointExt); overload; static;

    class procedure PointLookup(const table: TCryptoLibInt32Array; index: Int32; var r: TPointExt); overload; static;

    class function PointPrecomp(var p: TPointAffine; count: Int32): TCryptoLibInt32Array; static;

    class function PointPrecompVar(var p: TPointExt; count: Int32): TCryptoLibGenericArray<TPointExt>; static;

    class procedure PointSetNeutral(var p: TPointAccum); overload; static; inline;

    class procedure PointSetNeutral(var p: TPointExt); overload; static; inline;

    class procedure PruneScalar(const n: TCryptoLibByteArray; nOff: Int32; const r: TCryptoLibByteArray); static; inline;

    class function ReduceScalar(const n: TCryptoLibByteArray): TCryptoLibByteArray; static;

    class procedure ScalarMultBase(const k: TCryptoLibByteArray; var r: TPointAccum); static;

    class procedure ScalarMultBaseEncoded(const k, r: TCryptoLibByteArray; rOff: Int32); static; inline;

    class procedure ScalarMultStrausVar(const nb, np: TCryptoLibUInt32Array; var p: TPointAffine; var r: TPointAccum); static;

    class function ValidateDigestOutputSize(const ADigest: IDigest): TCryptoLibByteArray; static; inline;

    class function ConstructCustomByteArrayBufferContext(const AData: TCryptoLibByteArray; AIsNil: Boolean; ALength: Int32): TCryptoLibCustomByteArrayBuffer; static; inline;

    class function CheckPoint(const X, Y: TCryptoLibInt32Array): Int32; overload; static;
    class function CheckPoint(const X, Y, Z: TCryptoLibInt32Array): Int32; overload; static;
...
{$SCOPEDENUMS OFF}
  ...
  procedure GeneratePrivateKey(const random: ISecureRandom; const k: TCryptoLibByteArray); inline;

  procedure GeneratePublicKey(const sk: TCryptoLibByteArray; skOff: Int32; pk: TCryptoLibByteArray; pkOff: Int32); virtual;

  class procedure Precompute(); static;

  // NOTE: Only for use by X25519
  class procedure ScalarMultBaseYZ(const k: TCryptoLibByteArray; kOff: Int32; const Y, Z: TCryptoLibInt32Array); static; inline;

  procedure Sign(const sk: TCryptoLibByteArray; skOff: Int32; const m: TCryptoLibByteArray; mOff, mLen: Int32; const sig: TCryptoLibByteArray; sigOff: Int32); overload;

  procedure Sign(const sk: TCryptoLibByteArray; skOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const m: TCryptoLibByteArray; mOff, mLen: Int32; const sig: TCryptoLibByteArray; sigOff: Int32); overload;

  procedure Sign(const sk: TCryptoLibByteArray; skOff: Int32; const ctx, m: TCryptoLibByteArray; mOff, mLen: Int32; const sig: TCryptoLibByteArray; sigOff: Int32); overload;

  procedure Sign(const sk: TCryptoLibByteArray; skOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx, m: TCryptoLibByteArray; mOff, mLen: Int32; const sig: TCryptoLibByteArray; sigOff: Int32); overload;

  procedure SignPreHash(const sk: TCryptoLibByteArray; skOff: Int32; const ctx, ph: TCryptoLibByteArray; phOff: Int32; const sig: TCryptoLibByteArray; sigOff: Int32); overload;

  procedure SignPreHash(const sk: TCryptoLibByteArray; skOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx, ph: TCryptoLibByteArray; phOff: Int32; const sig: TCryptoLibByteArray; sigOff: Int32); overload;

  procedure SignPreHash(const sk: TCryptoLibByteArray; skOff: Int32; const ctx: TCryptoLibByteArray; const ph: IDigest; const sig: TCryptoLibByteArray; sigOff: Int32); overload;

  procedure SignPreHash(const sk: TCryptoLibByteArray; skOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx: TCryptoLibByteArray; const ph: IDigest; const sig: TCryptoLibByteArray; sigOff: Int32); overload;

  function Verify(const sig: TCryptoLibByteArray; sigOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const m: TCryptoLibByteArray; mOff, mLen: Int32): Boolean; overload;

  function Verify(const sig: TCryptoLibByteArray; sigOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx, m: TCryptoLibByteArray; mOff, mLen: Int32): Boolean; overload;

  function VerifyPreHash(const sig: TCryptoLibByteArray; sigOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx, ph: TCryptoLibByteArray; phOff: Int32): Boolean; overload;

  function VerifyPreHash(const sig: TCryptoLibByteArray; sigOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx: TCryptoLibByteArray; const ph: IDigest): Boolean; overload;

  class procedure ScalarMult(const k: TCryptoLibByteArray; var p: TPointAffine; var r: TPointAccum); static;
...
begin
  ...
  FDom2Prefix := TCryptoLibByteArray.Create(83, 105, 103, 69, 100, 50, 53, 53, 49, 57, 32, 110, 111, 32, 69, 100, 50, 53, 53, 49, 57, 32, 99, 111, 108, 108, 105, 115, 105, 111, 110, 115);

  FP := TCryptoLibUInt32Array.Create($FFFFFFED, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $7FFFFFFF);
  FL := TCryptoLibUInt32Array.Create($5CF5D3ED, $5812631A, $A2F79CD6, $14DEF9DE, $00000000, $00000000, $00000000, $10000000);

  FB_x := TCryptoLibInt32Array.Create($0325D51A, $018B5823, $007B2C95, $0304A92D, $00D2598E, $01D6DC5C, $01388C7F, $013FEC0A, $029E6B72, $0042D26D);
  FB_y := TCryptoLibInt32Array.Create($02666658, $01999999, $00666666, $03333333, $00CCCCCC, $02666666, $01999999, $00666666, $03333333, $00CCCCCC);
  FC_d := TCryptoLibInt32Array.Create($035978A3, $02D37284, $018AB75E, $026A0A0E, $0000E014, $0379E898, $01D01E5D, $01E738CC, $03715B7F, $00A406D9);
  FC_d2 := TCryptoLibInt32Array.Create($02B2F159, $01A6E509, $01156EBD, $00D4141D, $0001C029, $02F3D130, $03A03CBB, $01CE7198, $02E2B6FF, $00480DB3);
  FC_d4 := TCryptoLibInt32Array.Create($0165E2B2, $034DCA13, $002ADD7A, $01A8283B, $00038052, $01E7A260, $03407977, $019CE331, $01C56DFF, $00901B67);
...
class function TEd25519.Decode32(const bs: TCryptoLibByteArray; off: Int32): UInt32;
begin
  // UInt32 n := bs[off];
  // System.Inc(off);
...
class procedure TEd25519.Decode32(const bs: TCryptoLibByteArray; bsOff: Int32; const n: TCryptoLibUInt32Array; nOff, nLen: Int32);
begin
  // int32 i;
  ...
  // end;
  TConverters.le32_copy(PByte(bs), bsOff * System.SizeOf(Byte), PCardinal(n), nOff * System.SizeOf(UInt32), nLen * System.SizeOf(UInt32));
end;

class procedure TEd25519.DecodeScalar(const k: TCryptoLibByteArray; kOff: Int32; const n: TCryptoLibUInt32Array);
begin
  Decode32(k, kOff, n, 0, ScalarUints);
end;

class procedure TEd25519.Encode24(n: UInt32; const bs: TCryptoLibByteArray; off: Int32);
begin
  bs[off] := Byte(n);
  System.Inc(off);
  bs[off] := Byte(n shr 8);
...
class procedure TEd25519.Encode32(n: UInt32; const bs: TCryptoLibByteArray; off: Int32);
begin
  // bs[  off] := Byte(n      );
  // System.Inc(off);
  // bs[off] := Byte(n shr  8);
...
class procedure TEd25519.Encode56(n: UInt64; const bs: TCryptoLibByteArray; off: Int32);
begin
  Encode32(UInt32(n), bs, off);
  Encode24(UInt32(n shr 32), bs, off + 4);
end;

class function TEd25519.CalculateS(const r, k, s: TCryptoLibByteArray): TCryptoLibByteArray;
var
...
class function TEd25519.CheckContextVar(const ctx: TCryptoLibCustomByteArrayBuffer; phflag: Byte): Boolean;
begin
  result := ((ctx.IsNil) and (phflag = $00)) or ((not ctx.IsNil) and (ctx.Length < 256));
end;
...
class function TEd25519.Decode24(const bs: TCryptoLibByteArray; off: Int32): UInt32;
var
  n: UInt32;
begin
  n := bs[off];
...
class procedure TEd25519.PointLookup(const table: TCryptoLibInt32Array; index: Int32; var r: TPointExt);
var
  off: Int32;
begin
...
class function TEd25519.GetWindow4(const X: TCryptoLibUInt32Array; n: Int32): Int32;
var
  W, b: Int32;
begin
  W := TBits.Asr32(n, 3);
...
class procedure TEd25519.PointLookup(const X: TCryptoLibUInt32Array; n: Int32; const table: TCryptoLibInt32Array; var r: TPointExt);
var
...
class function TEd25519.DecodePointVar(const p: TCryptoLibByteArray; pOff: Int32; ANegate: Boolean; var r: TPointAffine): Boolean;
var
...
class procedure TEd25519.Dom2(const d: IDigest; phflag: Byte; const ctx: TCryptoLibCustomByteArrayBuffer);
begin
...
class function TEd25519.EncodePoint(var p: TPointAccum; const r: TCryptoLibByteArray; rOff: Int32): Int32;
var
...
begin
  ...
  r[rOff + PointBytes - 1] := r[rOff + PointBytes - 1] or Byte((X[0] and 1) shl 7);
end;

procedure TEd25519.GeneratePrivateKey(const random: ISecureRandom; const k: TCryptoLibByteArray);
begin
  random.NextBytes(k);
end;

class procedure TEd25519.PruneScalar(const n: TCryptoLibByteArray; nOff: Int32; const r: TCryptoLibByteArray);
begin
...
class procedure TEd25519.ScalarMultBaseEncoded(const k, r: TCryptoLibByteArray; rOff: Int32);
var
  p: TPointAccum;
begin
...
procedure TEd25519.GeneratePublicKey(const sk: TCryptoLibByteArray; skOff: Int32; pk: TCryptoLibByteArray; pkOff: Int32);
var
  d: IDigest;
...
class function TEd25519.GetWnaf(const n: TCryptoLibUInt32Array; width: Int32): TCryptoLibShortIntArray;
var
  T: TCryptoLibUInt32Array;
...
procedure TEd25519.ImplSign(const sk: TCryptoLibByteArray; skOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx: TCryptoLibCustomByteArrayBuffer; phflag: Byte; const m: TCryptoLibByteArray; mOff, mLen: Int32; const sig: TCryptoLibByteArray; sigOff: Int32);
var
  d: IDigest;
  h, s: TCryptoLibByteArray;
begin
...
procedure TEd25519.ImplSign(const sk: TCryptoLibByteArray; skOff: Int32; const ctx: TCryptoLibCustomByteArrayBuffer; phflag: Byte; const m: TCryptoLibByteArray; mOff, mLen: Int32; const sig: TCryptoLibByteArray; sigOff: Int32);
var
  d: IDigest;
...
class procedure TEd25519.ImplSign(const d: IDigest; const h, s, pk: TCryptoLibByteArray; pkOff: Int32; const ctx: TCryptoLibCustomByteArrayBuffer; phflag: Byte; const m: TCryptoLibByteArray; mOff, mLen: Int32; const sig: TCryptoLibByteArray; sigOff: Int32);
var
...
begin
  ...
  System.Move(bigS[0], sig[sigOff + PointBytes], ScalarBytes * System.SizeOf(Byte));
end;

function TEd25519.ImplVerify(const sig: TCryptoLibByteArray; sigOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx: TCryptoLibCustomByteArrayBuffer; phflag: Byte; const m: TCryptoLibByteArray; mOff, mLen: Int32): Boolean;
var
...
begin
  ...
  s := TArrayUtils.CopyOfRange(sig, sigOff + PointBytes, sigOff + SignatureSize);
  ...
  result := (EncodePoint(pR, check, 0) <> 0) and (TArrayUtils.ConstantTimeAreEqual(check, r));
end;

class procedure TEd25519.PointAddPrecomp(var p: TPointPrecomp; var r: TPointAccum);
var
...
var
  bigA, bigB, bigC, bigD, bigE, bigF, bigG, bigH, c, d, F, G: TCryptoLibInt32Array;
begin
  bigA := TX25519Field.Create();
  bigB := TX25519Field.Create();
  bigC := TX25519Field.Create();
...
class procedure TEd25519.PointAddVar(negate: Boolean; var p: TPointExt; var r: TPointAccum);
var
  bigA, bigB, bigC, bigD, bigE, bigF, bigG, bigH, c, d, F, G: TCryptoLibInt32Array;
begin
  bigA := TX25519Field.Create();
...
class function TEd25519.PointPrecomp(var p: TPointAffine; count: Int32): TCryptoLibInt32Array;
var
  q, d: TPointExt;
...
class function TEd25519.PointPrecompVar(var p: TPointExt; count: Int32): TCryptoLibGenericArray<TPointExt>;
var
  d: TPointExt;
...
class function TEd25519.ReduceScalar(const n: TCryptoLibByteArray): TCryptoLibByteArray;
var
  x00, x01, x02, x03, x04, x05, x06, x07, x08, x09, x10, x11, x12, x13, x14, x15, x16, x17, x18, T: Int64;
begin
...
class procedure TEd25519.ScalarMult(const k: TCryptoLibByteArray; var p: TPointAffine; var r: TPointAccum);
var
  n: TCryptoLibUInt32Array;
  table: TCryptoLibInt32Array;
  q: TPointExt;
...
class procedure TEd25519.ScalarMultBase(const k: TCryptoLibByteArray; var r: TPointAccum);
var
  n: TCryptoLibUInt32Array;
  W, c1, c2: UInt32;
...
class procedure TEd25519.ScalarMultBaseYZ(const k: TCryptoLibByteArray; kOff: Int32; const Y, Z: TCryptoLibInt32Array);
var
...
class procedure TEd25519.ScalarMultStrausVar(const nb, np: TCryptoLibUInt32Array; var p: TPointAffine; var r: TPointAccum);
var
...
class function TEd25519.ValidateDigestOutputSize(const ADigest: IDigest): TCryptoLibByteArray;
begin
...
class function TEd25519.ConstructCustomByteArrayBufferContext(const AData: TCryptoLibByteArray; AIsNil: Boolean; ALength: Int32): TCryptoLibCustomByteArrayBuffer;
begin
...
procedure TEd25519.Sign(const sk: TCryptoLibByteArray; skOff: Int32; const m: TCryptoLibByteArray; mOff, mLen: Int32; const sig: TCryptoLibByteArray; sigOff: Int32);
var
  phflag: Byte;
begin
  phflag := $00;
...
procedure TEd25519.Sign(const sk: TCryptoLibByteArray; skOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const m: TCryptoLibByteArray; mOff, mLen: Int32; const sig: TCryptoLibByteArray; sigOff: Int32);
var
  phflag: Byte;
begin
  phflag := $00;
  ImplSign(sk, skOff, pk, pkOff, EmptyBytesNil, phflag, m, mOff, mLen, sig, sigOff);
end;

procedure TEd25519.Sign(const sk: TCryptoLibByteArray; skOff: Int32; const ctx, m: TCryptoLibByteArray; mOff, mLen: Int32; const sig: TCryptoLibByteArray; sigOff: Int32);
var
  phflag: Byte;
...
procedure TEd25519.Sign(const sk: TCryptoLibByteArray; skOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx, m: TCryptoLibByteArray; mOff, mLen: Int32; const sig: TCryptoLibByteArray; sigOff: Int32);
var
  phflag: Byte;
  LCtx: TCryptoLibCustomByteArrayBuffer;
begin
...
procedure TEd25519.SignPreHash(const sk: TCryptoLibByteArray; skOff: Int32; const ctx, ph: TCryptoLibByteArray; phOff: Int32; const sig: TCryptoLibByteArray; sigOff: Int32);
var
  phflag: Byte;
  LCtx: TCryptoLibCustomByteArrayBuffer;
begin
...
procedure TEd25519.SignPreHash(const sk: TCryptoLibByteArray; skOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx, ph: TCryptoLibByteArray; phOff: Int32; const sig: TCryptoLibByteArray; sigOff: Int32);
var
  phflag: Byte;
  LCtx: TCryptoLibCustomByteArrayBuffer;
begin
  phflag := $01;
  LCtx := ConstructCustomByteArrayBufferContext(ctx, false, System.Length(ctx));
  ImplSign(sk, skOff, pk, pkOff, LCtx, phflag, ph, phOff, PreHashSize, sig, sigOff);
end;

procedure TEd25519.SignPreHash(const sk: TCryptoLibByteArray; skOff: Int32; const ctx: TCryptoLibByteArray; const ph: IDigest; const sig: TCryptoLibByteArray; sigOff: Int32);
var
  phflag: Byte;
...
procedure TEd25519.SignPreHash(const sk: TCryptoLibByteArray; skOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx: TCryptoLibByteArray; const ph: IDigest; const sig: TCryptoLibByteArray; sigOff: Int32);
var
  phflag: Byte;
  m: TCryptoLibByteArray;
  LCtx: TCryptoLibCustomByteArrayBuffer;
begin
  ...
  m := ValidateDigestOutputSize(ph);
  LCtx := ConstructCustomByteArrayBufferContext(ctx, false, System.Length(ctx));
  ImplSign(sk, skOff, pk, pkOff, LCtx, phflag, m, 0, System.Length(m), sig, sigOff);
end;

function TEd25519.Verify(const sig: TCryptoLibByteArray; sigOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const m: TCryptoLibByteArray; mOff, mLen: Int32): Boolean;
var
  phflag: Byte;
begin
  phflag := $00;
  result := ImplVerify(sig, sigOff, pk, pkOff, EmptyBytesNil, phflag, m, mOff, mLen);
end;

function TEd25519.Verify(const sig: TCryptoLibByteArray; sigOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx, m: TCryptoLibByteArray; mOff, mLen: Int32): Boolean;
var
  phflag: Byte;
  LCtx: TCryptoLibCustomByteArrayBuffer;
begin
...
function TEd25519.VerifyPreHash(const sig: TCryptoLibByteArray; sigOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx, ph: TCryptoLibByteArray; phOff: Int32): Boolean;
var
  phflag: Byte;
  LCtx: TCryptoLibCustomByteArrayBuffer;
begin
  phflag := $01;
  LCtx := ConstructCustomByteArrayBufferContext(ctx, false, System.Length(ctx));
  result := ImplVerify(sig, sigOff, pk, pkOff, LCtx, phflag, ph, phOff, PreHashSize);
end;

function TEd25519.VerifyPreHash(const sig: TCryptoLibByteArray; sigOff: Int32; const pk: TCryptoLibByteArray; pkOff: Int32; const ctx: TCryptoLibByteArray; const ph: IDigest): Boolean;
var
  phflag: Byte;
  m: TCryptoLibByteArray;
  LCtx: TCryptoLibCustomByteArrayBuffer;
begin
  ...
  m := ValidateDigestOutputSize(ph);
  LCtx := ConstructCustomByteArrayBufferContext(ctx, false, System.Length(ctx));
  result := ImplVerify(sig, sigOff, pk, pkOff, LCtx, phflag, m, 0, System.Length(m));
end;
