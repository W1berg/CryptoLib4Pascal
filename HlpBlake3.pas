...
{$REGION 'Consts'}
  const
    ...
    IV: array [0 .. 7] of UInt32 = ($6A09E667, $BB67AE85, $3C6EF372, $A54FF53A, $510E527F, $9B05688C, $1F83D9AB, $5BE0CD19);
{$ENDREGION}
  ...
  type
    ...
    public
      class function CreateBlake3Node(const ACV, ABlock: THashLibUInt32Array; ACounter: UInt64; ABlockLen, AFlags: UInt32): TBlake3Node; static;

      class function ParentNode(const ALeft, ARight, AKey: THashLibUInt32Array; AFlags: UInt32): TBlake3Node; static;
    end;
  ...
  type
    ...
    public
      class function CreateBlake3ChunkState(const AIV: THashLibUInt32Array; AChunkCounter: UInt64; AFlags: UInt32): TBlake3ChunkState; static;
    end;
  ...
  type
    ...
    var
      ...
      procedure Read(const ADestination: THashLibByteArray; ADestinationOffset, AOutputLength: UInt64);
  ...
  var
    ...
    procedure InternalDoOutput(const ADestination: THashLibByteArray; ADestinationOffset, AOutputLength: UInt64); inline;

    constructor Create(AHashSize: Int32; const AKey: THashLibByteArray); overload;

    constructor CreateInternal(AHashSize: Int32; const AKeyWords: THashLibUInt32Array; AFlags: UInt32);

  public
    constructor Create(AHashSize: THashSize = THashSize.hsHashSize256; const AKey: THashLibByteArray = nil); overload;
    ...
    class procedure DeriveKey(const ASrcKey, ACtx, ASubKey: THashLibByteArray); static;
...
type
  ...
  public
    ...
    constructor Create(AHashSize: Int32; const AKeyWords: THashLibUInt32Array; AFlags: UInt32); overload;
...
class function TBlake3.TBlake3Node.CreateBlake3Node(const ACV, ABlock: THashLibUInt32Array; ACounter: UInt64; ABlockLen, AFlags: UInt32): TBlake3Node;
begin
  Result := DefaultBlake3Node();
  System.Move(ACV[0], Result.CV, System.Length(ACV) * System.SizeOf(UInt32));
  System.Move(ABlock[0], Result.Block, System.Length(ABlock) * System.SizeOf(UInt32));
...
class function TBlake3.TBlake3Node.ParentNode(const ALeft, ARight, AKey: THashLibUInt32Array; AFlags: UInt32): TBlake3Node;
var
  LBlockWords: THashLibUInt32Array;
begin
  LBlockWords := TArrayUtils.Concatenate(ALeft, ARight);
  Result := TBlake3Node.CreateBlake3Node(AKey, LBlockWords, 0, BlockSizeInBytes, AFlags or flagParent);
end;

{ TBlake3.TBlake3ChunkState }

class function TBlake3.TBlake3ChunkState.DefaultBlake3ChunkState: TBlake3ChunkState;
begin
...
class function TBlake3.TBlake3ChunkState.CreateBlake3ChunkState(const AIV: THashLibUInt32Array; AChunkCounter: UInt64; AFlags: UInt32): TBlake3ChunkState;
begin
  Result := DefaultBlake3ChunkState;
  System.Move(AIV[0], Result.N.CV[0], System.Length(AIV) * System.SizeOf(UInt32));
...
begin
  ...
  TArrayUtils.FillMemory(@(Block[BlockLen]), (System.Length(Block) - BlockLen) * System.SizeOf(Byte), 0);
...
class function TBlake3.TBlake3OutputReader.DefaultBlake3OutputReader: TBlake3OutputReader;
begin
...
procedure TBlake3.TBlake3OutputReader.Read(const ADestination: THashLibByteArray; ADestinationOffset, AOutputLength: UInt64);
var
...
constructor TBlake3.CreateInternal(AHashSize: Int32; const AKeyWords: THashLibUInt32Array; AFlags: UInt32);
var
  LIdx: Int32;
begin
...
begin
  ...
  begin
    ...
    begin
      raise EArgumentOutOfRangeHashLibException.CreateResFmt(@SInvalidKeyLength, [KeyLengthInBytes, LKeyLength]);
    end;
...
procedure TBlake3.InternalDoOutput(const ADestination: THashLibByteArray; ADestinationOffset, AOutputLength: UInt64);
begin
...
begin
  ...
  begin
    TBlake3Node.ParentNode(FStack[LIdx], ACV, LKey, LFlags).ChainingValue(LPtrCV);
    System.Inc(LIdx);
  end;
...
procedure TBlake3.TransformBytes(const AData: THashLibByteArray; AIndex, ADataLength: Int32);
var
  LPtrAData: PByte;
...
begin
  ...
  begin
    ...
    begin
      ...
      FCS := TBlake3ChunkState.CreateBlake3ChunkState(FKey, FCS.ChunkCounter() + 1, FFlags);
    end;
...
class procedure TBlake3.DeriveKey(const ASrcKey, ACtx, ASubKey: THashLibByteArray);
const
...
begin
  ...
  LDerivationIV := (TBlake3.CreateInternal(derivationIVLen, LIVWords, flagDeriveKeyContext) as IHash).ComputeBytes(ACtx).GetBytes();
  TConverters.le32_copy(PByte(LDerivationIV), 0, PCardinal(LIVWords), 0, KeyLengthInBytes);
...
constructor TBlake3XOF.Create(AHashSize: Int32; const AKeyWords: THashLibUInt32Array; AFlags: UInt32);
begin
  inherited CreateInternal(AHashSize, AKeyWords, AFlags);
  FFinalized := False;
end;

procedure TBlake3XOF.DoOutput(const ADestination: THashLibByteArray; ADestinationOffset, AOutputLength: UInt64);
begin
...
procedure TBlake3XOF.TransformBytes(const AData: THashLibByteArray; AIndex, ADataLength: Int32);
begin
  if FFinalized then
  begin
