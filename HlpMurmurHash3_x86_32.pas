...
type
  ...
  TMurmurHash3_x86_32 = class sealed(THash, IHash32, IHashWithKey, ITransformBlock)
...
procedure TMurmurHash3_x86_32.TransformBytes(const AData: THashLibByteArray; AIndex, ALength: Int32);
var
