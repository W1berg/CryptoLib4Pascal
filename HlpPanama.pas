...
begin
  ...
  TConverters.le32_copy(PCardinal(FState), 9 * System.SizeOf(UInt32), PByte(result), 0, System.Length(result));
end;
...
procedure TPanama.TransformBlock(AData: PByte; ADataLength: Int32; AIndex: Int32);
var
