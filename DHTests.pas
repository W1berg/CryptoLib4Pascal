...
type
  ...
  var
    ...
    function GetDHBasicKeyPairGenerator(const g, p: TBigInteger; privateValueSize: Int32): IDHBasicKeyPairGenerator;

    function GetDHKeyPairGenerator(const g, p: TBigInteger): IDHKeyPairGenerator;

    procedure DoTestDH(size: Int32; const g, p: TBigInteger);

    procedure DoTestDHBasic(size, privateValueSize: Int32; const g, p: TBigInteger);

    procedure DoCheckKeySize(privateValueSize: Int32; const priv: IDHPrivateKeyParameters);
...
function TTestDH.GetDHBasicKeyPairGenerator(const g, p: TBigInteger; privateValueSize: Int32): IDHBasicKeyPairGenerator;
var
  dhParams: IDHParameters;
  dhkgParams: IDHKeyGenerationParameters;
  kpGen: IDHBasicKeyPairGenerator;
begin
  dhParams := TDHParameters.Create(p, g, default (TBigInteger), privateValueSize);

  dhkgParams := TDHKeyGenerationParameters.Create(TSecureRandom.Create() as ISecureRandom, dhParams);
...
function TTestDH.GetDHKeyPairGenerator(const g, p: TBigInteger): IDHKeyPairGenerator;
var
  dhParams: IDHParameters;
  dhkgParams: IDHKeyGenerationParameters;
...
procedure TTestDH.DoCheckKeySize(privateValueSize: Int32; const priv: IDHPrivateKeyParameters);
begin
  if (privateValueSize <> 0) then
  begin
    if (priv.X.BitLength <> privateValueSize) then
    begin
      Fail(Format('limited key check failed for key size %d', [privateValueSize]));
    end;
  end;
end;
...
procedure TTestDH.DoTestDHBasic(size, privateValueSize: Int32; const g, p: TBigInteger);
var
  kpGen: IDHBasicKeyPairGenerator;
  pair: IAsymmetricCipherKeyPair;
  pu1, pu2: IDHPublicKeyParameters;
...
begin
  ...
  // generate second pair
  //
  dhkgParams := TDHKeyGenerationParameters.Create(TSecureRandom.Create() as ISecureRandom, pu1.Parameters);
  ...
  e1.Init(TParametersWithRandom.Create(pv1, TSecureRandom.Create() as ISecureRandom) as IParametersWithRandom);
  e2.Init(TParametersWithRandom.Create(pv2, TSecureRandom.Create() as ISecureRandom) as IParametersWithRandom);
...
begin
  ...
  try
    ...
    dh.CalculateAgreement(kpGen768.GenerateKeyPair().Public as IDHPublicKeyParameters, TBigInteger.ValueOf(100));
  ...
  try
    ...
    dhBasic.CalculateAgreement(kpBasicGen768.GenerateKeyPair().Public as IDHPublicKeyParameters);
...
begin
  inherited;
  Fg512 := TBigInteger.Create('153D5D6172ADB43045B68AE8E1DE1070B6137005686D29D3D73A7749199681EE5B212C9B96BFDCFA5B20CD5E3FD2044895D609CF9B410B7A0F12CA1CB9A428CC', 16);
  Fp512 := TBigInteger.Create('9494FEC095F3B85EE286542B3836FC81A5DD0A0349B4C239DD38744D488CF8E31DB8BCB7D33B41ABB9E5A33CCA9144B1CEF332C94BF0573BF047A3ACA98CDF3B', 16);

  Fg768 := TBigInteger.Create('7C240073C1316C621DF461B71EBB0CDCC90A6E5527E5E126633D131F87461C4DC4AFC60C2CB0F053B6758871489A69613E2A8B4C8ACDE23954C08C81CBD36132CFD64D69E4ED9F8E51ED6E516297206672D5C0A69135DF0A5DCF010D289A9CA1', 16);
  Fp768 := TBigInteger.Create('8C9DD223DEBED1B80103B8B309715BE009D48860ED5AE9B9D5D8159508EFD802E3AD4501A7F7E1CFEC78844489148CD72DA24B21EDDD01AA624291C48393E277CFC529E37075ECCEF957F3616F962D15B44AEAB4039D01B817FDE9EAA12FD73F', 16);

  Fg1024 := TBigInteger.Create('1DB17639CDF96BC4EABBA19454F0B7E5BD4E14862889A725C96EB61048DCD676CEB303D586E30F060DBAFD8A571A39C4D823982117DA5CC4E0F89C77388B7A08896362429B94A18A327604EB7FF227BFFBC83459ADE299E5' + '7B5F77B50FB045250934938EFA145511166E3197373E1B5B1E52DE713EB49792BEDDE722C6717ABF', 16);
  Fp1024 := TBigInteger.Create('A00E283B3C624E5B2B4D9FBC2653B5185D99499B00FD1BF244C6F0BB817B4D1C451B2958D62A0F8A38CAEF059FB5ECD25D75ED9AF403F5B5BDAB97A642902F824E3C13789FED95FA106DDFE0FF4A707C85E2EB77D49E68F2' + '808BCEA18CE128B178CD287C6BC00EFA9A1AD2A673FE0DCEACE53166F75B81D6709D5F8AF7C66BB7', 16);
