...
type
  ...
  public
    ...
    class function GetRandom(size: integer; onlyLettersAndDigits: boolean): string; static;
...
class function TStringGenerator.GetRandom(size: integer; onlyLettersAndDigits: boolean): string;
var
  i: integer;
...
begin
  ...
  begin
    ...
    while i < size do
    begin
      tempResult := tempResult + (lettersAndDigits[Random(Length(lettersAndDigits)) + 1]);
      Inc(i);
    end;
    Result := tempResult;
  end
