...
type
  ...
  class var
    ...
    class function ConstructBigPrimeProducts(const primeProducts: TCryptoLibInt32Array): TCryptoLibGenericArray<TBigInteger>; static;
  ...
  public
    ...
    /// </para>
    /// </summary>
    class function GenerateSafePrimes(size, certainty: Int32; const random: ISecureRandom): TCryptoLibGenericArray<TBigInteger>; static;
...
{$IFNDEF _FIXINSIGHT_}
    ...
    /// </para>
    /// </summary>
    class function SelectGenerator(const p, q: TBigInteger; const random: ISecureRandom): TBigInteger; static;
{$ENDIF}
  end;
...
class function TDHParametersHelper.ConstructBigPrimeProducts(const primeProducts: TCryptoLibInt32Array): TCryptoLibGenericArray<TBigInteger>;
var
...
class function TDHParametersHelper.GenerateSafePrimes(size, certainty: Int32; const random: ISecureRandom): TCryptoLibGenericArray<TBigInteger>;
var
  p, q: TBigInteger;
...
begin
  ...
  begin
    ...
    begin
      ...
      if ((certainty > 2) and (not q.RabinMillerTest(certainty - 2, random, True))) then
      begin
        continue;
      end;
...
class function TDHParametersHelper.SelectGenerator(const p, q: TBigInteger; const random: ISecureRandom): TBigInteger;
var
