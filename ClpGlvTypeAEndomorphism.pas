...
type
  TGlvTypeAEndomorphism = class(TInterfacedObject, IECEndomorphism, IGlvEndomorphism, IGlvTypeAEndomorphism)
  ...
  public
    constructor Create(const curve: IECCurve; const parameters: IGlvTypeAParameters);

    function DecomposeScalar(const k: TBigInteger): TCryptoLibGenericArray<TBigInteger>; virtual;
...
constructor TGlvTypeAEndomorphism.Create(const curve: IECCurve; const parameters: IGlvTypeAParameters);
begin
  inherited Create();
  (*
  ...
  *)
  ...
  FPointMap := TScaleYNegateXPointMap.Create(curve.FromBigInteger(parameters.I));
end;

function TGlvTypeAEndomorphism.DecomposeScalar(const k: TBigInteger): TCryptoLibGenericArray<TBigInteger>;
begin
