...
type
  ...
  TSuperFast = class sealed(TMultipleTransformNonBlock, IHash32, ITransformBlock)
...
function TSuperFast.ComputeAggregatedBytes(const AData: THashLibByteArray): IHashResult;
var
