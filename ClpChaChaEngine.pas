...
type
  ...
  strict private
    ...
    class procedure ChaChaCore(rounds: Int32; const input, x: TCryptoLibUInt32Array); static;
...
class procedure TChaChaEngine.ChaChaCore(rounds: Int32; const input, x: TCryptoLibUInt32Array);
var
...
begin
  ...
  begin
    ...
    // Key
    TConverters.le32_copy(PByte(keyBytes), 0, PCardinal(FEngineState), 4 * System.SizeOf(UInt32), 4 * System.SizeOf(UInt32));
    TConverters.le32_copy(PByte(keyBytes), (System.Length(keyBytes) - 16) * System.SizeOf(Byte), PCardinal(FEngineState), 8 * System.SizeOf(UInt32), 4 * System.SizeOf(UInt32));
  end;

  // IV
  TConverters.le32_copy(PByte(ivBytes), 0, PCardinal(FEngineState), 14 * System.SizeOf(UInt32), 2 * System.SizeOf(UInt32));
