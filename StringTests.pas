...
var
  ...
  LEncoding: TEncoding;
begin
  bs := TDerBitString.Create(TBytes.Create($01, $23, $45, $67, $89, $AB, $CD, $EF));
  ...
  bs := TDerBitString.Create(TBytes.Create($FE, $DC, $BA, $98, $76, $54, $32, $10));
  ...
  us := TDerUniversalString.Create(TBytes.Create($01, $23, $45, $67, $89, $AB, $CD, $EF));
  ...
  us := TDerUniversalString.Create(TBytes.Create($FE, $DC, $BA, $98, $76, $54, $32, $10));
