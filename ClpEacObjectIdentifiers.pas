...
type
  ...
  class var
    ...
    FIsBooted: Boolean;
    Fbsi_de, Fid_TA, Fid_TA_ECDSA, Fid_TA_ECDSA_SHA_1, Fid_TA_ECDSA_SHA_224, Fid_TA_ECDSA_SHA_256, Fid_TA_ECDSA_SHA_384, Fid_TA_ECDSA_SHA_512: IDerObjectIdentifier;
  ...
  public
    ...
    class property id_TA_ECDSA_SHA_1: IDerObjectIdentifier read Getid_TA_ECDSA_SHA_1;
    class property id_TA_ECDSA_SHA_224: IDerObjectIdentifier read Getid_TA_ECDSA_SHA_224;
    class property id_TA_ECDSA_SHA_256: IDerObjectIdentifier read Getid_TA_ECDSA_SHA_256;
    class property id_TA_ECDSA_SHA_384: IDerObjectIdentifier read Getid_TA_ECDSA_SHA_384;
    class property id_TA_ECDSA_SHA_512: IDerObjectIdentifier read Getid_TA_ECDSA_SHA_512;
...
class function TEacObjectIdentifiers.Getid_TA_ECDSA_SHA_224: IDerObjectIdentifier;
begin
  result := Fid_TA_ECDSA_SHA_224;
end;

class function TEacObjectIdentifiers.Getid_TA_ECDSA_SHA_256: IDerObjectIdentifier;
begin
  result := Fid_TA_ECDSA_SHA_256;
end;

class function TEacObjectIdentifiers.Getid_TA_ECDSA_SHA_384: IDerObjectIdentifier;
begin
  result := Fid_TA_ECDSA_SHA_384;
end;

class function TEacObjectIdentifiers.Getid_TA_ECDSA_SHA_512: IDerObjectIdentifier;
begin
