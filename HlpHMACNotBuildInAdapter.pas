...
type
  ...
  THMACNotBuildInAdapter = class sealed(THash, IHMAC, IHMACNotBuildIn, ICrypto, ICryptoNotBuildIn)
  ...
  var
    ...
    constructor Create(const AUnderlyingHash: IHash; const AHMACKey: THashLibByteArray);
  ...
  public
    ...
    class function CreateHMAC(const AHash: IHash; const AHMACKey: THashLibByteArray): IHMAC; static;
...
constructor THMACNotBuildInAdapter.Create(const AUnderlyingHash: IHash; const AHMACKey: THashLibByteArray);
begin
...
procedure THMACNotBuildInAdapter.TransformBytes(const AData: THashLibByteArray; AIndex, ALength: Int32);
begin
{$IFDEF DEBUG}
...
class function THMACNotBuildInAdapter.CreateHMAC(const AHash: IHash; const AHMACKey: THashLibByteArray): IHMAC;
begin
