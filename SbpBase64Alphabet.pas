...
type
  ...
  strict private
  const
    B64CharacterSet: string = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789';

    class var

      FDefault, FDefaultNoPadding, FUrlEncoding, FXmlEncoding, FRegExEncoding, FFileEncoding: IBase64Alphabet;
  ...
  public
    ...
    constructor Create(const alphabet: string; plusChar, slashChar: Char; PaddingEnabled: Boolean);
...
constructor TBase64Alphabet.Create(const alphabet: string; plusChar, slashChar: Char; PaddingEnabled: Boolean);
var
  newChars: string;
begin
