...
type
  ...
  /// </summary>
  TAsymmetricCipherKeyPair = class sealed(TInterfacedObject, IAsymmetricCipherKeyPair)
  ...
  public
    ...
    /// </param>
    constructor Create(const publicParameter, privateParameter: IAsymmetricKeyParameter);
...
constructor TAsymmetricCipherKeyPair.Create(const publicParameter, privateParameter: IAsymmetricKeyParameter);
begin
