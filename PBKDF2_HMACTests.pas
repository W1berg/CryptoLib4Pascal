...
begin
  ...
  ByteCount := 24;
  PBKDF2_HMACInstance := TKDF.TPBKDF2_HMAC.CreatePBKDF2_HMAC(THashFactory.TCrypto.CreateSHA1(), Password, Salt, 2048);
end;
...
begin
  ...
  ByteCount := 32;
  PBKDF2_HMACInstance := TKDF.TPBKDF2_HMAC.CreatePBKDF2_HMAC(THashFactory.TCrypto.CreateSHA2_256(), Password, Salt, 100000);
end;
