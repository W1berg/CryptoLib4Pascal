...
type
  TRandomDsaKCalculator = class(TInterfacedObject, IDsaKCalculator, IRandomDsaKCalculator)
  ...
  public
    ...
    procedure Init(const n, d: TBigInteger; const &message: TCryptoLibByteArray); overload; virtual;
...
procedure TRandomDsaKCalculator.Init(const n: TBigInteger; const random: ISecureRandom);
begin
  Fq := n;
  Frandom := random;
end;
...
procedure TRandomDsaKCalculator.Init(const n, d: TBigInteger; const &message: TCryptoLibByteArray);
begin
