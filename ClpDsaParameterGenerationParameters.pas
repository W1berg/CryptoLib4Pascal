...
type
  TDsaParameterGenerationParameters = class(TInterfacedObject, IDsaParameterGenerationParameters)
  ...
  public
    ...
    /// </param>
    constructor Create(L, N, certainty: Int32; const random: ISecureRandom); overload;
    ...
    /// a valid usage index.
    /// </param>
    constructor Create(L, N, certainty: Int32; const random: ISecureRandom; usageIndex: Int32); overload;
...
constructor TDsaParameterGenerationParameters.Create(L, N, certainty: Int32; const random: ISecureRandom);
begin
  Create(L, N, certainty, random, -1);
end;

constructor TDsaParameterGenerationParameters.Create(L, N, certainty: Int32; const random: ISecureRandom; usageIndex: Int32);
begin
  inherited Create();
  Fl := L;
  Fn := N;
