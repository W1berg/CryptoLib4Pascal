...
type
  TEphemeralKeyPairGenerator = class sealed(TInterfacedObject, IEphemeralKeyPairGenerator)
  ...
  public
    ...
    constructor Create(const gen: IAsymmetricCipherKeyPairGenerator; const keyEncoder: IKeyEncoder);
  end;
...
constructor TEphemeralKeyPairGenerator.Create(const gen: IAsymmetricCipherKeyPairGenerator; const keyEncoder: IKeyEncoder);
begin
  inherited Create();
  Fgen := gen;
