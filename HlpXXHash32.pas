...
procedure TXXHash32.TransformBytes(const AData: THashLibByteArray; AIndex, ALength: Int32);
var
...
{$ENDIF DEBUG}
  ...
  begin
    ...
    FState.FV1 := PRIME32_1 * TBits.RotateLeft32(FState.FV1 + PRIME32_2 * TConverters.ReadBytesAsUInt32LE(LPtrMemory, 0), 13);
    FState.FV2 := PRIME32_1 * TBits.RotateLeft32(FState.FV2 + PRIME32_2 * TConverters.ReadBytesAsUInt32LE(LPtrMemory, 4), 13);
    FState.FV3 := PRIME32_1 * TBits.RotateLeft32(FState.FV3 + PRIME32_2 * TConverters.ReadBytesAsUInt32LE(LPtrMemory, 8), 13);
    FState.FV4 := PRIME32_1 * TBits.RotateLeft32(FState.FV4 + PRIME32_2 * TConverters.ReadBytesAsUInt32LE(LPtrMemory, 12), 13);
  ...
  begin
    ...
    repeat
      ...
      LV1 := PRIME32_1 * TBits.RotateLeft32(LV1 + PRIME32_2 * TConverters.ReadPCardinalAsUInt32LE(LPtrADataStartCardinal), 13);
      LV2 := PRIME32_1 * TBits.RotateLeft32(LV2 + PRIME32_2 * TConverters.ReadPCardinalAsUInt32LE(LPtrADataStartCardinal + 1), 13);
      LV3 := PRIME32_1 * TBits.RotateLeft32(LV3 + PRIME32_2 * TConverters.ReadPCardinalAsUInt32LE(LPtrADataStartCardinal + 2), 13);
      LV4 := PRIME32_1 * TBits.RotateLeft32(LV4 + PRIME32_2 * TConverters.ReadPCardinalAsUInt32LE(LPtrADataStartCardinal + 3), 13);
...
begin
  ...
  begin
    FHash := TBits.RotateLeft32(FState.FV1, 1) + TBits.RotateLeft32(FState.FV2, 7) + TBits.RotateLeft32(FState.FV3, 12) + TBits.RotateLeft32(FState.FV4, 18)
  end
  else
  begin
