...
type
  ...
  public
    ...
    constructor Create(const alphabet: string; AllZeroShortcut: Char = Null_Char; AllSpaceShortcut: Char = Null_Char);
...
begin
  FZ85 := TBase85Alphabet.Create('0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ.-:+=^!/*?&<>()[]{}@%$#');
  FAscii85 := TBase85Alphabet.Create('!"#$%&''()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstu', 'z', 'y');
end;

constructor TBase85Alphabet.Create(const alphabet: string; AllZeroShortcut, AllSpaceShortcut: Char);
begin
