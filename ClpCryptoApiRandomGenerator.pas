...
type
  ...
  public
    ...
    procedure AddSeedMaterial(const seed: TCryptoLibByteArray); overload; virtual;
    ...
    procedure NextBytes(const bytes: TCryptoLibByteArray; start, len: Int32); overload; virtual;
...
procedure TCryptoApiRandomGenerator.AddSeedMaterial(const seed: TCryptoLibByteArray);
begin
  // We don't care about the seed
end;
...
procedure TCryptoApiRandomGenerator.NextBytes(const bytes: TCryptoLibByteArray; start, len: Int32);
var
