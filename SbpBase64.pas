...
type
  ...
  const
    ...
    class var
      ...
      FDefault, FDefaultNoPadding, FUrlEncoding, FXmlEncoding, FRegExEncoding, FFileEncoding: IBase64;
...
begin
  ...
  FDefaultNoPadding := TBase64.Create(TBase64Alphabet.DefaultNoPadding as IBase64Alphabet);
  FUrlEncoding := TBase64.Create(TBase64Alphabet.UrlEncoding as IBase64Alphabet);
  FXmlEncoding := TBase64.Create(TBase64Alphabet.XmlEncoding as IBase64Alphabet);
  FRegExEncoding := TBase64.Create(TBase64Alphabet.RegExEncoding as IBase64Alphabet);
  FFileEncoding := TBase64.Create(TBase64Alphabet.FileEncoding as IBase64Alphabet);
end;
...
function TBase64.Decode(const text: TSimpleBaseLibCharArray): TSimpleBaseLibByteArray;

  function ProcessDecode(var pInput: PChar; pEnd: PChar; pDecodeTable: PByte; PaddingCount: Int32): Byte;
  var
    c: Char;
    b: Int32;
  begin
...
begin
  ...
  begin
    ...
    resultPtr^ := Byte((TBits.Asr32(temp1 and $3C, 2)) or ((temp2 and $0F) shl 4));
    System.Inc(resultPtr);
...
begin
  ...
  begin
    ...
    System.Inc(OutputPtr);
    OutputPtr^ := table[(TBits.Asr32((b3 and $C0), 6) or (b2 and $0F) shl 2) + 1];
    System.Inc(OutputPtr);
