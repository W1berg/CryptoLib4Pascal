...
{$REGION 'Consts'}
  ...
  const
    ...
    SSBOX: array [0 .. 255] of UInt32 = ($18, $23, $C6, $E8, $87, $B8, $01, $4F, $36, $A6, $D2, $F5, $79, $6F, $91, $52, $60, $BC, $9B, $8E, $A3, $0C, $7B, $35, $1D, $E0, $D7, $C2, $2E, $4B, $FE, $57, $15, $77, $37, $E5, $9F, $F0, $4A, $DA, $58, $C9, $29, $0A, $B1, $A0, $6B, $85, $BD, $5D, $10, $F4,
      $CB, $3E, $05, $67, $E4, $27, $41, $8B, $A7, $7D, $95, $D8, $FB, $EE, $7C, $66, $DD, $17, $47, $9E, $CA, $2D, $BF, $07, $AD, $5A, $83, $33, $63, $02, $AA, $71, $C8, $19, $49, $D9, $F2, $E3, $5B, $88, $9A, $26, $32, $B0, $E9, $0F, $D5, $80, $BE, $CD, $34, $48, $FF, $7A, $90, $5F, $20, $68, $1A,
      $AE, $B4, $54, $93, $22, $64, $F1, $73, $12, $40, $08, $C3, $EC, $DB, $A1, $8D, $3D, $97, $00, $CF, $2B, $76, $82, $D6, $1B, $B5, $AF, $6A, $50, $45, $F3, $30, $EF, $3F, $55, $A2, $EA, $65, $BA, $2F, $C0, $DE, $1C, $FD, $4D, $92, $75, $06, $8A, $B2, $E6, $0E, $1F, $62, $D4, $A8, $96, $F9, $C5,
      $25, $59, $84, $72, $39, $4C, $5E, $78, $38, $8C, $D1, $A5, $E2, $61, $B3, $21, $9C, $1E, $43, $C7, $FC, $04, $51, $99, $6D, $0D, $FA, $DF, $7E, $24, $3B, $AB, $CE, $11, $8F, $4E, $B7, $EB, $3C, $81, $94, $F7, $B9, $13, $2C, $D3, $E7, $6E, $C4, $03, $56, $44, $7F, $A9, $2A, $BB, $C1, $53, $DC,
      $0B, $9D, $6C, $31, $74, $F6, $46, $AC, $89, $14, $E1, $16, $3A, $69, $09, $70, $B6, $D0, $ED, $CC, $42, $98, $A4, $28, $5C, $F8, $86);

{$ENDREGION}
    class constructor WhirlPool;

    class function PackIntoUInt64(b7, b6, b5, b4, b3, b2, b1, b0: UInt32): UInt64; static; inline;
    class function MaskWithReductionPolynomial(AInput: UInt32): UInt32; static; inline;
...
begin
  ...
  TConverters.be64_copy(PUInt64(FHash), 0, PByte(result), 0, System.Length(result));
end;
...
class function TWhirlPool.PackIntoUInt64(b7, b6, b5, b4, b3, b2, b1, b0: UInt32): UInt64;
begin
  result := (UInt64(b7) shl 56) xor (UInt64(b6) shl 48) xor (UInt64(b5) shl 40) xor (UInt64(b4) shl 32) xor (UInt64(b3) shl 24) xor (UInt64(b2) shl 16) xor (UInt64(b1) shl 8) xor b0;
end;

procedure TWhirlPool.TransformBlock(AData: PByte; ADataLength: Int32; AIndex: Int32);
var
...
begin
  ...
  begin
    LIdx := 8 * (LR - 1);
    FSRC[LR] := (FSC0[LIdx] and $FF00000000000000) xor (FSC1[LIdx + 1] and $00FF000000000000) xor (FSC2[LIdx + 2] and $0000FF0000000000) xor (FSC3[LIdx + 3] and $000000FF00000000) xor (FSC4[LIdx + 4] and $00000000FF000000) xor (FSC5[LIdx + 5] and $0000000000FF0000)
      xor (FSC6[LIdx + 6] and $000000000000FF00) xor (FSC7[LIdx + 7] and $00000000000000FF);
