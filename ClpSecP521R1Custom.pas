...
resourcestring
  SInvalidValueForSecP521R1FieldElement = 'Value Invalid for SecP521R1FieldElement "%s"';
...
type
  ...
  const
    ...
    class procedure ImplMultiply(const x, y, zz: TCryptoLibUInt32Array); static; inline;
    class procedure ImplSquare(const x, zz: TCryptoLibUInt32Array); static; inline;
...
type
  TSecP521R1FieldElement = class(TAbstractFpFieldElement, ISecP521R1FieldElement)

  strict private

    function Equals(const other: ISecP521R1FieldElement): Boolean; reintroduce; overload;
...
type
  ...
  type
    TSecP521R1LookupTable = class sealed(TAbstractECLookupTable, ISecP521R1LookupTable, IECLookupTable)
    ...
    public
      ...
      constructor Create(const outer: ISecP521R1Curve; const table: TCryptoLibUInt32Array; size: Int32);
...
begin
  FP := TCryptoLibUInt32Array.Create($FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $1FF);
end;

class function TSecP521R1Field.FromBigInteger(const x: TBigInteger): TCryptoLibUInt32Array;
var
...
class procedure TSecP521R1Field.ImplMultiply(const x, y, zz: TCryptoLibUInt32Array);
var
  x16, y16: UInt32;
begin
  TNat512.Mul(x, y, zz);
...
class procedure TSecP521R1Field.SquareN(const x: TCryptoLibUInt32Array; n: Int32; const z: TCryptoLibUInt32Array);
var
  tt: TCryptoLibUInt32Array;
begin
{$IFDEF DEBUG}
...
begin
  result := TBigInteger.Create(1, THex.Decode('01FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF'));
end;
...
begin
  ...
  begin
    raise EArgumentCryptoLibException.CreateResFmt(@SInvalidValueForSecP521R1FieldElement, ['x']);
  end;
  inherited Create();
...
function TSecP521R1FieldElement.Subtract(const b: IECFieldElement): IECFieldElement;
var
  z: TCryptoLibUInt32Array;
begin
  z := TNat.Create(17);
...
function TSecP521R1FieldElement.Multiply(const b: IECFieldElement): IECFieldElement;
var
  z: TCryptoLibUInt32Array;
begin
  z := TNat.Create(17);
...
function TSecP521R1FieldElement.Divide(const b: IECFieldElement): IECFieldElement;
var
  z: TCryptoLibUInt32Array;
begin
  z := TNat.Create(17);
...
function TSecP521R1FieldElement.Equals(const other: ISecP521R1FieldElement): Boolean;
begin
...
constructor TSecP521R1Point.Create(const curve: IECCurve; const x, y: IECFieldElement);
begin
  Create(curve, x, y, false);
end;

constructor TSecP521R1Point.Create(const curve: IECCurve; const x, y: IECFieldElement; withCompression: Boolean);
begin
...
constructor TSecP521R1Point.Create(const curve: IECCurve; const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean);
begin
...
begin
  ...
  result := TSecP521R1Point.Create(Lcurve, X3, Y3, zs, IsCompressed) as IECPoint;
end;
...
begin
  ...
  result := TSecP521R1Point.Create(curve, RawXCoord, RawYCoord.Negate(), RawZCoords, IsCompressed) as IECPoint;
end;
...
begin
  ...
  result := TSecP521R1Point.Create(Lcurve, X3, Y3, TCryptoLibGenericArray<IECFieldElement>.Create(Z3), IsCompressed) as IECPoint;
end;
...
begin
  ...
  Fm_a := FromBigInteger(TBigInteger.Create(1, THex.Decode('01FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC')));
...
function TSecP521R1Curve.CreateCacheSafeLookupTable(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32): IECLookupTable;
var
...
begin
  ...
  begin
    P := points[off + i];
    TNat.Copy(SECP521R1_FE_INTS, (P.RawXCoord as ISecP521R1FieldElement).x, 0, table, pos);
    pos := pos + SECP521R1_FE_INTS;
    TNat.Copy(SECP521R1_FE_INTS, (P.RawYCoord as ISecP521R1FieldElement).x, 0, table, pos);
    pos := pos + SECP521R1_FE_INTS;
  end;
...
function TSecP521R1Curve.CreateRawPoint(const x, y: IECFieldElement; withCompression: Boolean): IECPoint;
begin
  result := TSecP521R1Point.Create(Self as IECCurve, x, y, withCompression);
end;

function TSecP521R1Curve.CreateRawPoint(const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean): IECPoint;
begin
...
constructor TSecP521R1Curve.TSecP521R1LookupTable.Create(const outer: ISecP521R1Curve; const table: TCryptoLibUInt32Array; size: Int32);
begin
  inherited Create();
  Fm_outer := outer;
  Fm_table := table;
...
function TSecP521R1Curve.TSecP521R1LookupTable.CreatePoint(const x, y: TCryptoLibUInt32Array): IECPoint;
var
  XFieldElement, YFieldElement: ISecP521R1FieldElement;
  SECP521R1_AFFINE_ZS: TCryptoLibGenericArray<IECFieldElement>;
begin
  SECP521R1_AFFINE_ZS := TCryptoLibGenericArray<IECFieldElement>.Create(TSecP521R1FieldElement.Create(TBigInteger.One) as ISecP521R1FieldElement);

  XFieldElement := TSecP521R1FieldElement.Create(x);
  YFieldElement := TSecP521R1FieldElement.Create(y);
  result := Fm_outer.CreateRawPoint(XFieldElement, YFieldElement, SECP521R1_AFFINE_ZS, false);
end;
...
function TSecP521R1Curve.TSecP521R1LookupTable.LookupVar(index: Int32): IECPoint;
var
  x, y: TCryptoLibUInt32Array;
  pos, J: Int32;
begin
