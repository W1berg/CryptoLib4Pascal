...
procedure TTestSecP256R1Field.AssertAreBigIntegersEqual(const a, b: TBigInteger);
begin
...
function TTestSecP256R1Field.Nat256_ToBigInteger(const x: TCryptoLibUInt32Array): TBigInteger;
var
  bs, temp: TBytes;
  i: Int32;
  x_i: UInt32;
begin
  ...
  begin
    ...
    begin
      ...
      System.Move(temp[0], bs[(7 - i) shl 2], System.Length(temp) * SizeOf(Byte));
