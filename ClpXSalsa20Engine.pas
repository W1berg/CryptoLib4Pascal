...
begin
  ...
  begin
    raise EArgumentCryptoLibException.CreateResFmt(@SNullKeyReInit, [AlgorithmName]);
  end;
  ...
  TConverters.le32_copy(PByte(ivBytes), 8 * System.SizeOf(Byte), PCardinal(FEngineState), 8 * System.SizeOf(UInt32), 2 * System.SizeOf(UInt32));
  ...
  TConverters.le32_copy(PByte(ivBytes), 16 * System.SizeOf(Byte), PCardinal(FEngineState), 6 * System.SizeOf(UInt32), 2 * System.SizeOf(UInt32));
