...
type
  TX25519PrivateKeyParameters = class sealed(TAsymmetricKeyParameter, IX25519PrivateKeyParameters)
  ...
  public
    ...
    procedure GenerateSecret(const publicKey: IX25519PublicKeyParameters; const buf: TCryptoLibByteArray; off: Int32);

    function Equals(const other: IX25519PrivateKeyParameters): Boolean; reintroduce; overload;
...
procedure TX25519PrivateKeyParameters.GenerateSecret(const publicKey: IX25519PublicKeyParameters; const buf: TCryptoLibByteArray; off: Int32);
var
...
begin
  ...
  begin
    raise EInvalidOperationCryptoLibException.CreateRes(@SAgreementCalculationFailed);
  end;
end;
...
constructor TX25519PrivateKeyParameters.Create(const buf: TCryptoLibByteArray; off: Int32);
begin
  inherited Create(true);
  System.SetLength(FData, KeySize);
...
procedure TX25519PrivateKeyParameters.Encode(const buf: TCryptoLibByteArray; off: Int32);
begin
  System.Move(FData[0], buf[off], KeySize * System.SizeOf(Byte));
end;

function TX25519PrivateKeyParameters.Equals(const other: IX25519PrivateKeyParameters): Boolean;
begin
