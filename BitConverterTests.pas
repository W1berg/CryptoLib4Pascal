...
begin
  ...
  CheckEquals(FBoolean, FResult, Format('Expected %s but got %s.', [SysUtils.BoolToStr(FBoolean, True), SysUtils.BoolToStr(FResult, True)]));
...
begin
  ...
  CheckEquals(FChar, FResult, Format('Expected %s but got %s.', [FChar, FResult]));
...
begin
  ...
  CheckEquals(FDouble, FResult, Format('Expected %s but got %s.', [FloatToStr(FDouble), FloatToStr(FResult)]));
...
begin
  ...
  CheckEquals(FInt16, FResult, Format('Expected %s but got %s.', [IntToStr(FInt16), IntToStr(FResult)]));
...
begin
  ...
  CheckEquals(FInt32, FResult, Format('Expected %s but got %s.', [IntToStr(FInt32), IntToStr(FResult)]));
...
begin
  ...
  CheckEquals(FInt64, FResult, Format('Expected %s but got %s.', [IntToStr(FInt64), IntToStr(FResult)]));
...
begin
  ...
  CheckEquals(FSingle, FResult, Format('Expected %s but got %s.', [FloatToStr(FSingle), FloatToStr(FResult)]));
...
{$IFDEF FPC}
  CheckEquals(FUInt8, FResult, Format('Expected %s but got %s.', [IntToStr(FUInt8), IntToStr(FResult)]));
{$ELSE}
  CheckEquals(FUInt8, FResult, Format('Expected %s but got %s.', [UIntToStr(FUInt8), UIntToStr(FResult)]));
{$ENDIF FPC}
end;
...
{$IFDEF FPC}
  CheckEquals(FUInt16, FResult, Format('Expected %s but got %s.', [IntToStr(FUInt16), IntToStr(FResult)]));
{$ELSE}
  CheckEquals(FUInt16, FResult, Format('Expected %s but got %s.', [UIntToStr(FUInt16), UIntToStr(FResult)]));
{$ENDIF FPC}
end;
...
{$IFDEF FPC}
  CheckEquals(FUInt32, FResult, Format('Expected %s but got %s.', [IntToStr(FUInt32), IntToStr(FResult)]));
{$ELSE}
  CheckEquals(FUInt32, FResult, Format('Expected %s but got %s.', [UIntToStr(FUInt32), UIntToStr(FResult)]));
{$ENDIF FPC}
end;
...
{$IFDEF FPC}
  CheckEquals(FUInt64, FResult, Format('Expected %s but got %s.', [IntToStr(FUInt64), IntToStr(FResult)]));
{$ELSE}
  CheckEquals(FUInt64, FResult, Format('Expected %s but got %s.', [UIntToStr(FUInt64), UIntToStr(FResult)]));
{$ENDIF FPC}
end;
