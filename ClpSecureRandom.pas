...
type
  ...
  class var
    ...
    class function CreatePrng(const digestName: string; autoSeed: Boolean): IDigestRandomGenerator; static; inline;
  ...
  public
    ...
    procedure NextBytes(const buf: TCryptoLibByteArray; off, len: Int32); overload; virtual;
    ...
    class function GetNextBytes(const SecureRandom: ISecureRandom; length: Int32): TCryptoLibByteArray; static;
    ...
    class function GetInstance(const algorithm: string): ISecureRandom; overload; static; inline;
    /// <summary>
    /// Create an instance based on the given algorithm, with optional auto-seeding
    /// </summary>
    /// <param name="algorithm">e.g. "SHA256PRNG"</param>
    /// <param name="autoSeed">If true, the instance will be auto-seeded.</param>
    class function GetInstance(const algorithm: string; autoSeed: Boolean): ISecureRandom; overload; static;
...
class function TSecureRandom.GetNextBytes(const SecureRandom: ISecureRandom; length: Int32): TCryptoLibByteArray;
begin
...
procedure TSecureRandom.NextBytes(const buf: TCryptoLibByteArray; off, len: Int32);
begin
...
class function TSecureRandom.CreatePrng(const digestName: string; autoSeed: Boolean): IDigestRandomGenerator;
var
  digest: IDigest;
...
begin
  ...
  begin
    ...
    Fmaster := TSecureRandom.Create(TCryptoApiRandomGenerator.Create() as ICryptoApiRandomGenerator);
...
class function TSecureRandom.GetInstance(const algorithm: string; autoSeed: Boolean): ISecureRandom;
var
...
{$ENDIF DELPHIXE3_UP}
  ...
  begin
    digestName := System.Copy(upper, LowPoint, HighPoint - System.length('PRNG'));
  ...
  raise EArgumentCryptoLibException.CreateResFmt(@SUnRecognisedPRNGAlgorithm, [algorithm]);

end;

class function TSecureRandom.GetInstance(const algorithm: string): ISecureRandom;
begin
