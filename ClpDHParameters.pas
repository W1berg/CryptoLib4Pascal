...
type
  ...
  public
    ...
    constructor Create(const p, g, q, j: TBigInteger; const validation: IDHValidationParameters); overload;

    constructor Create(const p, g, q: TBigInteger; m, l: Int32; const j: TBigInteger; const validation: IDHValidationParameters); overload;
...
{$ENDIF DELPHI}override;
    ...
    property ValidationParameters: IDHValidationParameters read GetValidationParameters;
...
constructor TDHParameters.Create(const p, g, q, j: TBigInteger; const validation: IDHValidationParameters);
begin
  Create(p, g, q, DefaultMinimumLength, 0, j, validation)
end;

constructor TDHParameters.Create(const p, g, q: TBigInteger; m, l: Int32; const j: TBigInteger; const validation: IDHValidationParameters);
begin
  inherited Create();
  ...
  if ((g.CompareTo(TBigInteger.Two) < 0) or (g.CompareTo(p.Subtract(TBigInteger.Two)) > 0)) then
  begin
