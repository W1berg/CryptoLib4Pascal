...
type
  ...
  private
    ...
    procedure DoSPECKTest(const cipher: IBufferedCipher; const param: ICipherParameters; const input, output: string; withpadding: Boolean = False);
...
procedure TTestSPECK.DoSPECKTest(const cipher: IBufferedCipher; const param: ICipherParameters; const input, output: string; withpadding: Boolean);
var
...
begin
  ...
  for i := System.Low(TSPECKTestVectors.FCryptoPPVectorKeys_SPECK64_CBC) to System.High(TSPECKTestVectors.FCryptoPPVectorKeys_SPECK64_CBC) do
  begin
    ...
    KeyParametersWithIV := TParametersWithIV.Create(TKeyParameter.Create(keyBytes) as IKeyParameter, IVBytes);

    DoSPECKTest(cipher, KeyParametersWithIV as ICipherParameters, input, output);
  end;
...
begin
  ...
  for i := System.Low(TSPECKTestVectors.FCryptoPPVectorKeys_SPECK128_CBC) to System.High(TSPECKTestVectors.FCryptoPPVectorKeys_SPECK128_CBC) do
  begin
    keyBytes := DecodeHex(TSPECKTestVectors.FCryptoPPVectorKeys_SPECK128_CBC[i]);
...
begin
  ...
  for i := System.Low(TSPECKTestVectors.FCryptoPPVectorKeys_SPECK64_CTR) to System.High(TSPECKTestVectors.FCryptoPPVectorKeys_SPECK64_CTR) do
  begin
...
begin
  ...
  for i := System.Low(TSPECKTestVectors.FCryptoPPVectorKeys_SPECK128_CTR) to System.High(TSPECKTestVectors.FCryptoPPVectorKeys_SPECK128_CTR) do
  begin
    keyBytes := DecodeHex(TSPECKTestVectors.FCryptoPPVectorKeys_SPECK128_CTR[i]);
...
begin
  ...
  for i := System.Low(TSPECKTestVectors.FCryptoPPVectorKeys_SPECK64_ECB) to System.High(TSPECKTestVectors.FCryptoPPVectorKeys_SPECK64_ECB) do
  begin
...
begin
  ...
  for i := System.Low(TSPECKTestVectors.FCryptoPPVectorKeys_SPECK128_ECB) to System.High(TSPECKTestVectors.FCryptoPPVectorKeys_SPECK128_ECB) do
  begin
    keyBytes := DecodeHex(TSPECKTestVectors.FCryptoPPVectorKeys_SPECK128_ECB[i]);
