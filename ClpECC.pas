...
resourcestring
  ...
  SInvalidFieldElement = 'Field elements are not both instances of F2mFieldElement';
  SInvalidFieldElements = 'Field elements are not elements of the same field F2m';
  SIncorrectRepresentation = 'One of the F2m field elements has incorrect representation';
  ...
  SIncorrectLengthInfinityEncoding = 'Incorrect Length for infinity encoding", "encoded"';
  SIncorrectLengthCompressedEncoding = 'Incorrect Length for Compressed Encoding", "encoded"';
  SInvalidPoint = 'Invalid Point';
  SIncorrectLengthUnCompressedEncoding = 'Incorrect Length for UnCompressed Encoding", "encoded"';
  SIncorrectLengthHybridEncoding = 'Incorrect Length for Hybrid Encoding", "encoded"';
  SInConsistentYCoord = 'Inconsistent Y Coordinate in Hybrid Encoding", "encoded"';
...
type
  ...
  public
    ...
    function Subtract(const b: IECFieldElement): IECFieldElement; virtual; abstract;
    function Multiply(const b: IECFieldElement): IECFieldElement; virtual; abstract;
    function Divide(const b: IECFieldElement): IECFieldElement; virtual; abstract;
    ...
    function MultiplyMinusProduct(const b, x, y: IECFieldElement): IECFieldElement; virtual;

    function MultiplyPlusProduct(const b, x, y: IECFieldElement): IECFieldElement; virtual;

    function SquareMinusProduct(const x, y: IECFieldElement): IECFieldElement; virtual;

    function SquarePlusProduct(const x, y: IECFieldElement): IECFieldElement; virtual;

    function SquarePow(pow: Int32): IECFieldElement; virtual;

    function TestBitZero(): Boolean; virtual;

    function Equals(const other: IECFieldElement): Boolean; reintroduce; virtual;
...
type
  ...
  strict private
    ...
    function LucasSequence(const P, Q, K: TBigInteger): TCryptoLibGenericArray<TBigInteger>;
  ...
  public
    constructor Create(const Q, x: TBigInteger); overload; deprecated 'Use ECCurve.FromBigInteger to construct field elements';
    ...
    function MultiplyMinusProduct(const b, x, y: IECFieldElement): IECFieldElement; override;
    function MultiplyPlusProduct(const b, x, y: IECFieldElement): IECFieldElement; override;

    function SquareMinusProduct(const x, y: IECFieldElement): IECFieldElement; override;

    function SquarePlusProduct(const x, y: IECFieldElement): IECFieldElement; override;
...
type
  TAbstractF2mFieldElement = class abstract(TECFieldElement, IAbstractF2mFieldElement)
...
type
  ...
  public
    ...
    // */
    constructor Create(m, k1, k2, k3: Int32; const x: TBigInteger); overload; deprecated 'Use ECCurve.FromBigInteger to construct field elements';
    // /**
    // * Constructor for Tpb.
    // * @param m  The exponent <code>m</code> of
    // * <code>F<sub>2<sup>m</sup></sub></code>.
    ...
    // * @param x The BigInteger representing the value of the field element.
    // */
    constructor Create(m, K: Int32; const x: TBigInteger); overload; deprecated 'Use ECCurve.FromBigInteger to construct field elements';

    constructor Create(m: Int32; const ks: TCryptoLibInt32Array; const x: TLongArray); overload;
...
type
  ...
  var
    ...
    function CreateRawPoint(const x, y: IECFieldElement; withCompression: Boolean): IECPoint; overload; virtual; abstract;

    function CreateRawPoint(const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean): IECPoint; overload; virtual; abstract;

    function CreateDefaultMultiplier(): IECMultiplier; virtual;

    procedure CheckPoint(const point: IECPoint); virtual;

    procedure CheckPoints(const points: TCryptoLibGenericArray<IECPoint>); overload; virtual;

    procedure CheckPoints(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32); overload; virtual;

    function DecompressPoint(yTilde: Int32; const x1: TBigInteger): IECPoint; virtual; abstract;
  ...
  public
    ...
    public
      constructor Create(const outer: IECCurve; coord: Int32; const endomorphism: IECEndomorphism; const multiplier: IECMultiplier); overload;

      destructor Destroy(); override;

      function SetCoordinateSystem(coord: Int32): IConfig; inline;
      function SetEndomorphism(const endomorphism: IECEndomorphism): IConfig; inline;
  ...
  function ValidatePoint(const x, y: TBigInteger; withCompression: Boolean): IECPoint; overload; virtual; deprecated 'Per-point compression property will be removed';
  ...
  /// </summary>
  function CreateCacheSafeLookupTable(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32): IECLookupTable; virtual;

  function CreatePoint(const x, y: TBigInteger): IECPoint; overload; virtual;

  function CreatePoint(const x, y: TBigInteger; withCompression: Boolean): IECPoint; overload; virtual; deprecated 'Per-point compression property will be removed';

  function SupportsCoordinateSystem(coord: Int32): Boolean; virtual;

  function GetPreCompInfo(const point: IECPoint; const name: string): IPreCompInfo; virtual;
  ...
  /// </param>
  function Precompute(const point: IECPoint; const name: string; const callback: IPreCompCallback): IPreCompInfo; virtual;
  ...
  /// </param>
  procedure NormalizeAll(const points: TCryptoLibGenericArray<IECPoint>); overload; virtual;
  ...
  /// </param>
  procedure NormalizeAll(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32; const iso: IECFieldElement); overload; virtual;
...
{$ENDIF DELPHI}override;
  ...
  class function GetAllCoordinateSystems(): TCryptoLibInt32Array; static; inline;

  end;

type
  TAbstractECLookupTable = class abstract(TInterfacedObject, IAbstractECLookupTable, IECLookupTable)
...
type
  TSimpleLookupTable = class abstract(TAbstractECLookupTable, ISimpleLookupTable)

  strict private
  var
    FPoints: TCryptoLibGenericArray<IECPoint>;

    class function Copy(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32): TCryptoLibGenericArray<IECPoint>; static;

  strict protected
    function GetSize: Int32; override;

  public
    constructor Create(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32);
...
type
  ...
  public
    constructor Create(const outer: IECCurve; const table: TCryptoLibByteArray; Size: Int32);
...
type
  ...
  strict protected
    ...
    function DecompressPoint(yTilde: Int32; const x1: TBigInteger): IECPoint; override;
...
type
  ...
  public
    constructor Create(const outer: IF2mCurve; const table: TCryptoLibInt64Array; Size: Int32);
...
type
  ...
  var
    ...
    constructor Create(const Q, r: TBigInteger; const a, b: IECFieldElement); overload; deprecated 'Use constructor taking order/cofactor';
    constructor Create(const Q, r: TBigInteger; const a, b: IECFieldElement; const Order, Cofactor: TBigInteger); overload;
    ...
    function CreateRawPoint(const x, y: IECFieldElement; withCompression: Boolean): IECPoint; overload; override;

    function CreateRawPoint(const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean): IECPoint; overload; override;

  public
    constructor Create(const Q, a, b: TBigInteger); overload; deprecated 'Use constructor taking order/cofactor';
...
type
  ...
  strict protected
    ...
    // */
    function SolveQuadraticEquation(const beta: IECFieldElement): IECFieldElement;
  ...
  public
    ...
    function CreatePoint(const x, y: TBigInteger; withCompression: Boolean): IECPoint; override; deprecated 'Per-point compression property will be removed';
    ...
    class function Inverse(m: Int32; const ks: TCryptoLibInt32Array; const x: TBigInteger): TBigInteger; static; inline;
...
type
  ...
  var
    ...
    constructor Create(m, k1, k2, k3: Int32; const a, b: IECFieldElement; const Order, Cofactor: TBigInteger); overload;
  ...
  public
    ...
    // * <code>F<sub>2<sup>m</sup></sub></code>.
    // */
    constructor Create(m, K: Int32; const a, b: TBigInteger); overload; deprecated 'Use constructor taking order/cofactor';
    // /**
    // * Constructor for Trinomial Polynomial Basis (TPB).
    // * @param m  The exponent <code>m</code> of
    // * <code>F<sub>2<sup>m</sup></sub></code>.
    ...
    // */
    constructor Create(m, K: Int32; const a, b, Order, Cofactor: TBigInteger); overload;
    ...
    constructor Create(m, k1, k2, k3: Int32; const a, b: TBigInteger); overload; deprecated 'Use constructor taking order/cofactor';
    // /**
    // * Constructor for Pentanomial Polynomial Basis (PPB).
    // * @param m  The exponent <code>m</code> of
    // * <code>F<sub>2<sup>m</sup></sub></code>.
    ...
    // * <code>#E<sub>a</sub>(F<sub>2<sup>m</sup></sub>) = h * n</code>.
    // */
    constructor Create(m, k1, k2, k3: Int32; const a, b, Order, Cofactor: TBigInteger); overload;
    ...
    function CreateCacheSafeLookupTable(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32): IECLookupTable; override;
...
type
  ...
  type
    TValidityCallback = class(TInterfacedObject, IPreCompCallback, IValidityCallback)
    ...
    public
      constructor Create(const outer: IECPoint; decompressed, checkOrder: Boolean);
  ...
  var
    ...
    constructor Create(const curve: IECCurve; const x, y: IECFieldElement; withCompression: Boolean); overload;
    ...
    function CreateScaledPoint(const sx, sy: IECFieldElement): IECPoint; virtual;
    ...
    class function GetInitialZCoords(const curve: IECCurve): TCryptoLibGenericArray<IECFieldElement>; static;
  ...
  var
    ...
    constructor Create(const curve: IECCurve; const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean); overload;
    destructor Destroy; override;
    ...
    function Normalize(const zInv: IECFieldElement): IECPoint; overload; virtual;
    ...
    function GetEncoded(compressed: Boolean): TCryptoLibByteArray; overload; virtual; abstract;
...
{$ENDIF DELPHI}override;
    ...
    property preCompTable: TDictionary<string, IPreCompInfo> read GetpreCompTable write SetpreCompTable;
...
type
  ...
  strict protected
    ...
    function DoubleProductFromSquares(const a, b, aSquared, bSquared: IECFieldElement): IECFieldElement; virtual;

    function CalculateJacobianModifiedW(const z: IECFieldElement; const ZSquared: IECFieldElement): IECFieldElement; virtual;
  ...
  public
    ...
    /// </param>
    constructor Create(const curve: IECCurve; const x, y: IECFieldElement); overload; deprecated 'Use ECCurve.CreatePoint to construct points';
    ...
    /// </param>
    constructor Create(const curve: IECCurve; const x, y: IECFieldElement; withCompression: Boolean); overload; deprecated 'Per-point compression property will be removed, see GetEncoded(boolean)';
...
class procedure TF2mFieldElement.CheckFieldElements(const a, b: IECFieldElement);
var
  aF2m, bF2m: IF2mFieldElement;
begin
  if (not(Supports(a, IF2mFieldElement, aF2m)) or (not(Supports(b, IF2mFieldElement, bF2m)))) then
  begin
...
constructor TF2mFieldElement.Create(m: Int32; const ks: TCryptoLibInt32Array; const x: TLongArray);
begin
  inherited Create();
  Fm := m;
...
begin
  ...
  result := ((m = other.m) and (Representation = other.Representation) and TArrayUtils.AreEqual(ks, other.ks) and (x.Equals(other.x)));
end;
...
begin
  ...
  // elements involved are checked in ECPoint.F2m
  // checkFieldElements(this, b);
  result := TF2mFieldElement.Create(Fm, FKs, Fx.ModMultiply((b as IF2mFieldElement).x, Fm, FKs));
end;

function TF2mFieldElement.MultiplyMinusProduct(const b, x, y: IECFieldElement): IECFieldElement;
begin
  result := MultiplyPlusProduct(b, x, y);
end;

function TF2mFieldElement.MultiplyPlusProduct(const b, x, y: IECFieldElement): IECFieldElement;
var
...
function TF2mFieldElement.SquareMinusProduct(const x, y: IECFieldElement): IECFieldElement;
begin
  result := SquarePlusProduct(x, y);
end;

function TF2mFieldElement.SquarePlusProduct(const x, y: IECFieldElement): IECFieldElement;
var
...
begin
  result := TBigIntegers.AsUnsignedByteArray((FieldSize + 7) div 8, ToBigInteger());
end;
...
function TECFieldElement.MultiplyMinusProduct(const b, x, y: IECFieldElement): IECFieldElement;
begin
  result := Multiply(b).Subtract(x.Multiply(y));
end;

function TECFieldElement.MultiplyPlusProduct(const b, x, y: IECFieldElement): IECFieldElement;
begin
  result := Multiply(b).Add(x.Multiply(y));
end;

function TECFieldElement.SquareMinusProduct(const x, y: IECFieldElement): IECFieldElement;
begin
  result := Square().Subtract(x.Multiply(y));
end;

function TECFieldElement.SquarePlusProduct(const x, y: IECFieldElement): IECFieldElement;
begin
...
class function TFpFieldElement.CalculateResidue(const P: TBigInteger): TBigInteger;
var
  BitLength: Int32;
...
begin
  result := TFpFieldElement.Create(Fq, Fr, ModMult(Fx, ModInverse(b.ToBigInteger())));
end;
...
function TFpFieldElement.LucasSequence(const P, Q, K: TBigInteger): TCryptoLibGenericArray<TBigInteger>;
var
  n, s, j: Int32;
...
function TFpFieldElement.MultiplyMinusProduct(const b, x, y: IECFieldElement): IECFieldElement;
var
...
function TFpFieldElement.MultiplyPlusProduct(const b, x, y: IECFieldElement): IECFieldElement;
var
...
begin
  ...
  xy := xx.Multiply(yx);
  sum := ab.Add(xy);
  if ((Fr.IsInitialized) and (Fr.SignValue < 0) and (sum.BitLength > (Fq.BitLength shl 1))) then
  begin
...
var
  u, v, K, e, t1, t2, t3, t4, y, legendreExponent, x, fourX, qMinusOne, P: TBigInteger;
...
begin
  ...
  begin
    ...
    result := CheckSqrt(TFpFieldElement.Create(Fq, Fr, Fx.ModPow(e, Fq)) as IFpFieldElement);
    Exit;
  end;
  ...
  begin
    ...
    begin
      result := CheckSqrt(TFpFieldElement.Create(Fq, Fr, t2) as IFpFieldElement);
      Exit;
    end;
  ...
  repeat
    ...
    repeat
      ...
      ModReduceRes := (not ModReduce(P.Multiply(P).Subtract(fourX)).ModPow(legendreExponent, Q).Equals(qMinusOne));
...
function TFpFieldElement.SquareMinusProduct(const x, y: IECFieldElement): IECFieldElement;
var
...
function TFpFieldElement.SquarePlusProduct(const x, y: IECFieldElement): IECFieldElement;
var
...
procedure TECCurve.CheckPoints(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32);
var
  i: Int32;
  point: IECPoint;
begin
...
begin
  result := TConfig.Create(Self as IECCurve, Self.Fm_coord, Self.Fm_endomorphism, Self.Fm_multiplier);
end;
...
function TECCurve.CreateCacheSafeLookupTable(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32): IECLookupTable;
var
...
begin
  ...
  begin
    ...
    System.Move(px[pxStart], table[position + FE_BYTES - pxLen], pxLen * System.SizeOf(Byte));
    position := position + FE_BYTES;

    System.Move(py[pyStart], table[position + FE_BYTES - pyLen], pyLen * System.SizeOf(Byte));
    position := position + FE_BYTES;
  end;
...
function TECCurve.CreatePoint(const x, y: TBigInteger; withCompression: Boolean): IECPoint;
begin
  result := CreateRawPoint(FromBigInteger(x), FromBigInteger(y), withCompression);
end;
  ...
  case ltype of
    $00: // infinity
      begin
        ...
        begin
          raise EArgumentCryptoLibException.CreateRes(@SIncorrectLengthInfinityEncoding);
        end;
    ...
    $03: // compressed
      begin
        ...
        begin
          raise EArgumentCryptoLibException.CreateRes(@SIncorrectLengthCompressedEncoding);
        end;
    ...
    $04: // uncompressed
      begin
        ...
        begin
          raise EArgumentCryptoLibException.CreateRes(@SIncorrectLengthUnCompressedEncoding);
        end;
    ...
    $07: // hybrid
      begin
        if (System.Length(encoded) <> ((2 * expectedLength) + 1)) then
        begin
          raise EArgumentCryptoLibException.CreateRes(@SIncorrectLengthHybridEncoding);
        end;
...
begin
  ...
  result := (field as TObject).Equals(other.field as TObject) and (a.ToBigInteger().Equals(other.a.ToBigInteger())) and (b.ToBigInteger().Equals(other.b.ToBigInteger()));
end;
...
begin
  result := TCryptoLibInt32Array.Create(TECCurveConstants.COORD_AFFINE, TECCurveConstants.COORD_HOMOGENEOUS, TECCurveConstants.COORD_JACOBIAN, TECCurveConstants.COORD_JACOBIAN_CHUDNOVSKY, TECCurveConstants.COORD_JACOBIAN_MODIFIED, TECCurveConstants.COORD_LAMBDA_AFFINE,
...
{$ENDIF DELPHI}
begin
  result := (field as TObject).GetHashCode() xor Int32(TBits.RotateLeft32(a.ToBigInteger().GetHashCode(), 8)) xor Int32(TBits.RotateLeft32(b.ToBigInteger().GetHashCode(), 16));
end;
...
function TECCurve.GetPreCompInfo(const point: IECPoint; const name: string): IPreCompInfo;
var
...
begin
  ...
  result := CreatePoint(Lp.XCoord.ToBigInteger(), Lp.YCoord.ToBigInteger(), Lp.IsCompressed);
end;

procedure TECCurve.NormalizeAll(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32; const iso: IECFieldElement);
var
  ...
  case CoordinateSystem of
    TECCurveConstants.COORD_AFFINE, TECCurveConstants.COORD_LAMBDA_AFFINE:
      begin
        if (iso <> nil) then
        begin
          raise EArgumentCryptoLibException.CreateRes(@SInvalidAffineCoordinates);
        end;
...
function TECCurve.Precompute(const point: IECPoint; const name: string; const callback: IPreCompCallback): IPreCompInfo;
var
  table: TDictionary<string, IPreCompInfo>;
...
function TECCurve.ValidatePoint(const x, y: TBigInteger; withCompression: Boolean): IECPoint;
var
  P: IECPoint;
begin
...
constructor TECCurve.TConfig.Create(const outer: IECCurve; coord: Int32; const endomorphism: IECEndomorphism; const multiplier: IECMultiplier);
begin
  inherited Create();
  Fouter := outer;
  Fcoord := coord;
...
function TECCurve.TConfig.SetEndomorphism(const endomorphism: IECEndomorphism): IConfig;
begin
  Fendomorphism := endomorphism;
  result := Self as IConfig;
end;

function TECCurve.TConfig.SetMultiplier(const multiplier: IECMultiplier): IConfig;
begin
  Fmultiplier := multiplier;
  result := Self as IConfig;
end;
...
function TAbstractFpCurve.DecompressPoint(yTilde: Int32; const x1: TBigInteger): IECPoint;
var
...
begin
  result := (x.IsInitialized) and (x.SignValue >= 0) and (x.CompareTo(field.Characteristic) < 0);
end;
...
constructor TFpCurve.Create(const Q, r: TBigInteger; const a, b: IECFieldElement; const Order, Cofactor: TBigInteger);
begin
  inherited Create(Q);
  Fm_q := Q;
  Fm_r := r;
...
constructor TFpCurve.Create(const Q, r: TBigInteger; const a, b: IECFieldElement);
begin
...
function TFpCurve.CreateRawPoint(const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean): IECPoint;
begin
...
function TFpCurve.CreateRawPoint(const x, y: IECFieldElement; withCompression: Boolean): IECPoint;
begin
...
begin
  if ((Self as IECCurve <> P.curve) and (CoordinateSystem = TECCurveConstants.COORD_JACOBIAN) and (not P.IsInfinity)) then
  begin
    case P.curve.CoordinateSystem of
      TECCurveConstants.COORD_JACOBIAN, TECCurveConstants.COORD_JACOBIAN_CHUDNOVSKY, TECCurveConstants.COORD_JACOBIAN_MODIFIED:
        begin
          result := TFpPoint.Create(Self as IECCurve, FromBigInteger(P.RawXCoord.ToBigInteger()), FromBigInteger(P.RawYCoord.ToBigInteger()), TCryptoLibGenericArray<IECFieldElement>.Create(FromBigInteger(P.GetZCoord(0).ToBigInteger())), P.IsCompressed);
          Exit;
        end;
    end;
  end;
...
begin
  ...
  begin
    ...
    result := TFiniteFields.GetBinaryExtensionField(TCryptoLibInt32Array.Create(0, k1, m));
    Exit;
  end;
  ...
  result := TFiniteFields.GetBinaryExtensionField(TCryptoLibInt32Array.Create(0, k1, k2, k3, m));
end;
...
function TAbstractF2mCurve.CreatePoint(const x, y: TBigInteger; withCompression: Boolean): IECPoint;
var
...
begin
  ...
  case CoordinateSystem of
    TECCurveConstants.COORD_LAMBDA_AFFINE, TECCurveConstants.COORD_LAMBDA_PROJECTIVE:
      begin
        if (Lx.IsZero) then
        begin
...
function TAbstractF2mCurve.DecompressPoint(yTilde: Int32; const x1: TBigInteger): IECPoint;
var
...
begin
  result := (Fm_order.IsInitialized) and (Fm_cofactor.IsInitialized) and (Fm_b.IsOne) and (Fm_a.IsZero or Fm_a.IsOne);
end;
...
class function TAbstractF2mCurve.Inverse(m: Int32; const ks: TCryptoLibInt32Array; const x: TBigInteger): TBigInteger;
begin
...
begin
  result := (x.IsInitialized) and (x.SignValue >= 0) and (x.BitLength <= FieldSize);
end;

function TAbstractF2mCurve.SolveQuadraticEquation(const beta: IECFieldElement): IECFieldElement;
var
...
constructor TF2mCurve.Create(m, k1, k2, k3: Int32; const a, b: IECFieldElement; const Order, Cofactor: TBigInteger);
begin
...
constructor TF2mCurve.Create(m, K: Int32; const a, b, Order, Cofactor: TBigInteger);
begin
  Create(m, K, 0, 0, a, b, Order, Cofactor);
end;

constructor TF2mCurve.Create(m, k1, k2, k3: Int32; const a, b, Order, Cofactor: TBigInteger);
begin
  inherited Create(m, k1, k2, k3);
  Fm := m;
  Fk1 := k1;
...
function TF2mCurve.CreateCacheSafeLookupTable(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32): IECLookupTable;
var
...
function TF2mCurve.CreateRawPoint(const x, y: IECFieldElement; withCompression: Boolean): IECPoint;
begin
  result := TF2mPoint.Create(Self as IECCurve, x, y, withCompression);
end;

function TF2mCurve.CreateRawPoint(const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean): IECPoint;
begin
...
constructor TDefaultLookupTable.Create(const outer: IECCurve; const table: TCryptoLibByteArray; Size: Int32);
begin
  inherited Create();
  Fm_outer := outer;
  Fm_table := table;
...
function TDefaultLookupTable.CreatePoint(const x, y: TCryptoLibByteArray): IECPoint;
var
...
constructor TDefaultF2mLookupTable.Create(const outer: IF2mCurve; const table: TCryptoLibInt64Array; Size: Int32);
begin
  inherited Create();
  Fm_outer := outer;
  Fm_table := table;
...
function TDefaultF2mLookupTable.CreatePoint(const x, y: TCryptoLibInt64Array): IECPoint;
var
  XFieldElement, YFieldElement: IECFieldElement;
  m: Int32;
...
begin
  ...
  result := (Fm_x = nil) or (Fm_y = nil) or ((System.Length(Fm_zs) > 0) and (Fm_zs[0].IsZero));
end;
...
begin
  ...
  result := (not(n.IsInitialized)) or TECAlgorithms.ReferenceMultiply(Self as IECPoint, n).IsInfinity;
end;
...
begin
  ...
  begin
    result := curve.CreateRawPoint(RawXCoord.Multiply(scale), RawYCoord, RawZCoords, IsCompressed);
  end;
end;
...
begin
  ...
  begin
    result := curve.CreateRawPoint(RawXCoord.Multiply(scale), RawYCoord.Negate, RawZCoords, IsCompressed);
  end;
end;
...
begin
  ...
  begin
    result := curve.CreateRawPoint(RawXCoord, RawYCoord.Multiply(scale), RawZCoords, IsCompressed);
  end;
end;
...
begin
  ...
  begin
    result := curve.CreateRawPoint(RawXCoord.Negate, RawYCoord.Multiply(scale), RawZCoords, IsCompressed);
  end;
end;

procedure TECPoint.SetpreCompTable(const Value: TDictionary<string, IPreCompInfo>);
begin
...
constructor TECPoint.Create(const curve: IECCurve; const x, y: IECFieldElement; withCompression: Boolean);
begin
...
constructor TECPoint.Create(const curve: IECCurve; const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean);
begin
  inherited Create();
...
begin
  result := curve.CreateRawPoint(RawXCoord.Multiply(sx), RawYCoord.Multiply(sy), IsCompressed);
end;
...
class function TECPoint.GetInitialZCoords(const curve: IECCurve): TCryptoLibGenericArray<IECFieldElement>;
var
  coord: Int32;
  One: IECFieldElement;
begin
...
begin
  ...
  callback := TValidityCallback.Create(Self as IECPoint, decompressed, checkOrder);
  Validity := curve.Precompute(Self as IECPoint, TValidityPrecompInfo.PRECOMP_NAME, callback) as IValidityPrecompInfo;
...
begin
  ...
  result := (coord = TECCurveConstants.COORD_AFFINE) or (coord = TECCurveConstants.COORD_LAMBDA_AFFINE) or (IsInfinity) or (RawZCoords[0].IsOne);
end;
...
begin
  case CurveCoordinateSystem of
    ...
    begin
      raise EInvalidOperationCryptoLibException.CreateRes(@SNotProjectiveCoordSystem);
    end;
...
constructor TF2mPoint.Create(const curve: IECCurve; const x, y: IECFieldElement; withCompression: Boolean);
begin
...
var
  ecCurve: IECCurve;
  coord: Int32;
  x1, x2, Y1, Y2, dx, dy, L, x3, Y3, Z1, Z2, U1, V1, U2, V2, u, v, Vsq, Vcu, w, a, VSqZ2, uv, Z3, L3, L1, L2, S2, S1, ABZ2, AU1, AU2, bigB: IECFieldElement;
  ...
  case coord of
    ...
    TECCurveConstants.COORD_HOMOGENEOUS:
      begin
        ...
        Y3 := u.MultiplyPlusProduct(x1, v, Y1).MultiplyPlusProduct(VSqZ2, uv, a);
        Z3 := Vcu.Multiply(w);

        result := TF2mPoint.Create(ecCurve, x3, Y3, TCryptoLibGenericArray<IECFieldElement>.Create(Z3), IsCompressed);
        Exit;
      end;
    ...
    TECCurveConstants.COORD_LAMBDA_PROJECTIVE:
      begin
        ...
        begin
          ...
          if (x3.IsZero) then
          begin
            result := TF2mPoint.Create(ecCurve, x3, ecCurve.b.Sqrt(), IsCompressed);
            Exit;
          end;
        ...
        result := TF2mPoint.Create(ecCurve, x3, L3, TCryptoLibGenericArray<IECFieldElement>.Create(Z3), IsCompressed);
        Exit;
      end
  else
    begin
...
constructor TF2mPoint.Create(const curve: IECCurve; const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean);
begin
  ...
  case coord of
    ...
    TECCurveConstants.COORD_HOMOGENEOUS:
      begin
        LY := RawYCoord;
        z := RawZCoords[0];
        result := TF2mPoint.Create(ecCurve, Lx, LY.Add(Lx), TCryptoLibGenericArray<IECFieldElement>.Create(z), IsCompressed);
        Exit;
      end;
    ...
    TECCurveConstants.COORD_LAMBDA_PROJECTIVE:
      begin
        ...
        L := RawYCoord;
        z := RawZCoords[0];
        result := TF2mPoint.Create(ecCurve, Lx, L.Add(z), TCryptoLibGenericArray<IECFieldElement>.Create(z), IsCompressed);
        Exit;
      end
...
var
  ecCurve: IECCurve;
  x1, Y1, L1, x3, Y3, Z1, X1Z1, X1Sq, Y1Z1, s, v, vSquared, sv, h, Z3, L1Z1, Z1Sq, a, aZ1Sq, L3, t, b, t1, t2: IECFieldElement;
  coord: Int32;
  Z1IsOne: Boolean;
begin
  if (IsInfinity) then
  ...
  case coord of
    ...
    TECCurveConstants.COORD_LAMBDA_PROJECTIVE:
      begin
        ...
        if (t.IsZero) then
        begin
          result := TF2mPoint.Create(ecCurve, t, ecCurve.b.Sqrt(), IsCompressed);
          Exit;
        end;
...
var
  ecCurve: IECCurve;
  x1, x2, Z2, L1, L2, Z1, X1Sq, L1Sq, Z1Sq, L1Z1, t, L2plus1, a, X2Z1Sq, bigB, x3, L3, Z3: IECFieldElement;
  coord: Int32;
begin
  if (IsInfinity) then
  begin
  ...
  case coord of
    TECCurveConstants.COORD_LAMBDA_PROJECTIVE:
      begin
        ...
        L2plus1 := L2.AddOne();
        a := ecCurve.a.Add(L2plus1).Multiply(Z1Sq).Add(L1Sq).MultiplyPlusProduct(t, X1Sq, Z1Sq);
        ...
        if (a.IsZero) then
        begin
          result := TF2mPoint.Create(ecCurve, a, ecCurve.b.Sqrt(), IsCompressed);
          Exit;
        end;
...
constructor TECPointBase.Create(const curve: IECCurve; const x, y: IECFieldElement; withCompression: Boolean);
begin
  inherited Create(curve, x, y, withCompression);
end;

constructor TECPointBase.Create(const curve: IECCurve; const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean);
begin
  inherited Create(curve, x, y, zs, withCompression);
end;
...
begin
  ...
  System.Move(Lx[0], PO[1], System.Length(Lx) * System.SizeOf(Byte));
  System.Move(LY[0], PO[System.Length(Lx) + 1], System.Length(LY) * System.SizeOf(Byte));
...
constructor TAbstractFpPoint.Create(const curve: IECCurve; const x, y: IECFieldElement; withCompression: Boolean);
begin
  inherited Create(curve, x, y, withCompression);
end;

constructor TAbstractFpPoint.Create(const curve: IECCurve; const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean);
begin
  inherited Create(curve, x, y, zs, withCompression);
end;
...
var
  ecCurve: IECCurve;
  coord: Int32;
  gamma, x1, x2, Y1, Y2, dx, dy, x3, Y3, Z1, Z2, U1, V1, U2, V2, u, v, w, a, Z3, S2, S1, vSquared, vCubed, vSquaredV2, Z1Squared, bigU2, Z3Squared, c, W1, w2, A1, Z1Cubed, Z2Squared, bigU1, h, r, HSquared, G, W3, Z2Cubed: IECFieldElement;
  zs: TCryptoLibGenericArray<IECFieldElement>;
  Z1IsOne, Z2IsOne: Boolean;
begin
  if (IsInfinity) then
  ...
  case coord of
    ...
    TECCurveConstants.COORD_HOMOGENEOUS:
      begin
        ...
        result := TFpPoint.Create(ecCurve, x3, Y3, TCryptoLibGenericArray<IECFieldElement>.Create(Z3), IsCompressed);
        Exit;
      end;
...
function TFpPoint.CalculateJacobianModifiedW(const z: IECFieldElement; const ZSquared: IECFieldElement): IECFieldElement;
var
...
constructor TFpPoint.Create(const curve: IECCurve; const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean);
begin
  inherited Create(curve, x, y, zs, withCompression);
end;

constructor TFpPoint.Create(const curve: IECCurve; const x, y: IECFieldElement; withCompression: Boolean);
begin
  inherited Create(curve, x, y, withCompression);
  if ((x = nil) <> (y = nil)) then
  begin
...
function TFpPoint.DoubleProductFromSquares(const a, b, aSquared, bSquared: IECFieldElement): IECFieldElement;
begin
  // /*
...
begin
  if ((index = 1) and (TECCurveConstants.COORD_JACOBIAN_MODIFIED = CurveCoordinateSystem)) then
  begin
...
begin
  ...
  begin
    result := TFpPoint.Create(Lcurve, RawXCoord, RawYCoord.Negate(), RawZCoords, IsCompressed);
    Exit;
  end;

  result := TFpPoint.Create(Lcurve, RawXCoord, RawYCoord.Negate(), IsCompressed);
end;
...
var
  ecCurve: IECCurve;
  Y1, W1, x1, Z1, Z1Sq, X1Squared, m, _2Y1, _2Y1Squared, s, _4T, _8T, zInv, zInv2, zInv3: IECFieldElement;
  coord, i: Int32;
begin
  if (e < 0) then
  begin
  ...
  case coord of
    TECCurveConstants.COORD_AFFINE:
      begin
        ...
        result := TFpPoint.Create(ecCurve, x1.Multiply(zInv2), Y1.Multiply(zInv3), IsCompressed);
        Exit;
      end;
    ...
    TECCurveConstants.COORD_HOMOGENEOUS:
      begin
        ...
        result := TFpPoint.Create(ecCurve, x1, Y1, TCryptoLibGenericArray<IECFieldElement>.Create(Z1), IsCompressed);
        Exit;
      end;
    TECCurveConstants.COORD_JACOBIAN:
      begin
    ...
    TECCurveConstants.COORD_JACOBIAN_MODIFIED:
      begin
        result := TFpPoint.Create(ecCurve, x1, Y1, TCryptoLibGenericArray<IECFieldElement>.Create(Z1, W1), IsCompressed);
        Exit;
      end
  else
    begin
...
var
  ecCurve: IECCurve;
  Y1, x1, X1Squared, gamma, x3, Y3, Z1, w, s, t, b, _4B, h, _2s, _2t, _4sSquared, Z3, m, Y1Squared, a4, a4Neg, Z1Squared, Z1Pow4: IECFieldElement;
  coord: Int32;
  Z1IsOne: Boolean;
begin
  if (IsInfinity) then
...
var
  x1, Y1, Z1, W1, X1Squared, m, _2Y1, _2Y1Squared, s, x3, _4T, _8T, Y3, W3, Z3: IECFieldElement;
begin
  x1 := RawXCoord;
  Y1 := RawYCoord;
  Z1 := RawZCoords[0];
  ...
  result := TFpPoint.Create(curve, x3, Y3, TCryptoLibGenericArray<IECFieldElement>.Create(Z3, W3), IsCompressed);
end;
...
constructor TAbstractF2mPoint.Create(const curve: IECCurve; const x, y: IECFieldElement; withCompression: Boolean);
begin
  inherited Create(curve, x, y, withCompression);
end;

constructor TAbstractF2mPoint.Create(const curve: IECCurve; const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean);
begin
  inherited Create(curve, x, y, zs, withCompression);
end;
  ...
  case CurveCoordinateSystem of
    ...
    TECCurveConstants.COORD_LAMBDA_PROJECTIVE:
      begin
        ...
        result := curve.CreateRawPoint(Lx, L2, TCryptoLibGenericArray<IECFieldElement>.Create(Z2), IsCompressed);
        Exit;
      end
  else
    begin
...
function TAbstractF2mPoint.ScaleXNegateY(const scale: IECFieldElement): IECPoint;
begin
  result := ScaleX(scale);
end;
...
function TAbstractF2mPoint.ScaleYNegateX(const scale: IECFieldElement): IECPoint;
begin
  result := ScaleY(scale);
end;
...
begin
  ...
  case coord of
    TECCurveConstants.COORD_AFFINE, TECCurveConstants.COORD_LAMBDA_AFFINE:
      begin
        Y1 := RawYCoord;
        result := ecCurve.CreateRawPoint(x1.Square(), Y1.Square(), IsCompressed) as IAbstractF2mPoint;
        Exit;
      end;
    ...
    TECCurveConstants.COORD_HOMOGENEOUS, TECCurveConstants.COORD_LAMBDA_PROJECTIVE:
      begin
        Y1 := RawYCoord;
        Z1 := RawZCoords[0];
        result := ecCurve.CreateRawPoint(x1.Square(), Y1.Square(), TCryptoLibGenericArray<IECFieldElement>.Create(Z1.Square()), IsCompressed) as IAbstractF2mPoint;
        Exit;
      end
...
begin
  ...
  case coord of
    TECCurveConstants.COORD_AFFINE, TECCurveConstants.COORD_LAMBDA_AFFINE:
      begin
        Y1 := RawYCoord;
        result := ecCurve.CreateRawPoint(x1.SquarePow(pow), Y1.SquarePow(pow), IsCompressed) as IAbstractF2mPoint;
        Exit;
      end;
    ...
    TECCurveConstants.COORD_HOMOGENEOUS, TECCurveConstants.COORD_LAMBDA_PROJECTIVE:
      begin
        Y1 := RawYCoord;
        Z1 := RawZCoords[0];
        result := ecCurve.CreateRawPoint(x1.SquarePow(pow), Y1.SquarePow(pow), TCryptoLibGenericArray<IECFieldElement>.Create(Z1.SquarePow(pow)), IsCompressed) as IAbstractF2mPoint;
        Exit;
      end
...
constructor TECPoint.TValidityCallback.Create(const outer: IECPoint; decompressed, checkOrder: Boolean);
begin
  inherited Create();
  Fm_outer := outer;
...
function TECPoint.TValidityCallback.Precompute(const existing: IPreCompInfo): IPreCompInfo;
var
...
class function TSimpleLookupTable.Copy(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32): TCryptoLibGenericArray<IECPoint>;
var
  i: Int32;
begin
...
constructor TSimpleLookupTable.Create(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32);
begin
  inherited Create();
