...
resourcestring
  SInvalidValueForSecT283FieldElement = 'Value Invalid for SecT283FieldElement "%s"';
...
type
  ...
  const
    ...
    class procedure ImplExpand(const x, z: TCryptoLibUInt64Array); static; inline;
    class procedure ImplMultiply(const x, y, zz: TCryptoLibUInt64Array); static;
    class procedure ImplMulw(x, y: UInt64; const z: TCryptoLibUInt64Array; zOff: Int32); static;
  ...
  public
    ...
    class procedure AddExt(const xx, yy, zz: TCryptoLibUInt64Array); static; inline;
    class procedure AddOne(const x, z: TCryptoLibUInt64Array); static; inline;

    class procedure HalfTrace(const x, z: TCryptoLibUInt64Array); static; inline;

    class function FromBigInteger(const x: TBigInteger): TCryptoLibUInt64Array; static; inline;

    class procedure Invert(const x, z: TCryptoLibUInt64Array); static;
    class procedure Multiply(const x, y, z: TCryptoLibUInt64Array); static; inline;
    class procedure MultiplyAddToExt(const x, y, zz: TCryptoLibUInt64Array); static; inline;
    class procedure Reduce(const xx, z: TCryptoLibUInt64Array); static;
    class procedure Reduce37(const z: TCryptoLibUInt64Array; zOff: Int32); static; inline;
    ...
    class procedure SquareAddToExt(const x, zz: TCryptoLibUInt64Array); static; inline;
    class procedure SquareN(const x: TCryptoLibUInt64Array; n: Int32; const z: TCryptoLibUInt64Array); static; inline;

    class function Trace(const x: TCryptoLibUInt64Array): UInt32; static; inline;
...
type
  ...
  strict private
    ...
    function Equals(const other: ISecT283FieldElement): Boolean; reintroduce; overload;
...
type
  ...
  type
    TSecT283K1LookupTable = class sealed(TAbstractECLookupTable, ISecT283K1LookupTable)
    ...
    public
      ...
      constructor Create(const outer: ISecT283K1Curve; const table: TCryptoLibUInt64Array; size: Int32);
...
class procedure TSecT283Field.Reduce37(const z: TCryptoLibUInt64Array; zOff: Int32);
var
  z4, t: UInt64;
begin
  z4 := z[zOff + 4];
...
begin
  FROOT_Z := TCryptoLibUInt64Array.Create(UInt64($0C30C30C30C30808), UInt64($30C30C30C30C30C3), UInt64($820820820820830C), UInt64($0820820820820820), UInt64($2082082));
end;
...
class function TSecT283Field.FromBigInteger(const x: TBigInteger): TCryptoLibUInt64Array;
begin
...
class procedure TSecT283Field.SquareN(const x: TCryptoLibUInt64Array; n: Int32; const z: TCryptoLibUInt64Array);
var
  tt: TCryptoLibUInt64Array;
begin
{$IFDEF DEBUG}
...
class procedure TSecT283Field.ImplMultiply(const x, y, zz: TCryptoLibUInt64Array);
var
  a, b, p: TCryptoLibUInt64Array;
  u0, u1, u2, u3, v0, v1, v2, v3, A4, A5, B4, B5, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, t30, t31, t32, t33, t34, t35, t36, t37, t38, t39: UInt64;
begin
  // /*
...
class procedure TSecT283Field.ImplMulw(x, y: UInt64; const z: TCryptoLibUInt64Array; zOff: Int32);
var
...
{$ENDIF DEBUG}
  ...
  h := h xor (((x and Int64($0100804020100800)) and UInt64(TBits.Asr64(Int64(y) shl 7, 63))) shr 8);
...
class procedure TSecT283Field.MultiplyAddToExt(const x, y, zz: TCryptoLibUInt64Array);
var
  tt: TCryptoLibUInt64Array;
begin
  tt := TNat320.CreateExt64();
...
class procedure TSecT283Field.SquareAddToExt(const x, zz: TCryptoLibUInt64Array);
var
  tt: TCryptoLibUInt64Array;
begin
  tt := TNat.Create64(9);
...
begin
  ...
  begin
    raise EArgumentCryptoLibException.CreateResFmt(@SInvalidValueForSecT283FieldElement, ['x']);
  end;
  inherited Create();
...
function TSecT283FieldElement.Equals(const other: ISecT283FieldElement): Boolean;
begin
...
function TSecT283FieldElement.Multiply(const b: IECFieldElement): IECFieldElement;
var
  z: TCryptoLibUInt64Array;
begin
  z := TNat320.Create64();
...
function TSecT283FieldElement.MultiplyMinusProduct(const b, x, y: IECFieldElement): IECFieldElement;
begin
  result := MultiplyPlusProduct(b, x, y);
end;

function TSecT283FieldElement.MultiplyPlusProduct(const b, x, y: IECFieldElement): IECFieldElement;
var
...
function TSecT283FieldElement.SquareMinusProduct(const x, y: IECFieldElement): IECFieldElement;
begin
  result := SquarePlusProduct(x, y);
end;

function TSecT283FieldElement.SquarePlusProduct(const x, y: IECFieldElement): IECFieldElement;
var
...
function TSecT283FieldElement.Subtract(const b: IECFieldElement): IECFieldElement;
begin
...
var
  LCurve: IECCurve;
  x1, x2, L1, L2, z1, z2, u2, S2, u1, S1, a, LB, x3, L3, z3, Y1, Y2, l, Y3, AU1, AU2, ABZ2: IECFieldElement;
...
begin
  ...
  result := TSecT283K1Point.Create(LCurve, x3, L3, TCryptoLibGenericArray<IECFieldElement>.Create(z3), IsCompressed);
end;

constructor TSecT283K1Point.Create(const curve: IECCurve; const x, y: IECFieldElement);
begin
  Create(curve, x, y, false);
end;

constructor TSecT283K1Point.Create(const curve: IECCurve; const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean);
begin
  inherited Create(curve, x, y, zs, withCompression);
end;

constructor TSecT283K1Point.Create(const curve: IECCurve; const x, y: IECFieldElement; withCompression: Boolean);
begin
...
begin
  ...
  l := RawYCoord;
  z := RawZCoords[0];
  result := TSecT283K1Point.Create(curve, x, l.Add(z), TCryptoLibGenericArray<IECFieldElement>.Create(z), IsCompressed);
end;
...
var
  LCurve: IECCurve;
  x1, x2, z2, L1, z1, L2, X1Sq, L1Sq, Z1Sq, L1Z1, t, L2plus1, a, X2Z1Sq, LB, x3, z3, L3: IECFieldElement;
begin
  if ((IsInfinity)) then
  begin
    result := b;
...
begin
  ...
  Fm_order := TBigInteger.Create(1, THex.Decode('01FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE9AE2ED07577265DFF7F94451E061E163C61'));
...
function TSecT283K1Curve.CreateCacheSafeLookupTable(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32): IECLookupTable;
var
...
function TSecT283K1Curve.CreateRawPoint(const x, y: IECFieldElement; withCompression: Boolean): IECPoint;
begin
  result := TSecT283K1Point.Create(Self as IECCurve, x, y, withCompression);
end;

function TSecT283K1Curve.CreateRawPoint(const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean): IECPoint;
begin
...
constructor TSecT283K1Curve.TSecT283K1LookupTable.Create(const outer: ISecT283K1Curve; const table: TCryptoLibUInt64Array; size: Int32);
begin
  inherited Create();
  Fm_outer := outer;
  Fm_table := table;
...
function TSecT283K1Curve.TSecT283K1LookupTable.CreatePoint(const x, y: TCryptoLibUInt64Array): IECPoint;
var
  XFieldElement, YFieldElement: ISecT283FieldElement;
  SECT283K1_AFFINE_ZS: TCryptoLibGenericArray<IECFieldElement>;
begin
  SECT283K1_AFFINE_ZS := TCryptoLibGenericArray<IECFieldElement>.Create(TSecT283FieldElement.Create(TBigInteger.One) as ISecT283FieldElement);

  XFieldElement := TSecT283FieldElement.Create(x);
  YFieldElement := TSecT283FieldElement.Create(y);
  result := Fm_outer.CreateRawPoint(XFieldElement, YFieldElement, SECT283K1_AFFINE_ZS, false);
end;
...
function TSecT283K1Curve.TSecT283K1LookupTable.LookupVar(index: Int32): IECPoint;
var
  x, y: TCryptoLibUInt64Array;
  pos, j: Int32;
begin
