...
resourcestring
  SInvalidIVLength = 'Initialisation Vector Must be the Same Length as Block Size';
...
{$IFNDEF _FIXINSIGHT_}
  ...
  SInvalidTooLargeIVLength = 'CTR/SIC mode requires IV no greater than: %u bytes';
...
type
  ...
  /// </summary>
  TCbcBlockCipher = class sealed(TInterfacedObject, ICbcBlockCipher, IBlockCipher)
  ...
  var
    ...
    /// </exception>
    function EncryptBlock(const input: TCryptoLibByteArray; inOff: Int32; const outBytes: TCryptoLibByteArray; outOff: Int32): Int32;
    ...
    /// if the cipher isn't initialised.
    /// </exception>
    function DecryptBlock(const input: TCryptoLibByteArray; inOff: Int32; const outBytes: TCryptoLibByteArray; outOff: Int32): Int32;
  ...
  public
    ...
    /// if the cipher isn't initialised.
    /// </exception>
    function ProcessBlock(const input: TCryptoLibByteArray; inOff: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32;
...
type
  ...
  /// </summary>
  TCfbBlockCipher = class sealed(TInterfacedObject, ICfbBlockCipher, IBlockCipher)
...
type
  ...
  /// </summary>
  TOfbBlockCipher = class sealed(TInterfacedObject, IOfbBlockCipher, IBlockCipher)
...
type
  ...
  /// </summary>
  TSicBlockCipher = class sealed(TInterfacedObject, ISicBlockCipher, IBlockCipher)
...
type
  ...
  public
    ...
    function ProcessByte(input: Byte; const output: TCryptoLibByteArray; outOff: Int32): Int32; override;
    ...
    /// </returns>
    function ProcessBytes(const input: TCryptoLibByteArray; inOff, len: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32; override;
    ...
    /// the number of output bytes copied to out.
    /// </returns>
    function DoFinal(const output: TCryptoLibByteArray; outOff: Int32): Int32; override;
...
function TCbcBlockCipher.DecryptBlock(const input: TCryptoLibByteArray; inOff: Int32; const outBytes: TCryptoLibByteArray; outOff: Int32): Int32;
var
  Length, I: Int32;
...
function TCbcBlockCipher.EncryptBlock(const input: TCryptoLibByteArray; inOff: Int32; const outBytes: TCryptoLibByteArray; outOff: Int32): Int32;
var
  I, &length: Int32;
begin
  if ((inOff + FblockSize) > System.Length(input)) then
  ...
  System.Move(outBytes[outOff], FcbcV[0], System.Length(FcbcV) * System.SizeOf(Byte));
...
function TCbcBlockCipher.ProcessBlock(const input: TCryptoLibByteArray; inOff: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32;
begin
  if Fencrypting then
  begin
...
constructor TCfbBlockCipher.Create(const cipher: IBlockCipher; bitBlockSize: Int32);
begin
  inherited Create();
  Fcipher := cipher;
...
function TCfbBlockCipher.DecryptBlock(const input: TCryptoLibByteArray; inOff: Int32; const outBytes: TCryptoLibByteArray; outOff: Int32): Int32;
var
  I, count: Int32;
begin
  if ((inOff + FblockSize) > System.Length(input)) then
  ...
  System.Move(input[inOff], FcfbV[(System.Length(FcfbV) - FblockSize)], FblockSize * System.SizeOf(Byte));
...
function TCfbBlockCipher.EncryptBlock(const input: TCryptoLibByteArray; inOff: Int32; const outBytes: TCryptoLibByteArray; outOff: Int32): Int32;
var
  I, count: Int32;
begin
  if ((inOff + FblockSize) > System.Length(input)) then
  ...
  System.Move(outBytes[outOff], FcfbV[(System.Length(FcfbV) - FblockSize)], FblockSize * System.SizeOf(Byte));
...
procedure TCfbBlockCipher.Init(forEncryption: Boolean; const parameters: ICipherParameters);
var
  ivParam: IParametersWithIV;
  iv: TCryptoLibByteArray;
  Lparameters: ICipherParameters;
...
function TCfbBlockCipher.ProcessBlock(const input: TCryptoLibByteArray; inOff: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32;
begin
  if Fencrypting then
  begin
    result := EncryptBlock(input, inOff, output, outOff);
...
constructor TOfbBlockCipher.Create(const cipher: IBlockCipher; blockSize: Int32);
begin
  inherited Create();
  Fcipher := cipher;
...
begin
  ...
  begin
    ...
    begin
      ...
      System.Move(iv[0], FIV[System.Length(FIV) - System.Length(iv)], System.Length(iv) * System.SizeOf(Byte));
...
function TOfbBlockCipher.ProcessBlock(const input: TCryptoLibByteArray; inOff: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32;
var
  I, count: Int32;
begin
  if ((inOff + FblockSize) > System.Length(input)) then
  ...
  System.Move(FofbOutV[0], FofbV[(System.Length(FofbV) - FblockSize)], FblockSize * System.SizeOf(Byte));
...
begin
  ...
  begin
    ...
    begin
      raise EArgumentCryptoLibException.CreateResFmt(@SInvalidTooLargeIVLength, [FblockSize]);
    end;
    ...
    begin
      raise EArgumentCryptoLibException.CreateResFmt(@SInvalidTooSmallIVLength, [FblockSize - maxCounterSize]);
    end;
...
function TSicBlockCipher.ProcessBlock(const input: TCryptoLibByteArray; inOff: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32;
var
  I, J: Int32;
begin
...
begin
  inherited Create();
  if Supports(cipher, ICfbBlockCipher) or Supports(cipher, IOfbBlockCipher) or Supports(cipher, ISicBlockCipher) or Supports(cipher, ICtsBlockCipher) then
  begin
...
function TCtsBlockCipher.DoFinal(const output: TCryptoLibByteArray; outOff: Int32): Int32;
var
...
begin
  ...
  begin
    raise EDataLengthCryptoLibException.CreateRes(@SOutputBufferTooSmallForDoFinal);
  end;
  ...
  begin
    ...
    begin
      ...
      System.Move(block[0], output[outOff + blockSize], len * System.SizeOf(Byte));
    end
    else
    begin
  ...
  begin
    ...
    begin
      ...
      System.Move(lastBlock[0], output[outOff + blockSize], len * System.SizeOf(Byte));
    end
    else
    begin
      Fcipher.ProcessBlock(Fbuf, 0, block, 0);
...
function TCtsBlockCipher.ProcessByte(input: Byte; const output: TCryptoLibByteArray; outOff: Int32): Int32;
begin
  result := 0;
...
function TCtsBlockCipher.ProcessBytes(const input: TCryptoLibByteArray; inOff, len: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32;
var
