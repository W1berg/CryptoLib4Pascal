...
begin
  ...
  //
  safePrimes := TDHParametersHelper.GenerateSafePrimes(Fsize, Fcertainty, Frandom);
...
procedure TDHParametersGenerator.Init(size, certainty: Int32; const random: ISecureRandom);
begin
  Fsize := size;
