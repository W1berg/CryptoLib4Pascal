...
type
  ...
  // */
  TWTauNafPreCompInfo = class(TInterfacedObject, IPreCompInfo, IWTauNafPreCompInfo)

  strict private
    function GetPreComp: TCryptoLibGenericArray<IAbstractF2mPoint>; virtual;
    procedure SetPreComp(const value: TCryptoLibGenericArray<IAbstractF2mPoint>); virtual;
  strict protected
  var
    // /**
...
procedure TWTauNafPreCompInfo.SetPreComp(const value: TCryptoLibGenericArray<IAbstractF2mPoint>);
begin
  Fm_preComp := value;
end;
