...
resourcestring
  ...
  SHashCannotNotProduceSufficientData = 'Specified Hash Cannot Produce Sufficient Data for the Specified Operation.';
...
type
  ...
  /// </para>
  /// </summary>
  TPascalCoinECIESKdfBytesGenerator = class(TBaseKdfBytesGenerator, IPascalCoinECIESKdfBytesGenerator)
  ...
  public
    ...
    /// </exception>
    function GenerateBytes(const output: TCryptoLibByteArray; outOff, length: Int32): Int32; override;
...
function TPascalCoinECIESKdfBytesGenerator.GenerateBytes(const output: TCryptoLibByteArray; outOff, length: Int32): Int32;
var
  outLen: Int32;
...
procedure TPascalCoinECIESKdfBytesGenerator.Init(const parameters: IDerivationParameters);
var
