...
type
  IECFieldElement = interface(IInterface)
    ...
    function MultiplyMinusProduct(const b, x, y: IECFieldElement): IECFieldElement;

    function MultiplyPlusProduct(const b, x, y: IECFieldElement): IECFieldElement;
...
type
  ...
  IFpPoint = interface(IAbstractFpPoint)
    ...
    function DoubleProductFromSquares(const a, b, aSquared, bSquared: IECFieldElement): IECFieldElement;

    function CalculateJacobianModifiedW(const z: IECFieldElement; const ZSquared: IECFieldElement): IECFieldElement;
  ...
  IECCurve = interface(IInterface)
    ...
    function CreateRawPoint(const x, y: IECFieldElement; withCompression: Boolean): IECPoint; overload;

    function CreateRawPoint(const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean): IECPoint; overload;

    function CreateDefaultMultiplier(): IECMultiplier;

    procedure CheckPoint(const point: IECPoint);

    procedure CheckPoints(const points: TCryptoLibGenericArray<IECPoint>); overload;

    procedure CheckPoints(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32); overload;
    ...
    function ValidatePoint(const x, y: TBigInteger; withCompression: Boolean): IECPoint; overload; deprecated 'Per-point compression property will be removed';

    function CreateCacheSafeLookupTable(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32): IECLookupTable;

    function CreatePoint(const x, y: TBigInteger): IECPoint; overload;

    function CreatePoint(const x, y: TBigInteger; withCompression: Boolean): IECPoint; overload; deprecated 'Per-point compression property will be removed';

    function SupportsCoordinateSystem(coord: Int32): Boolean;

    function GetPreCompInfo(const point: IECPoint; const name: string): IPreCompInfo;
    ...
    /// </param>
    function Precompute(const point: IECPoint; const name: string; const callback: IPreCompCallback): IPreCompInfo;
    ...
    /// </param>
    procedure NormalizeAll(const points: TCryptoLibGenericArray<IECPoint>); overload;
    ...
    /// </param>
    procedure NormalizeAll(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32; const iso: IECFieldElement); overload;
