...
type
  ...
  private
    ...
    Blake2BTreeHashingMode = '3AD2A9B37C6070E374C7A8C508FE20CA86B6ED54E286E93A0318E95E881DB5AA';
...
type
  ...
  protected
    ...
    const
    RawKeyInHex = '404142434445464748494A4B4C4D4E4F505152535455565758595A5B5C5D5E5F';
...
type
  ...
  private
    ...
    procedure DoComputeKMAC128(const AKey, ACustomization, AData, AExpectedResult: string; AOutputSizeInBits: UInt64; IsXOF: Boolean);
...
type
  ...
  private
    ...
    procedure DoComputeKMAC256(const AKey, ACustomization, AData, AExpectedResult: string; AOutputSizeInBits: UInt64; IsXOF: Boolean);
...
type
  ...
  private
    ...
    procedure DoComputeBlake2BMAC(const AKey, APersonalisation, ASalt, AData, AExpectedResult: string; AOutputSizeInBits: Int32);
...
type
  ...
  private
    ...
    procedure DoComputeBlake2SMAC(const AKey, APersonalisation, ASalt, AData, AExpectedResult: string; AOutputSizeInBits: Int32);
...
begin
  ...
  HashOfABCDE := 'B18CFD04F92DC1D83325036BC723D36DB25EDE41AE879D2545FC7F377B700899';
  HashOfDefaultDataHMACWithShortKey := '6E4E2895E194BEB0A083B1DED6C4084F5E7F37BAAB988D288D9707235F2F8294';
  HashOfDefaultDataHMACWithLongKey := 'DE9D68F7793C829E7369AC09493A7749B2637A7B1D572A70549936E09F2D1D82';
end;
...
begin
  ...
  HashOfABCDE := '5CDA73422F36E41087795BB6C21D577BAAF114E4A6CCF33D919E700EE2489FE2';
  HashOfDefaultDataHMACWithShortKey := '65BA6F8EFA5B566D556EC8E3A2EC67DB7EE9BDEE663F17A8B8E7FAD067481023';
  HashOfDefaultDataHMACWithLongKey := '02D964EE346B0C333CEC0F5D7E68C5CFAAC1E3CB0C06FE36418E17AA3AFCA2BE';
end;
...
begin
  ...
  HMACInstance := THashFactory.THMAC.CreateHMAC(HashInstance);
  HashOfEmptyData := 'EE0BA85F90B6D232430BA43DD0EDD008462591816962A355602ED214FAAE54A9A4607D6F577CE950421FF58AEA53F51A7A9F5CCA894C3776104D43568FEA1207';
  HashOfDefaultData := '540F3C6A5070DA391BBA7121DB8F8745752D3515164498FC82CB5B4D837632CF3F256D85C4A0B7F34A86936FAB07BDA2DF2BFDD59AFDBD901E1347C2001DB1AD';
  HashOfOnetoNine := '6845F20B8A9DB083F307844506D342ED0FEE0D16BAF64B22E6C07552CB8C907E936FEDCD885B72C1B05813F722B5706C112AD59D3421CFD88CAA1CFB40EF1BEF';
  HashOfABCDE := 'F282C47F31831EAB58B8EE9D1EEE3B9B5A6A86354EEFE84CA3176BED5AB447E6D5AC82316F2D6FAAD350848E2D418336A57772D96311DA8BC51C93087204C6A5';
  HashOfDefaultDataHMACWithShortKey := '7F067A454A4F6300982CAE37900171C627992A75A5567E0D3A51BC6672F79C5AC0CEF5978E933B713F38494DDF26114994C47689AC93EEC9B8EF7892C3B24087';
  HashOfDefaultDataHMACWithLongKey := '59A3F868AE1844BA9B683760D62C73E6E254BE6F46DF923F45118F32E9E1AB80A9056AA8A4792F0D6B8C709919C0ACC64EF64FC013C919758841AE6026F47E61';
end;
...
begin
  ...
  HashOfDefaultDataHMACWithLongKey := '7D2F0051F2BD817A4C27F126882353BCD300B7CA';
end;
...
begin
  ...
  HashOfDefaultDataHMACWithLongKey := 'B42F2273A6220C65B5ADAE1A9A1188B9D4398D2A';
end;
...
begin
  ...
  HashOfDefaultDataHMACWithLongKey := 'E7969DB764172896F2467CF74F62BBE231E2772D';
end;
...
begin
  ...
  HashOfDefaultDataHMACWithLongKey := 'EF034569FB10312F89F3FC09DDD9AA5C783A7E21';
end;
...
begin
  ...
  HashOfDefaultDataHMACWithLongKey := 'AE216E5FA60AE76305DA19EE908FA0531FFE52BCC6A2AB5F';
end;
...
begin
  ...
  HashOfDefaultDataHMACWithLongKey := 'F5C16DFD598655201E6C636B363484FFAED4CCA27F3366A1';
end;
...
begin
  ...
  HashOfDefaultDataHMACWithLongKey := 'C28A804383403F608CB4A6473BCAF744CF25E62AF28C5934';
end;
...
begin
  ...
  HashOfDefaultDataHMACWithLongKey := '64F21A46C5B17F4AAD8C28F970428BAA00C4096132369A7E5C0B2F67';
end;
...
begin
  ...
  HashOfDefaultDataHMACWithLongKey := '462C126C107ADA83089EB66168831EB6804BA6062EC8D049B9B47D2B';
end;
...
begin
  ...
  HashOfDefaultDataHMACWithLongKey := '1DD7A2CF3F32F5C447F50D5A3F6B9C421B243E310C3C292581F95447';
end;
...
begin
  ...
  HashOfABCDE := '3913AB70F6219EEFE10B202DE5991EFDBC4A808203BD60BBFBFC043383AE8F90';
  HashOfDefaultDataHMACWithShortKey := '7E24B475617096B102F0F64572E297144B35683476D1768CB35C0E0A43A6BF8F';
  HashOfDefaultDataHMACWithLongKey := 'A587C118D2A575F91A7D3986F0893A32F8DBE13218D4B3CDB93DD0B7566E5003';
end;
...
begin
  ...
  HashOfABCDE := '8F9B46785E52C6C48A0178EDC66D3C23C220D15E52C3C8A13E1CD45D21369193';
  HashOfDefaultDataHMACWithShortKey := 'FD0122B375A581D3F06DB6EB992F9A3F46657091E427BB8BD247D835CC086437';
  HashOfDefaultDataHMACWithLongKey := 'ED5D88C730ED3EB103DDE96AD42DA60825A9B8B0D8BD2ED580EBF92B851B12E7';
end;
...
begin
  ...
  HashOfABCDE := 'C464C9A669D5B43E4C34808114DCE4ECC732D1B71407E7F05468D0B15BFF7E30';
  HashOfDefaultDataHMACWithShortKey := 'C702F985817A2596D7E0BB073D71DFEF72D77BD45599DD4F7E5D83A8EAF7268B';
  HashOfDefaultDataHMACWithLongKey := '267B5C9F0A093726E47541C8F1DEADD400AD9AEE0145A59FBD5A18BA2877101E';
end;
...
begin
  ...
  HashOfABCDE := 'B064E5476A3F511105B75305FC2EC31578A6B200FB5084CF937C179F1C52A891';
  HashOfDefaultDataHMACWithShortKey := '3C15C9B7CDC77470BC02CA96711B66FAA976AC2044F6F177ABCA93B1442EA376';
  HashOfDefaultDataHMACWithLongKey := '93226A060B4A82D1D9FBEE6B78424F8E3E871BE7DA77A9D17D5C78D5F415E631';
end;
...
begin
  ...
  HashOfABCDE := 'A593059B12513A1BD88A2D433F07B239BC14743AF0FF7294837B5DF756BF9C7A';
  HashOfDefaultDataHMACWithShortKey := '72EB7D36180C1B1BBF88E062FEC7419DBB4849892623D332821C1B0D71D6D513';
  HashOfDefaultDataHMACWithLongKey := 'CD48D590665EA2C066A0C26E2620D567C75090DE38045B88C53BFAE685D67886';
end;
...
begin
  ...
  HashOfABCDE := '36B4DD23A97424844662E882AD1DA1DBAD8CB435A57F380455393C9FF9DE9D37';
  HashOfDefaultDataHMACWithShortKey := 'FA280F80C1323C32AACC7F1CAB3808FE2BB8880F901AE6F03BD14D6D1884B267';
  HashOfDefaultDataHMACWithLongKey := 'B9CBBB9FE06144CF5E369BDBBCB2C76EBBE8904061C356BA9A06FE2D96E4037F';
end;
...
begin
  ...
  HashOfDefaultDataHMACWithLongKey := '4C373970BDB829BE3B6E0B2D9F510E9C35C9B583';
end;
...
begin
  ...
  HashOfABCDE := '81D8B58A3110A9139B4DDECCB031409E8AF023067CF4C6F0B701DAB9ECC0EB4E';
  HashOfDefaultDataHMACWithShortKey := 'D59B820A708FA31C39BD33BA88CB9A25516A3BA2BA99A74223FCE0EC0F9BFB1B';
  HashOfDefaultDataHMACWithLongKey := 'F1149704222B7ABA1F9C14B0E9A67909C53605E07614CF8C47CB357083EA3A6B';
end;
...
begin
  ...
  HashOfABCDE := 'A94DC1BC825DB64E97718305CE36BFEF32CC5410A630999678BCD89CC38C424269012EC8C5A95830';
  HashOfDefaultDataHMACWithShortKey := '4D3DFCCB43E5A60611A850C2141086CB16752505BA12E1B7953EA8859CB1E1DF3A698562A46DB41C';
  HashOfDefaultDataHMACWithLongKey := '248D14ED08F0F49D175F4DC487A64B81F06D78077D1CF975BBE5D47627995990EBE45E6B7EDF9362';
end;
...
begin
  ...
  HashOfDefaultDataHMACWithLongKey := 'CDA87167A558311B9154F372F21A453030BBE16A';
end;
...
begin
  ...
  HashOfDefaultDataHMACWithLongKey := 'E70699720F4222E3A4A4474F14F13CBC3316D9B2';
end;
...
begin
  ...
  HashOfDefaultDataHMACWithLongKey := '86855E59D8B09A3C7632D4E176C4B65C549255F417FEF9EEF2D4167D';
end;
...
begin
  ...
  HashOfABCDE := '36BBE50ED96841D10443BCB670D6554F0A34B761BE67EC9C4A8AD2C0C44CA42C';
  HashOfDefaultDataHMACWithShortKey := '92678A1C746AAEAA1D3F0C9DAC4BCA73801D278B51C1F6861D49C9A2C1175687';
  HashOfDefaultDataHMACWithLongKey := 'BC05A7D3B13A4A67445C62389564D35B18F33A0C6408EC8DA0CB2506AE6E2D14';
end;
...
begin
  ...
  HMACInstance := THashFactory.THMAC.CreateHMAC(HashInstance);
  HashOfEmptyData := '38B060A751AC96384CD9327EB1B1E36A21FDB71114BE07434C0CC7BF63F6E1DA274EDEBFE76F65FBD51AD2F14898B95B';
  HashOfDefaultData := '05D165ADA4A6F9F550CB6F9A0E00401E628B302FA5D7F3824361768758421F83102AC611B2710F5168579CFB11942869';
  HashOfOnetoNine := 'EB455D56D2C1A69DE64E832011F3393D45F3FA31D6842F21AF92D2FE469C499DA5E3179847334A18479C8D1DEDEA1BE3';
  HashOfABCDE := '4C525CBEAC729EAF4B4665815BC5DB0C84FE6300068A727CF74E2813521565ABC0EC57A37EE4D8BE89D097C0D2AD52F0';
  HashOfDefaultDataHMACWithShortKey := '3D6DCED731DAF3599CC0971646C1A8B8CCC61650722F111A9EB26CE7B65189EB220EACB09152D9A09065099FE6C1FDC9';
  HashOfDefaultDataHMACWithLongKey := '162295D136DB47205EDF45BF8687E5599DFA80C6AE79D83C03E729C48D373E19638ADD5B5D603558234DF755404CCF9E';
end;
...
begin
  ...
  HMACInstance := THashFactory.THMAC.CreateHMAC(HashInstance);
  HashOfEmptyData := 'CF83E1357EEFB8BDF1542850D66D8007D620E4050B5715DC83F4A921D36CE9CE47D0D13C5D85F2B0FF8318D2877EEC2F63B931BD47417A81A538327AF927DA3E';
  HashOfDefaultData := '0A5DA12B113EBD3DEA4C51FD10AFECF1E2A8EE6C3848A0DD4407141ADDA04375068D85A1EEF980FAFF68DC3BF5B1B3FBA31344178042197B5180BD95530D61AC';
  HashOfOnetoNine := 'D9E6762DD1C8EAF6D61B3C6192FC408D4D6D5F1176D0C29169BC24E71C3F274AD27FCD5811B313D681F7E55EC02D73D499C95455B6B5BB503ACF574FBA8FFE85';
  HashOfABCDE := '878AE65A92E86CAC011A570D4C30A7EAEC442B85CE8ECA0C2952B5E3CC0628C2E79D889AD4D5C7C626986D452DD86374B6FFAA7CD8B67665BEF2289A5C70B0A1';
  HashOfABCDE := '5D745E26CCB20FE655D39C9E7F69455758FBAE541CB892B3581E4869244AB35B4FD6078F5D28B1F1A217452A67D9801033D92724A221255A5E377FE9E9E5F0B2';
  HashOfDefaultDataHMACWithShortKey := '72B3CFC10CC32F9203670984407594B9F2A6C9F1A46C3FF7DF76AD07207758F96CF46C448A7687EBBA5EBC046984B4837320306EB27978A58B8CF447978CADEA';
  HashOfDefaultDataHMACWithLongKey := 'A2CF231E2E01B310A91A7BF92435AE0258997AB969D0B2E09378C0F30C73E4434894A836B3F580683F58FC56DA87C685927AE0FC80D2548A35CD3C7528A83AC1';
end;
...
var
  LBuffer: TBytes;
  Blake2BTreeConfigh00, Blake2BTreeConfigh01, Blake2BTreeConfigh10: IBlake2BTreeConfig;
  h00, h01, h10: IHash;
begin
  LBuffer := nil;
  ...
  h00 := THashFactory.TCrypto.CreateBlake2B(TBlake2BConfig.Create() as IBlake2BConfig, Blake2BTreeConfigh00);
  h00.Initialize;
  ...
  h01 := THashFactory.TCrypto.CreateBlake2B(TBlake2BConfig.Create() as IBlake2BConfig, Blake2BTreeConfigh01);
  h01.Initialize;
  ...
  h10 := THashFactory.TCrypto.CreateBlake2B(TBlake2BConfig.Create(32) as IBlake2BConfig, Blake2BTreeConfigh10);
  h10.Initialize;

  h10.TransformBytes(h00.ComputeBytes(System.Copy(LBuffer, 0, LEAF_SIZE)).GetBytes());

  h10.TransformBytes(h01.ComputeBytes(System.Copy(LBuffer, LEAF_SIZE, UInt32(System.Length(LBuffer)) - LEAF_SIZE)).GetBytes());

  ActualString := h10.TransformFinal().ToString();
  ExpectedString := Blake2BTreeHashingMode;

  CheckEquals(ExpectedString, ActualString, Format('Expected %s but got %s.', [ExpectedString, ActualString]));
end;
...
begin
  ...
  begin
    ...
    ExpectedString := THashFactory.TCrypto.CreateBlake2B(LConfigNoKeyed).ComputeBytes(LMainData).ToString();

    ActualString := THashFactory.TCrypto.CreateBlake2B(LConfigNullKeyed).ComputeBytes(LMainData).ToString();

    CheckEquals(ExpectedString, ActualString, Format('Expected %s but got %s at Index %d', [ExpectedString, ActualString, LIdx]));
  end;
end;
...
begin
  ...
  HMACInstance := THashFactory.THMAC.CreateHMAC(HashInstance);
  HashOfEmptyData := '786A02F742015903C6C6FD852552D272912F4740E15847618A86E217F71F5419D25E1031AFEE585313896444934EB04B903A685B1448B755D56F701AFE9BE2CE';
  HashOfDefaultData := '154F99998573B5FC21E3DF86EE1E0161A6E0E912C4361088FE46D2E3543070EFE9746E326BC09E77EC06BCA60955538821C010411B4D0D6BF9BF2D2221CC8017';
  HashOfOnetoNine := 'F5AB8BAFA6F2F72B431188AC38AE2DE7BB618FB3D38B6CBF639DEFCDD5E10A86B22FCCFF571DA37E42B23B80B657EE4D936478F582280A87D6DBB1DA73F5C47D';
  HashOfABCDE := 'F3E89A60EC4B0B1854744984E421D22B82F181BD4601FB9B1726B2662DA61C29DFF09E75814ACB2639FD79E56616E55FC135F8476F0302B3DC8D44E082EB83A8';
  HashOfDefaultDataHMACWithShortKey := '945EF4F96C681CC9C30A3EB1193FA13FD4ACD87D7C4A86D62AC9D8DCA74A32BB0DDC055EA75383A653E06B8E25266154DE5BE6B23C69723B795A1680EE844834';
  HashOfDefaultDataHMACWithLongKey := '8E6F664622E2637AE477C00F314087FF8F6A8142D8CCF8946A451982AB750566DFD9BF97A50D705389FBF450525098797924DC443EFFDB1A1C945ECEA5DE9553';
...
var
  LBuffer: TBytes;
  Blake2STreeConfigh00, Blake2STreeConfigh01, Blake2STreeConfigh10: IBlake2STreeConfig;
  h00, h01, h10: IHash;
begin
  LBuffer := nil;
  System.SetLength(LBuffer, 6000);
  ...
  h00 := THashFactory.TCrypto.CreateBlake2S(TBlake2SConfig.Create() as IBlake2SConfig, Blake2STreeConfigh00);
  h00.Initialize;
  ...
  h01 := THashFactory.TCrypto.CreateBlake2S(TBlake2SConfig.Create() as IBlake2SConfig, Blake2STreeConfigh01);
  h01.Initialize;
  ...
  h10 := THashFactory.TCrypto.CreateBlake2S(TBlake2SConfig.Create(16) as IBlake2SConfig, Blake2STreeConfigh10);
  h10.Initialize;
...
begin
  ...
  begin
    ...
    ExpectedString := THashFactory.TCrypto.CreateBlake2S(LConfigNoKeyed).ComputeBytes(LMainData).ToString();

    ActualString := THashFactory.TCrypto.CreateBlake2S(LConfigNullKeyed).ComputeBytes(LMainData).ToString();
...
begin
  ...
  HMACInstance := THashFactory.THMAC.CreateHMAC(HashInstance);
  HashOfEmptyData := '69217A3079908094E11121D042354A7C1F55B6482CA1A51E1B250DFD1ED0EEF9';
  HashOfDefaultData := 'D9DB23D51529BC163546C2C76F9FDC4611118A691352524D6BCCF5C79AF89E14';
  HashOfOnetoNine := '7ACC2DD21A2909140507F37396ACCE906864B5F118DFA766B107962B7A82A0D4';
  HashOfABCDE := '4BD7246C13721CC5B96F045BE71D49D5C82535332C6903771AFE9EF7B772136F';
  HashOfDefaultDataHMACWithShortKey := '105C7994CB1F775C709A9FBC9641FB2495311258268134F460B9895915A7519A';
  HashOfDefaultDataHMACWithLongKey := '1CB9502C2FE830B46849F2C178BE527BF4B1B80B0B002F6FAC18C0A7ABD3B636';
...
begin
  ...
  HashOfDefaultDataHMACWithLongKey := '8C500F95CB013CBC16DEB6CB742D470E20404E0A1776647EAAB6E869';
end;
...
begin
  ...
  HashOfABCDE := '6377C7E66081CB65E473C1B95DB5195A27D04A7108B468890224BEDBE1A8A6EB';
  HashOfDefaultDataHMACWithShortKey := '1660234E7CCC29CFC8DEC8C6508AAF54EE48004EA9B56A15AC5742C89AAADA08';
  HashOfDefaultDataHMACWithLongKey := '925FE69CEF38AA0D2CCBF6741ADD808F204CAA64EFA7E301A0A3EC332E40075E';
end;
...
begin
  ...
  HashOfABCDE := 'F996518E4703A5D660B250D720A143B0A44C5DE31819A82FEF0F30158D18E74E6DF405F6';
  HashOfDefaultDataHMACWithShortKey := '615143BAA85817D4F6F051E33801A900AEA480E716A01826E1392743A92B46EED587E9F7';
  HashOfDefaultDataHMACWithLongKey := 'EDC893C0E0E9E70F299098D5049D82EE6811582B93B5C38A5DC9FD14F984A352042365D0';
end;
...
begin
  ...
  HMACInstance := THashFactory.THMAC.CreateHMAC(HashInstance);
  HashOfEmptyData := '2C23146A63A29ACF99E73B88F8C24EAA7DC60AA771780CCC006AFBFA8FE2479B2DD2B21362337441AC12B515911957FF';
  HashOfDefaultData := '6A53977DFA0BCDCF069635CF541AB64C7E41923FCB3A5B049AB98878411D0E71DF95FCAB0072F1AE8B931BF4490B823E';
  HashOfOnetoNine := 'EFCCAE72CE14656C434751CF737E70A57AB8DD2C76F5ABE01E52770AFFD77B66D2B80977724A00A6D971B702906F8032';
  HashOfABCDE := '6E577A02A783232ACF34841399883F5F69D9AC78F48C7F4431CBC4F669C2A0F1CA3B1BECB7701B8315588D64D6C3746A';
  HashOfDefaultDataHMACWithShortKey := '044628643016E3EA30DE6CA3A8A1276F6BF1A5443CEF96BAA73199CF64FFC52D7F38254C671DB2933FFC8DD3E5B77223';
  HashOfDefaultDataHMACWithLongKey := 'A7740E29EEF80306DA09D7AF0868E925D6144996F99A01F973F03C4BD85D1EC20567936CA34A443B62A890AD8D263D2A';
end;
...
begin
  ...
  HMACInstance := THashFactory.THMAC.CreateHMAC(HashInstance);
  HashOfEmptyData :=
  HashOfDefaultData := '5ADFC3100CED2EDF93D530E747544B1FF88981E2C8BF4BCA95C434FAEA991718';
  HashOfOnetoNine := 'EA2BBB210CCC659A88EEE6D07900D719E26D801CC6A5E6214214EBA376FF28A5';
  HashOfABCDE := '3B42907077820444C727CF6B1FD6CC5E9BF8AA5489F57010670D4045AC0A1466';
  XofOfEmptyData := '217B64B104155F7158277FC5B0AFB954138C93A6F1269DC4C642A781BA20EB24B3B4B5C7E6C13645DD584D851BD4280B24E1DBA29C512D3CBD6A5C84A708C1D536A6654DDD1D8E3' +
    ...
    '3EB53418FB69257FF807691FA896E6486D54FD991E927C492D15C0C9B01D905FAD6FFA294C484DFA6B74400CBDD414A85D458DBFFC366C2AFACCEC7E4EA8D7AB75F52FAAD995ED9CB45D' + 'C69A8D906E1C09A60DEF1447A3D724F54CCE6';
end;
...
begin
  ...
  for LIdx := 0 to System.Pred(System.Length(TBlake2STestVectors.FBlake2XS_XofTestVectors)) do
  begin
    LVector := TBlake2STestVectors.FBlake2XS_XofTestVectors[LIdx];
    LInput := TConverters.ConvertHexStringToBytes(TBlake2STestVectors.FBlake2XS_XofTestInput);
    LKey := TConverters.ConvertHexStringToBytes(LVector[0]);

    LHash := THashFactory.TXOF.CreateBlake2XS(LKey, (System.Length(LVector[1]) shr 1) * 8);
    LHash.Initialize;
    LHash.TransformBytes(LInput);
    LOutput := LHash.TransformFinal().GetBytes();

    if not AreEqual(LOutput, TConverters.ConvertHexStringToBytes(LVector[1])) then
    begin
      Fail(Format('BLAKE2XS mismatch on test vector, Expected "%s" but got "%s"', [LVector[1], TConverters.ConvertBytesToHexString(LOutput, False)]));
    end;
    ...
    if (not AreEqual(LOutput, TConverters.ConvertHexStringToBytes(LVector[1]))) then
    begin
      Fail(Format('BLAKE2XS mismatch on test vector after a reset, Expected "%s" but got "%s"', [LVector[1], TConverters.ConvertBytesToHexString(LOutput, False)]));
    end;
    ...
    begin
      Fail(Format('BLAKE2XS mismatch on test vector test vector against a clone, Expected "%s" but got "%s"', [LVector[1], TConverters.ConvertBytesToHexString(LOutputClone, False)]));
    end;
  end;
end;
...
begin
  ...
  HashOfEmptyData := 'C5EF3D8845B9B2BA8EA28E9326C9E46E7A5843AD42BACAF927798BEAF554A43CA0830CCF8BB4A24CE1B1D82BD2DA971AFB2BE73919CC5FFF8E7C6A20F87284FA';
  HashOfDefaultData := '9A4C47E816EF6A06F9708B8AE2FEE224F18565CE1F08B848945B73A961BB5E83D79B3A71BE6E324243483C265007A2CD67DE3150C26DC799CE7FC201981AC80A';
  HashOfOnetoNine := '3FD021E013DF681EE479A6E3CE7D36E53971946C586147D59EECF1634C31C318F03BBCE3CDB0B1EC5CD4BD4EDF8ED1441A37754899BB3D8850FCA5EBE0639ABB';
  HashOfABCDE := '81B9FF044391492C89822F8A96279128E876FC5326B0C5C83552B503409F1A6A6CA66DAECE711FE4FCC5DBD92D8560172A64472FAF845CAA7F4297E17ECA1283';
  XofOfEmptyData := '85DDB224AFA3113F145AC1AA3618BD7496FDC79AF14372734A2CDCE9E8DA30029454BAF1C2D78D528F011B3F3FE824CF05B28C4CF34791B3595AC30AB7B348F' +
    ...
    'E1B03FC5390199A7607CA7E45CDAD99411A850125C90AD526C2008293185C1B5B008A458F8F885C8614F317ED52DBAF3E82D0A4B0E47E41C63F145FB17B994B5E9829D8138876A3ADA' + '872FD00914654D504245150B178B919D9F9A7219DB86595D3AACA009798FB52DD0D28F8FFBE4D75063EFD98E655CDEE16';
end;
...
begin
  ...
  for LIdx := 0 to System.Pred(System.Length(TBlake2BTestVectors.FBlake2XB_XofTestVectors)) do
  begin
    LVector := TBlake2BTestVectors.FBlake2XB_XofTestVectors[LIdx];
    LInput := TConverters.ConvertHexStringToBytes(TBlake2BTestVectors.FBlake2XB_XofTestInput);
    LKey := TConverters.ConvertHexStringToBytes(LVector[0]);

    LHash := THashFactory.TXOF.CreateBlake2XB(LKey, (System.Length(LVector[1]) shr 1) * 8);
    LHash.Initialize;
    LHash.TransformBytes(LInput);
    LOutput := LHash.TransformFinal().GetBytes();
    ...
    if not AreEqual(LOutput, TConverters.ConvertHexStringToBytes(LVector[1])) then
    begin
      Fail(Format('BLAKE2XB mismatch on test vector, Expected "%s" but got "%s"', [LVector[1], TConverters.ConvertBytesToHexString(LOutput, False)]));
    end;
    ...
    if (not AreEqual(LOutput, TConverters.ConvertHexStringToBytes(LVector[1]))) then
    begin
      Fail(Format('BLAKE2XB mismatch on test vector after a reset, Expected "%s" but got "%s"', [LVector[1], TConverters.ConvertBytesToHexString(LOutput, False)]));
    end;
    ...
    if (not AreEqual(LOutput, LOutputClone)) then
    begin
      Fail(Format('BLAKE2XB mismatch on test vector test vector against a clone, Expected "%s" but got "%s"', [LVector[1], TConverters.ConvertBytesToHexString(LOutputClone, False)]));
    end;
  end;
end;
...
begin
  ...
  HashOfEmptyData := 'AF1349B9F5F9A1A6A0404DEA36DCC9499BCB25C9ADC112B7CC9A93CAE41F3262';
  HashOfDefaultData := 'BB8DB7E4155BFDB254AD49D8D3105C57B6AC3E783E6D316A75E8B8F8911EB41F';
  HashOfOnetoNine := 'B7D65B48420D1033CB2595293263B6F72EABEE20D55E699D0DF1973B3C9DEED1';
  HashOfABCDE := '0648C03B5AD9BB6DDF8306EEF6A33EBAE8F89CB4741150C1AE9CD662FDCC1EE2';
  HashOfDefaultDataHMACWithShortKey := 'D4DE3C2DE89625AF7076FEC6CFD7B0D318665514D1F88CF68F567AC4971B6681';
  HashOfDefaultDataHMACWithLongKey := 'A7F72F6A236F4572079427B0FD44516705B3322FB3A8D85ACFCB759804529E96';
end;
...
begin
  ...
  HashOfEmptyData := 'AF1349B9F5F9A1A6A0404DEA36DCC9499BCB25C9ADC112B7CC9A93CAE41F3262E00F03E7B69AF26B7FAAF09FCD333050338DDFE085B8CC869CA98B206C08243A';
  HashOfDefaultData := 'BB8DB7E4155BFDB254AD49D8D3105C57B6AC3E783E6D316A75E8B8F8911EB41F800B6ACB7F3593E1787BF62433D016B800B75C14C4E3E395FC5571ADEB1A7143';
  HashOfOnetoNine := 'B7D65B48420D1033CB2595293263B6F72EABEE20D55E699D0DF1973B3C9DEED15042F0A21EE5D17C59E507AE27E48A7CD85F69DCD816C5F421883F36E513D9FE';
  HashOfABCDE := '0648C03B5AD9BB6DDF8306EEF6A33EBAE8F89CB4741150C1AE9CD662FDCC1EE2AB9CED8A57741468B7C3163AF41767186CE877C7AE21260064FD4EAD6004D549';
  XofOfEmptyData := 'AF1349B9F5F9A1A6A0404DEA36DCC9499BCB25C9ADC112B7CC9A93CAE41F3262E00F03E7B69AF26B7FAAF09FCD333050338DDFE085B8CC869CA98B206C08243A26F5' + '487789E8F660AFE6C99EF9E0C52B92E7393024A80459CF91F476F9FFDBDA7001C22E159B402631F277CA96F2DEFDF1078282314E763699A31C5363165421CCE14D30F' +
    '8A03E49EE25D2EA3CD48A568957B378A65AF65FC35FB3E9E12B81CA2D82CDEE16C68908A6772F827564336933C89E6908B2F9C7D1811C0EB795CBD5898FE6F5E8AF7633' + '19CA863718A59AFF3D99660EF642483E217EF0C8785827284FEA90D42225E3CDD6A179BEE852FD24E7D45B38C27B9C2F9469EA8DBDB893F00E28534C7D15B59BADD5A5BDE' +
    'B090E98EB93C5B2F42101394ACB7C72E9B60094D5442096754600DB8C0FA6DBDFEA154C324C07BF17B7AB0D1488AE5EF76CB7611BAEF17087D84C08B4F950D3D85E00E7001' + '813FE029A10722BB003531D5AE406386E78CCA4CA7CACE8A41D294F6EE3B1C645832109B5B19304360B8AB79581E351C518849EAA7C7E14F37BA5B769D2CAF191F9DDEE2D49' +
    '82B6213947A7D047A03F5E456F2588F56E4075C756A319299FBA4001C4B6FB89FBFD93B0739DC684424A439CEFB447D5E191919C4581BC153BD2F2FAE39758F1322AE52EA8B2' + 'D859887A71F70C03E28765709711950C2C06BF5C7D1BB6C235F722CE6DB047FE97CF74B87ADBD6531CB14A1193A8974F939DD2EB21335793880279905402DBDA8B5EC0A7C82A' +
    '69151BB42F7126E4157A510C6123139815BA3DF3FD1D810795D1F4F49CB8B0D63D8D07833CE95FCFF2B8B8677D1F6C3EE3CF2A00CE72A32E93F5E225A065A0726DC5C9AD5C26F' + '2C3560E401BA5079C3D63A8B29175BC9597B09A2BE664E6641F2D2EBFAFE58D5C025EE367396B4C0E31F9D761B779FF27DBAB678CFBB3C62460CC68A4C3187E9788E045EC92437' +
    '1C3027903A42059D1ED659406706C5E4381C931886A034E20689FFA78221E39B42326A9725C5D669D5E2ABAA1C4640AFC7E4D3A5FF5C5513F1B13BF865F4F02EC09453DBD0BCD1D0' + 'AC3444141CC78B662F00811F095D1A1614EDCB516C70FB3BBF4C9ED58F8FBBDDE8CB1B5497585C53FB33EB7A98810780056C9952848F129D5A87DD36774C1B91E135C1ACEF799E6E4'
    ...
    'D4CAFB5ABC45FC9FCA9780C26F457EA9DDCF5370A4D042BC5B9BFA87FAC10F88B170CD22CB9AB2255B251529272BADDF757AD471C4935363495B8E626421859FF304F6D5D527AAE2AF' + '7444F3E14C8CD41F9BB1E19A1418E08A5B535C79554';
end;
...
var
  ...
  LVector: THashLibStringArray;
  LFullInput, LChunkedInput, LNilKey, LKey, LOutput, LOutputClone, LKeyedOutput, LKeyedOutputClone, LCtx, LSubKey: TBytes;
...
begin
  ...
  for LIdx := 0 to System.Pred(System.Length(TBlake3TestVectors.FBlake3_XofTestVectors)) do
  begin
    LVector := TBlake3TestVectors.FBlake3_XofTestVectors[LIdx];
    LChunkedInput := System.Copy(LFullInput, 0, StrToInt(LVector[0]));

    LHash := THashFactory.TXOF.CreateBlake3XOF(LNilKey, (System.Length(LVector[1]) shr 1) * 8);

    LKeyedHash := THashFactory.TXOF.CreateBlake3XOF(LKey, (System.Length(LVector[2]) shr 1) * 8);
    ...
    if not AreEqual(LOutput, TConverters.ConvertHexStringToBytes(LVector[1])) then
    begin
      Fail(Format('BLAKE3XOF mismatch on test vector, Expected "%s" but got "%s"', [LVector[1], TConverters.ConvertBytesToHexString(LOutput, False)]));
    end;

    if not AreEqual(LKeyedOutput, TConverters.ConvertHexStringToBytes(LVector[2])) then
    begin
      Fail(Format('BLAKE3XOF mismatch on keyed test vector, Expected "%s" but got "%s"', [LVector[2], TConverters.ConvertBytesToHexString(LKeyedOutput, False)]));
    end;
    ...
    if (not AreEqual(LOutput, TConverters.ConvertHexStringToBytes(LVector[1]))) then
    begin
      Fail(Format('BLAKE3XOF mismatch on test vector after a reset, Expected "%s" but got "%s"', [LVector[1], TConverters.ConvertBytesToHexString(LOutput, False)]));
    end;

    if (not AreEqual(LKeyedOutput, TConverters.ConvertHexStringToBytes(LVector[2]))) then
    begin
      Fail(Format('BLAKE3XOF mismatch on keyed test vector after a reset, Expected "%s" but got "%s"', [LVector[2], TConverters.ConvertBytesToHexString(LKeyedOutput, False)]));
    end;
    ...
    if (not AreEqual(LOutput, LOutputClone)) then
    begin
      Fail(Format('BLAKE3XOF mismatch on test vector test vector against a clone, Expected "%s" but got "%s"', [LVector[1], TConverters.ConvertBytesToHexString(LOutputClone, False)]));
    end;

    if (not AreEqual(LKeyedOutput, LKeyedOutputClone)) then
    begin
      Fail(Format('BLAKE3XOF mismatch on keyed test vector test vector against a clone, Expected "%s" but got "%s"', [LVector[2], TConverters.ConvertBytesToHexString(LKeyedOutputClone, False)]));
    end;

    System.SetLength(LSubKey, System.Length(LVector[3]) shr 1);
    TBlake3.DeriveKey(LChunkedInput, LCtx, LSubKey);

    if (not AreEqual(LSubKey, TConverters.ConvertHexStringToBytes(LVector[3]))) then
    begin
      Fail(Format('Blake3DeriveKey mismatch on test vector, Expected "%s" but got "%s"', [LVector[3], TConverters.ConvertBytesToHexString(LSubKey, False)]));
    end;
  end;
end;
...
procedure TTestKMAC128.DoComputeKMAC128(const AKey, ACustomization, AData, AExpectedResult: string; AOutputSizeInBits: UInt64; IsXOF: Boolean);
var
  LHash, LClone: IHash;
  LIdx: Int32;
...
begin
  ...
  LCustomization := TConverters.ConvertStringToBytes(ACustomization, TEncoding.UTF8);
  LData := TConverters.ConvertHexStringToBytes(AData);

  if IsXOF then
  begin
    LHash := THashFactory.TXOF.CreateKMAC128XOF(LKey, LCustomization, AOutputSizeInBits);
    Suffix := 'XOF';
  end
  else
  begin
    LHash := THashFactory.TKMAC.CreateKMAC128(LKey, LCustomization, AOutputSizeInBits);
    Suffix := '';
  end;
  ...
  begin
    ...
    ((LHash as IKMAC) as IXOF).DoOutput(LActualResult, 0, AOutputSizeInBits shr 3);

    ((LClone as IKMAC) as IXOF).DoOutput(LActualResultClone, 0, AOutputSizeInBits shr 3);
  ...
  CheckEquals(AExpectedResult, TConverters.ConvertBytesToHexString(LActualResult, False), Format('Expected %s But got %s', [AExpectedResult, TConverters.ConvertBytesToHexString(LActualResult, False)]));

  if (not AreEqual(LActualResult, LActualResultClone)) then
  begin
    Fail(Format('KMAC128%s mismatch on test vector against a clone, Expected "%s" but got "%s"', [Suffix, AExpectedResult, TConverters.ConvertBytesToHexString(LActualResultClone, False)]));
  end;
...
begin
  DoComputeKMAC128(RawKeyInHex, '', ZeroToThreeInHex, 'E5780B0D3EA6F7D3A429C5706AA43A00FADBD7D49628839E3187243F456EE14E', OutputSizeInBits, False);
end;

procedure TTestKMAC128.TestKMAC128NISTSample2;
begin
  DoComputeKMAC128(RawKeyInHex, CustomizationMessage, ZeroToThreeInHex, '3B1FBA963CD8B0B59E8C1A6D71888B7143651AF8BA0A7070C0979E2811324AA5', OutputSizeInBits, False);
end;

procedure TTestKMAC128.TestKMAC128NISTSample3;
begin
  DoComputeKMAC128(RawKeyInHex, CustomizationMessage, FData, '1F5B4E6CCA02209E0DCB5CA635B89A15E271ECC760071DFD805FAA38F9729230', OutputSizeInBits, False);
end;

procedure TTestKMAC128.TestKMAC128XOFNISTSample1;
begin
  DoComputeKMAC128(RawKeyInHex, '', ZeroToThreeInHex, 'CD83740BBD92CCC8CF032B1481A0F4460E7CA9DD12B08A0C4031178BACD6EC35', OutputSizeInBits, True);
end;

procedure TTestKMAC128.TestKMAC128XOFNISTSample2;
begin
  DoComputeKMAC128(RawKeyInHex, CustomizationMessage, ZeroToThreeInHex, '31A44527B4ED9F5C6101D11DE6D26F0620AA5C341DEF41299657FE9DF1A3B16C', OutputSizeInBits, True);
end;

procedure TTestKMAC128.TestKMAC128XOFNISTSample3;
begin
  DoComputeKMAC128(RawKeyInHex, CustomizationMessage, FData, '47026C7CD793084AA0283C253EF658490C0DB61438B8326FE9BDDF281B83AE0F', OutputSizeInBits, True);
end;

{ TTestKMAC256 }

procedure TTestKMAC256.DoComputeKMAC256(const AKey, ACustomization, AData, AExpectedResult: string; AOutputSizeInBits: UInt64; IsXOF: Boolean);
var
  LHash, LClone: IHash;
  LIdx: Int32;
  LActualResult, LActualResultClone, LKey, LCustomization, LData: TBytes;
...
begin
  ...
  if IsXOF then
  begin
    LHash := THashFactory.TXOF.CreateKMAC256XOF(LKey, LCustomization, AOutputSizeInBits);
    Suffix := 'XOF';
  end
  else
  begin
    LHash := THashFactory.TKMAC.CreateKMAC256(LKey, LCustomization, AOutputSizeInBits);
    Suffix := '';
  end;
  ...
  if (not AreEqual(LActualResult, LActualResultClone)) then
  begin
    Fail(Format('KMAC256%s mismatch on test vector against a clone, Expected "%s" but got "%s"', [Suffix, AExpectedResult, TConverters.ConvertBytesToHexString(LActualResultClone, False)]));
  end;
...
begin
  DoComputeKMAC256(RawKeyInHex, CustomizationMessage, ZeroToThreeInHex, '20C570C31346F703C9AC36C61C03CB64C3970D0CFC787E9B79599D273A68D2F7F69D4CC3DE9D104A351689F27CF6F5951F0103F33F4F24871024D9C27773A8DD', OutputSizeInBits, False);
end;

procedure TTestKMAC256.TestKMAC256NISTSample2;
begin
  DoComputeKMAC256(RawKeyInHex, '', FData, '75358CF39E41494E949707927CEE0AF20A3FF553904C86B08F21CC414BCFD691589D27CF5E15369CBBFF8B9A4C2EB17800855D0235FF635DA82533EC6B759B69', OutputSizeInBits, False);
end;

procedure TTestKMAC256.TestKMAC256NISTSample3;
begin
  DoComputeKMAC256(RawKeyInHex, CustomizationMessage, FData, 'B58618F71F92E1D56C1B8C55DDD7CD188B97B4CA4D99831EB2699A837DA2E4D970FBACFDE50033AEA585F1A2708510C32D07880801BD182898FE476876FC8965', OutputSizeInBits, False);
end;

procedure TTestKMAC256.TestKMAC256XOFNISTSample1;
begin
  DoComputeKMAC256(RawKeyInHex, CustomizationMessage, ZeroToThreeInHex, '1755133F1534752AAD0748F2C706FB5C784512CAB835CD15676B16C0C6647FA96FAA7AF634A0BF8FF6DF39374FA00FAD9A39E322A7C92065A64EB1FB0801EB2B', OutputSizeInBits, True);
end;

procedure TTestKMAC256.TestKMAC256XOFNISTSample2;
begin
  DoComputeKMAC256(RawKeyInHex, '', FData, 'FF7B171F1E8A2B24683EED37830EE797538BA8DC563F6DA1E667391A75EDC02CA633079F81CE12A25F45615EC89972031D18337331D24CEB8F8CA8E6A19FD98B', OutputSizeInBits, True);
end;

procedure TTestKMAC256.TestKMAC256XOFNISTSample3;
begin
  DoComputeKMAC256(RawKeyInHex, CustomizationMessage, FData, 'D5BE731C954ED7732846BB59DBE3A8E30F83E77A4BFF4459F2F1C2B4ECEBB8CE67BA01C62E8AB8578D2D499BD1BB276768781190020A306A97DE281DCC30305D', OutputSizeInBits, True);
end;

{ TTestBlake2BMAC }

procedure TTestBlake2BMAC.DoComputeBlake2BMAC(const AKey, APersonalisation, ASalt, AData, AExpectedResult: string; AOutputSizeInBits: Int32);
var
  LHash, LClone: IHash;
  LIdx: Int32;
  LActualResult, LActualResultClone, LKey, LPersonalisation, LSalt, LData: TBytes;
begin
  LKey := TConverters.ConvertHexStringToBytes(AKey);
  LPersonalisation := TConverters.ConvertStringToBytes(APersonalisation, TEncoding.UTF8);
  ...
  LHash := THashFactory.TBlake2BMAC.CreateBlake2BMAC(LKey, LSalt, LPersonalisation, AOutputSizeInBits);
  ...
  if (not AreEqual(LActualResult, LActualResultClone)) then
  begin
    Fail(Format('Blake2BMAC mismatch on test vector against a clone, Expected "%s" but got "%s"', [AExpectedResult, TConverters.ConvertBytesToHexString(LActualResultClone, False)]));
  end;
...
begin
  DoComputeBlake2BMAC('000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F', '', '', 'Sample input for outlen<digest_length', '2A', 1 * 8);
end;

procedure TTestBlake2BMAC.TestBlake2BMACSample2;
begin
  DoComputeBlake2BMAC('000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F', 'application', '000102030405060708090A0B0C0D0E0F', 'Combo input with outlen, custom and salt', '51742FC491171EAF6B9459C8B93A44BBF8F44A0B4869A17FA178C8209918AD96', 32 * 8);
end;

procedure TTestBlake2BMAC.TestBlake2BMACSample3;
begin
  DoComputeBlake2BMAC('000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F', 'application', '000102030405060708090A0B0C0D0E0F', 'Sample input for keylen<blocklen, salt and custom',
    '233A6C732212F4813EC4C9F357E35297E59A652FD24155205F00363F7C54734EE1E8C7329D92116CBEC62DB35EBB5D51F9E5C2BA41789B84AC9EBC266918E524', 64 * 8);
end;

{ TTestBlake2SMAC }

procedure TTestBlake2SMAC.DoComputeBlake2SMAC(const AKey, APersonalisation, ASalt, AData, AExpectedResult: string; AOutputSizeInBits: Int32);
var
  LHash, LClone: IHash;
  LIdx: Int32;
  LActualResult, LActualResultClone, LKey, LPersonalisation, LSalt, LData: TBytes;
begin
  ...
  LHash := THashFactory.TBlake2SMAC.CreateBlake2SMAC(LKey, LSalt, LPersonalisation, AOutputSizeInBits);
  ...
  if (not AreEqual(LActualResult, LActualResultClone)) then
  begin
    Fail(Format('Blake2SMAC mismatch on test vector against a clone, Expected "%s" but got "%s"', [AExpectedResult, TConverters.ConvertBytesToHexString(LActualResultClone, False)]));
  end;
...
begin
  DoComputeBlake2SMAC('000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F', '', '', 'Sample input for outlen<digest_length', '07', 1 * 8);
end;

procedure TTestBlake2SMAC.TestBlake2SMACSample2;
begin
  DoComputeBlake2SMAC('000102030405060708090A0B0C0D0E0F', 'app', '0001020304050607', 'Combo input with outlen, custom and salt', '6808D8DAAE537A16BF00E837010969A4', 16 * 8);
end;

procedure TTestBlake2SMAC.TestBlake2SMACSample3;
begin
  DoComputeBlake2SMAC('000102030405060708090A0B0C0D0E0F', 'app', 'A205819E78D6D762', 'Sample input for keylen<blocklen, salt and custom', 'E9F7704DFE5080A4AAFE62A806F53EA7F98FFC24175164158F18EC5497B961F5', 32 * 8);
end;
...
begin
  ...
  HMACInstance := THashFactory.THMAC.CreateHMAC(HashInstance);
  HashOfEmptyData := 'B5EF811A8038F70B628FA8B294DAAE7492B1EBE343A80EAABBF1F6AE664DD67B9D90B0120791EAB81DC96985F28849F6A305186A85501B405114BFA678DF9380';
  HashOfDefaultData := '6F02764BDBA4184E50CAA52539BC392239D31E1BC76CEACBCA42630BCB7B48B527F65AA2F50363C0E26A287B758C87BC77C7175AB7A12B33104330F5A1C6E171';
  HashOfOnetoNine := 'E70843E71EF73EF84D991990687CB72E272E590F7E86F491935E9904F0582A165A388F956D691101C5D2B035634E4415C3CB21D7F721702CC64791D53AEDB9E2';
  HashOfABCDE := 'C96CA7B60257D18A67EC6DAF4E06A6A0F882ECEE22605DBE64DFAD2D7AA2FF939726385C7E60F00A2A38CF302E460C33EAE769CA5652FA8456EA6A75DC6AAC39';
  HashOfDefaultDataHMACWithShortKey := '671A8EE18AD7BCC940CF4B35B47D0AAA89077AA8503E4E374A5BC2803758BBF04C6C80F97E5B71CD79A1E6DCD6585EB82A5F5482DB268B462D651530CE5CB177';
  HashOfDefaultDataHMACWithLongKey := '62B264D5D5DFC01350B69C083B239426EC8A8F971FAC8DCB0B6A4825DD664CB992413AA1F7E5D2950BFFB9C207A9B084591633A96F3F590A861B27C3B827D3BC';
...
begin
  ...
  HMACInstance := THashFactory.THMAC.CreateHMAC(HashInstance);
  HashOfEmptyData := 'DD0E891776933F43C7D032B08A917E25741F8AA9A12C12E1CAC8801500F2CA4F';
  HashOfDefaultData := 'F1617895134C203ED0A9C8CC72938161EBC9AB6F233BBD3CCFC4D4BCA08A5ED0';
  HashOfOnetoNine := 'D6D3157BD4E809982E0EEA22C5AF5CDDF05473F6ECBE353119591E6CDCB7127E';
  HashOfABCDE := '107EEF69D795B14C8411EEBEFA897429682108397680377C78E5D214F014916F';
  HashOfDefaultDataHMACWithShortKey := 'D818A87A70949BDA7DE9765650D665C49B1B5CF11B05A1780901C46A91FFD786';
  HashOfDefaultDataHMACWithLongKey := '7E061EC8E97D200F21BD7DB59FF4ED7BB1F7327D9E75EB3D922B926A76FEFE3F';
