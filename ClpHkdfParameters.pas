...
type
  ...
  /// </summary>
  THkdfParameters = class(TInterfacedObject, IDerivationParameters, IHkdfParameters)
  ...
  var
    ...
    constructor Create(const ikm: TCryptoLibByteArray; skip: Boolean; const salt, info: TCryptoLibByteArray); overload;
  ...
  public
    ...
    /// </returns>
    class function SkipExtractParameters(const ikm, info: TCryptoLibByteArray): IHkdfParameters; static; inline;

    class function DefaultParameters(const ikm: TCryptoLibByteArray): IHkdfParameters; static; inline;
...
constructor THkdfParameters.Create(const ikm: TCryptoLibByteArray; skip: Boolean; const salt, info: TCryptoLibByteArray);
begin
  inherited Create();
...
class function THkdfParameters.DefaultParameters(const ikm: TCryptoLibByteArray): IHkdfParameters;
begin
...
class function THkdfParameters.SkipExtractParameters(const ikm, info: TCryptoLibByteArray): IHkdfParameters;
begin
