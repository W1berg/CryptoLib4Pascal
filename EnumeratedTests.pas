...
type
  ...
  var
  private
    FMultipleSingleByteItems, FMultipleDoubleByteItems, FMultipleTripleByteItems: TBytes;
...
begin
  ...
  CheckEquals(65793, enumerated.Value.Int32Value, 'Unexpected ENUMERATED value');
