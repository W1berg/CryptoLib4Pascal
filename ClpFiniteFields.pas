...
resourcestring
  ...
  SUnConstantTerm = 'Irreducible polynomials in GF(2) must have constant term, "exponents"';
  SPolynomialError = 'Polynomial Exponents must be montonically increasing", "exponents"';
...
type
  ...
  public
    class function GetBinaryExtensionField(const exponents: TCryptoLibInt32Array): IPolynomialExtensionField; static;

    class function GetPrimeField(const characteristic: TBigInteger): IFiniteField; static;
  end;
...
class function TFiniteFields.GetBinaryExtensionField(const exponents: TCryptoLibInt32Array): IPolynomialExtensionField;
var
  i: Int32;
begin
  ...
  Result := TGenericPolynomialExtensionField.Create(FGF_2, TGF2Polynomial.Create(exponents) as IGF2Polynomial);
end;

class function TFiniteFields.GetPrimeField(const characteristic: TBigInteger): IFiniteField;
var
  bitLength: Int32;
begin
