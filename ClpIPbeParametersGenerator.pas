...
type
  IPbeParametersGenerator = interface(IInterface)
    ...
    /// a parameters object representing a key.
    /// </returns>
    function GenerateDerivedParameters(const algorithm: string; keySize: Int32): ICipherParameters; overload;
    ...
    /// </returns>
    function GenerateDerivedParameters(const algorithm: string; keySize, ivSize: Int32): ICipherParameters; overload;
