...
type
  ...
  var
    ...
    /// instead. <br />
    /// </summary>
    function Blake2SPCreateLeafParam(const ABlake2SConfig: IBlake2SConfig; const ABlake2STreeConfig: IBlake2STreeConfig): TBlake2S;
    ...
    function DeepCloneBlake2SInstances(const ALeafHashes: THashLibGenericArray<TBlake2S>): THashLibGenericArray<TBlake2S>;
...
function TBlake2SP.Blake2SPCreateLeafParam(const ABlake2SConfig: IBlake2SConfig; const ABlake2STreeConfig: IBlake2STreeConfig): TBlake2S;
begin
...
function TBlake2SP.DeepCloneBlake2SInstances(const ALeafHashes: THashLibGenericArray<TBlake2S>): THashLibGenericArray<TBlake2S>;
var
  LIdx: Int32;
begin
...
procedure TBlake2SP.ParallelComputation(AIdx: Int32; ADataContainer: PDataContainer);
var
...
procedure TBlake2SP.PasMPParallelComputationWrapper(const AJob: PPasMPJob; const AThreadIndex: LongInt; const ADataContainer: Pointer; const AFromIndex, AToIndex: TPasMPNativeInt);
begin
...
procedure TBlake2SP.MTProcsParallelComputationWrapper(AIdx: PtrInt; ADataContainer: Pointer; AItem: TMultiThreadProcItem);
begin
...
procedure TBlake2SP.TransformBytes(const AData: THashLibByteArray; AIndex, ADataLength: Int32);
var
