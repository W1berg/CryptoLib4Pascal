...
type
  ...
  var
    FseqData, FnestedSeqData, FexpTagSeqData, FimplTagSeqData, FnestedSeqExpTagData, FnestedSeqImpTagData, FberSeqData, FberDerNestedSeqData, FberNestedSeqData, FberExpTagSeqData, FberSeqWithDERNullData: TBytes;
...
begin
  ...
  try
    ...
    CheckTrue(AreEqual(FberExpTagSeqData, temp), 'explicit BER tag writing test failed.');
  finally
    bOut.Free;
  end;
end;
...
begin
  ...
  try
    ...
    CheckTrue(AreEqual(FexpTagSeqData, temp), 'explicit tag writing test failed.');
  finally
    bOut.Free;
  end;
end;
...
begin
  ...
  try
    ...
    CheckTrue(AreEqual(FimplTagSeqData, temp), 'implicit tag writing test failed.');
  finally
    bOut.Free;
  end;
end;
...
begin
  ...
  try
    ...
    seqGen1.AddObject(TDerObjectIdentifier.Create('1.1') as IDerObjectIdentifier);
    ...
    System.SetLength(temp, bOut.Size);
    bOut.Read(temp[0], bOut.Size);
    CheckTrue(AreEqual(FberDerNestedSeqData, temp), 'nested BER/DER writing test failed.');
  finally
    bOut.Free;
  end;
end;
...
begin
  ...
  try
    ...
    System.SetLength(temp, bOut.Size);
    bOut.Read(temp[0], bOut.Size);
    CheckTrue(AreEqual(FberNestedSeqData, temp), 'nested BER writing test failed.');
  finally
    bOut.Free;
  end;
end;
...
begin
  ...
  try
    ...
    System.SetLength(temp, bOut.Size);
    bOut.Read(temp[0], bOut.Size);
    CheckTrue(AreEqual(FnestedSeqData, temp), 'nested DER writing test failed.');
  finally
    bOut.Free;
  end;
end;
...
begin
  ...
  try
    ...
    seqGen2 := TDerSequenceGenerator.Create(seqGen1.GetRawOutputStream(), 1, true);
    ...
    System.SetLength(temp, bOut.Size);
    bOut.Read(temp[0], bOut.Size);
    CheckTrue(AreEqual(FnestedSeqExpTagData, temp), 'nested explicit tagged DER writing test failed.');
  finally
    bOut.Free;
  end;
end;
...
begin
  ...
  try
    ...
    seqGen2 := TDerSequenceGenerator.Create(seqGen1.GetRawOutputStream(), 1, false);
    ...
    System.SetLength(temp, bOut.Size);
    bOut.Read(temp[0], bOut.Size);
    CheckTrue(AreEqual(FnestedSeqImpTagData, temp), 'nested implicit tagged DER writing test failed.');
  finally
    bOut.Free;
  end;
end;
