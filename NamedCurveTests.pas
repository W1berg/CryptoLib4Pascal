...
function TTestNamedCurve.GetCurveParameters(const name: string): IECDomainParameters;
var
...
begin
  ...
  result := TECDomainParameters.Create(ecP.Curve, ecP.g, ecP.N, ecP.H, ecP.GetSeed());
end;
