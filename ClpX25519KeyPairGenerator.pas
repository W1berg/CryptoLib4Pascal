...
type
  TX25519KeyPairGenerator = class sealed(TInterfacedObject, IX25519KeyPairGenerator, IAsymmetricCipherKeyPairGenerator)
...
procedure TX25519KeyPairGenerator.Init(const parameters: IKeyGenerationParameters);
begin
