...
type
  IAbstractECMultiplier = interface(IECMultiplier)
    ...
    function MultiplyPositive(const p: IECPoint; const k: TBigInteger): IECPoint;
...
type
  IWTauNafMultiplier = interface(IAbstractECMultiplier)
    ...
    // */
    function MultiplyWTnaf(const p: IAbstractF2mPoint; const lambda: IZTauElement; a, mu: ShortInt): IAbstractF2mPoint;
