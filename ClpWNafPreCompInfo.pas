...
{$ENDIF}
    ...
    procedure SetPreCompNeg(const Value: TCryptoLibGenericArray<IECPoint>); inline;
...
procedure TWNafPreCompInfo.SetPreComp(const Value: TCryptoLibGenericArray<IECPoint>);
begin
  FPreComp := Value;
end;

procedure TWNafPreCompInfo.SetPreCompNeg(const Value: TCryptoLibGenericArray<IECPoint>);
begin
  FPreCompNeg := Value;
end;
