...
type
  ...
  public
    ...
    /// </param>
    constructor Create(const derivation, encoding: TCryptoLibByteArray; MacKeySize: Int32);
  end;
...
constructor TIESParameters.Create(const derivation, encoding: TCryptoLibByteArray; MacKeySize: Int32);
begin
  inherited Create();
