...
type
  ...
  public
    ...
    constructor Create(const keyPair: IAsymmetricCipherKeyPair; const publicKeyEncoder: IKeyEncoder);
...
constructor TEphemeralKeyPair.Create(const keyPair: IAsymmetricCipherKeyPair; const publicKeyEncoder: IKeyEncoder);
begin
  inherited Create();
  FkeyPair := keyPair;
