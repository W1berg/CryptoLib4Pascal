...
type
  ...
  var
    ...
    procedure LocalCRCCompute(const ACRCTable: THashLibMatrixUInt32Array; const AData: THashLibByteArray; AIndex, ALength: Int32);

    class function Init_CRC_Table(APolynomial: UInt32): THashLibMatrixUInt32Array; static;
...
class function TCRC32Fast.Init_CRC_Table(APolynomial: UInt32): THashLibMatrixUInt32Array;
var
...
procedure TCRC32Fast.LocalCRCCompute(const ACRCTable: THashLibMatrixUInt32Array; const AData: THashLibByteArray; AIndex, ALength: Int32);
const
  Unroll = Int32(4);
...
begin
  ...
  begin
    ...
    begin
      LOne := TConverters.ReadPCardinalAsUInt32(LCurrent) xor TConverters.le2me_32(LCRC);
      System.Inc(LCurrent);
...
{$IFDEF HASHLIB_LITTLE_ENDIAN}
      LCRC := LCRCTable[0][(LFour shr 24) and $FF] xor LCRCTable[1][(LFour shr 16) and $FF] xor LCRCTable[2][(LFour shr 8) and $FF] xor LCRCTable[3][LFour and $FF] xor LCRCTable[4][(LThree shr 24) and $FF] xor LCRCTable[5][(LThree shr 16) and $FF] xor LCRCTable[6][(LThree shr 8) and $FF]
        xor LCRCTable[7][LThree and $FF] xor LCRCTable[8][(LTwo shr 24) and $FF] xor LCRCTable[9][(LTwo shr 16) and $FF] xor LCRCTable[10][(LTwo shr 8) and $FF] xor LCRCTable[11][LTwo and $FF] xor LCRCTable[12][(LOne shr 24) and $FF] xor LCRCTable[13][(LOne shr 16) and $FF] xor LCRCTable[14]
        [(LOne shr 8) and $FF] xor LCRCTable[15][LOne and $FF];
{$ELSE}
      LCRC := LCRCTable[0][LFour and $FF] xor LCRCTable[1][(LFour shr 8) and $FF] xor LCRCTable[2][(LFour shr 16) and $FF] xor LCRCTable[3][(LFour shr 24) and $FF] xor LCRCTable[4][LThree and $FF] xor LCRCTable[5][(LThree shr 8) and $FF] xor LCRCTable[6][(LThree shr 16) and $FF] xor LCRCTable[7]
        [(LThree shr 24) and $FF] xor LCRCTable[8][LTwo and $FF] xor LCRCTable[9][(LTwo shr 8) and $FF] xor LCRCTable[10][(LTwo shr 16) and $FF] xor LCRCTable[11][(LTwo shr 24) and $FF] xor LCRCTable[12][LOne and $FF] xor LCRCTable[13][(LOne shr 8) and $FF] xor LCRCTable[14][(LOne shr 16) and $FF]
...
procedure TCRC32_PKZIP.TransformBytes(const AData: THashLibByteArray; AIndex, ALength: Int32);
begin
...
procedure TCRC32_CASTAGNOLI.TransformBytes(const AData: THashLibByteArray; AIndex, ALength: Int32);
begin
