...
type
  ...
  public
    ...
    class procedure Expand64To128(x: UInt64; const z: TCryptoLibUInt64Array; zOff: Int32); static;
    class procedure Expand64To128Rev(x: UInt64; const z: TCryptoLibUInt64Array; zOff: Int32); static;
...
class procedure TInterleave.Expand64To128(x: UInt64; const z: TCryptoLibUInt64Array; zOff: Int32);
var
  t: UInt64;
begin
  // "shuffle" low half to even bits and high half to odd bits
...
class procedure TInterleave.Expand64To128Rev(x: UInt64; const z: TCryptoLibUInt64Array; zOff: Int32);
var
  t: UInt64;
begin
  // "shuffle" low half to even bits and high half to odd bits
