...
type
  ...
  private
  var
    FRawData, FEncodedData, FSpecialRaw, FSpecialEncoded: TSimpleBaseLibStringArray;
  protected
...
begin
  ...
  FEncodedData := TSimpleBaseLibStringArray.Create('', 'CR', 'CSQG', 'CSQPY', 'CSQPYRG', 'CSQPYRK1', 'CSQPYRK1E8', '64S36D1N6RVKGE9G64S36D1N6RVKGE9G64S36D1N6RVKGE9G64S36D1N6RVKGE9G'
...
begin
  ...
  begin
    ...
    CheckTrue(TUtilities.AreArraysEqual(expectedResult, result), Format('Decoding Failed at Index %d', [Idx]));
  end;
end;
...
begin
  ...
  begin
    ...
    CheckEquals(FEncodedData[Idx], result, Format('Encoding Failed at Index %d', [Idx]));
  end;
end;
