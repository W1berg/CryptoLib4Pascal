...
type
  ...
  class var
    ...
    FIsBooted: Boolean;
    FGostR3411, FGostR3410x2001, FGostR3410x94, FGostR28147Cbc, FID_Gost28147_89_CryptoPro_A_ParamSet, FGostR3411x94CryptoProParam, FGostR3411Hmac, FGostR3410x2001CryptoProA, FGostElSgDH3410Default, FGostR3410x94CryptoProXchB, FGostR3410x94CryptoProXchC, FGostR3411x94WithGostR3410x94,
      FGostR3410x94CryptoProXchA, FGostR3410x94CryptoProB, FGostR3410x94CryptoProC, FGostR3410x94CryptoProA, FGostR3410x94CryptoProD, FGostR3411x94CryptoProParamSet, FGostR3410x2001CryptoProXchB, FGostR3411x94WithGostR3410x2001, FGostR3410x2001CryptoProXchA, FGostR3410x2001CryptoProB,
    ...
    class function GetID_Gost28147_89_CryptoPro_A_ParamSet: IDerObjectIdentifier; static; inline;
    class function GetGostR3410x2001: IDerObjectIdentifier; static; inline;

    class function GetGostElSgDH3410Default: IDerObjectIdentifier; static; inline;
    ...
    class function GetGostR3411x94CryptoProParam: IDerObjectIdentifier; static; inline;
  ...
  public
    ...
    class property ID_Gost28147_89_CryptoPro_A_ParamSet: IDerObjectIdentifier read GetID_Gost28147_89_CryptoPro_A_ParamSet;
    ...
    class property GostElSgDH3410Default: IDerObjectIdentifier read GetGostElSgDH3410Default;
    class property GostElSgDH3410x1: IDerObjectIdentifier read GetGostElSgDH3410x1;

    class property GostR3411x94CryptoProParam: IDerObjectIdentifier read GetGostR3411x94CryptoProParam;
...
class function TCryptoProObjectIdentifiers.GetGostElSgDH3410Default: IDerObjectIdentifier;
begin
  result := FGostElSgDH3410Default;
end;

class function TCryptoProObjectIdentifiers.GetGostElSgDH3410x1: IDerObjectIdentifier;
begin
  result := FGostElSgDH3410x1;
end;

class function TCryptoProObjectIdentifiers.GetGostR28147Cbc: IDerObjectIdentifier;
begin
...
class function TCryptoProObjectIdentifiers.GetGostR3411x94CryptoProParam: IDerObjectIdentifier;
begin
...
class function TCryptoProObjectIdentifiers.GetID_Gost28147_89_CryptoPro_A_ParamSet: IDerObjectIdentifier;
begin
...
begin
  ...
  begin
    ...
    FID_Gost28147_89_CryptoPro_A_ParamSet := TDerObjectIdentifier.Create(GostID + '.31.1');
    ...
    // { iso(1) member-body(2) ru(643) rans(2) cryptopro(2) hashes(30) }
    FGostR3411x94CryptoProParamSet := TDerObjectIdentifier.Create(GostID + '.30.1');
