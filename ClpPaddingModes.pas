...
type
  ...
  /// </summary>
  TISO7816d4Padding = class sealed(TInterfacedObject, IISO7816d4Padding, IBlockCipherPadding)
...
type
  TPkcs7Padding = class sealed(TInterfacedObject, IPkcs7Padding, IBlockCipherPadding)
...
type
  ...
  /// </p>
  /// </summary>
  TTBCPadding = class sealed(TInterfacedObject, ITBCPadding, IBlockCipherPadding)
...
type
  ...
  /// used.
  /// </summary>
  TX923Padding = class sealed(TInterfacedObject, IX923Padding, IBlockCipherPadding)
...
type
  ...
  /// </summary>
  TZeroBytePadding = class sealed(TInterfacedObject, IZeroBytePadding, IBlockCipherPadding)
...
function TISO7816d4Padding.AddPadding(const input: TCryptoLibByteArray; inOff: Int32): Int32;
var
  added: Int32;
begin
...
function TPkcs7Padding.AddPadding(const input: TCryptoLibByteArray; inOff: Int32): Int32;
var
  code: Byte;
begin
  code := Byte(System.Length(input) - inOff);
...
begin
  ...
  begin
    failed := failed or ((System.Length(input) - i <= count) and (input[i] <> countAsByte));
  end;
...
function TTBCPadding.AddPadding(const input: TCryptoLibByteArray; inOff: Int32): Int32;
var
  count: Int32;
  code: Byte;
begin
...
function TX923Padding.AddPadding(const input: TCryptoLibByteArray; inOff: Int32): Int32;
var
  code: Byte;
begin
  code := Byte(System.Length(input) - inOff);
...
function TZeroBytePadding.AddPadding(const input: TCryptoLibByteArray; inOff: Int32): Int32;
var
  added: Int32;
begin
  added := System.Length(input) - inOff;
