...
type
  ...
  public
    ...
    class function GetInstance(const obj: IAsn1TaggedObject; explicitly: Boolean): IDsaParameter; overload; static; inline;

    class function GetInstance(obj: TObject): IDsaParameter; overload; static; inline;
...
begin
  ...
  raise EArgumentCryptoLibException.CreateResFmt(@SInvalidDsaParameter, [obj.ToString]);
end;

class function TDsaParameter.GetInstance(const obj: IAsn1TaggedObject; explicitly: Boolean): IDsaParameter;
begin
