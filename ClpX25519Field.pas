...
type
  ...
  const
    ...
    class procedure Decode128(const bs: TCryptoLibByteArray; off: Int32; const z: TCryptoLibInt32Array; zOff: Int32); static; inline;

    class function Decode32(const bs: TCryptoLibByteArray; off: Int32): UInt32; static; inline;

    class procedure Encode32(n: UInt32; const bs: TCryptoLibByteArray; off: Int32); static; inline;

    class procedure Encode128(const x: TCryptoLibInt32Array; xOff: Int32; const bs: TCryptoLibByteArray; off: Int32); static; inline;
  ...
  public
    ...
    class procedure AddOne(const z: TCryptoLibInt32Array); overload; static; inline;

    class procedure AddOne(const z: TCryptoLibInt32Array; zOff: Int32); overload; static; inline;

    class procedure Apm(const x, y, zp, zm: TCryptoLibInt32Array); static; inline;

    class procedure Carry(const z: TCryptoLibInt32Array); static;

    class procedure CMov(cond: Int32; const x: TCryptoLibInt32Array; xOff: Int32; const z: TCryptoLibInt32Array; zOff: Int32); static;

    class procedure CNegate(ANegate: Int32; const z: TCryptoLibInt32Array); static; inline;

    class procedure Copy(const x: TCryptoLibInt32Array; xOff: Int32; const z: TCryptoLibInt32Array; zOff: Int32); static; inline;
    ...
    class procedure CSwap(swap: Int32; const a, b: TCryptoLibInt32Array); static;

    class procedure Decode(const x: TCryptoLibByteArray; xOff: Int32; const z: TCryptoLibInt32Array); static; inline;

    class procedure Encode(const x: TCryptoLibInt32Array; const z: TCryptoLibByteArray; zOff: Int32); static; inline;
    ...
    class function IsZeroVar(const x: TCryptoLibInt32Array): Boolean; static; inline;

    class procedure Mul(const x: TCryptoLibInt32Array; y: Int32; const z: TCryptoLibInt32Array); overload; static;
    ...
    class procedure Sqr(const x: TCryptoLibInt32Array; n: Int32; const z: TCryptoLibInt32Array); overload; static;

    class function SqrtRatioVar(const u, v, z: TCryptoLibInt32Array): Boolean; static;
...
begin
  FRootNegOne := TCryptoLibInt32Array.Create($020EA0B0, $0386C9D2, $00478C4E, $0035697F, $005E8630, $01FBD7A7, $0340264F, $01F0B2B4, $00027E0E, $00570649);
end;
...
class procedure TX25519Field.CMov(cond: Int32; const x: TCryptoLibInt32Array; xOff: Int32; const z: TCryptoLibInt32Array; zOff: Int32);
var
  i, z_i, diff: Int32;
begin
{$IFDEF DEBUG}
...
class procedure TX25519Field.CNegate(ANegate: Int32; const z: TCryptoLibInt32Array);
var
  mask, i: Int32;
begin
{$IFDEF DEBUG}
...
class procedure TX25519Field.Copy(const x: TCryptoLibInt32Array; xOff: Int32; const z: TCryptoLibInt32Array; zOff: Int32);
var
  i: Int32;
begin
  for i := 0 to System.Pred(Size) do
...
class procedure TX25519Field.CSwap(swap: Int32; const a, b: TCryptoLibInt32Array);
var
...
class function TX25519Field.Decode32(const bs: TCryptoLibByteArray; off: Int32): UInt32;
begin
  // UInt32 n := bs[off];
  // System.Inc(off);
...
class procedure TX25519Field.Decode128(const bs: TCryptoLibByteArray; off: Int32; const z: TCryptoLibInt32Array; zOff: Int32);
var
  t0, t1, t2, t3: UInt32;
begin
...
class procedure TX25519Field.Decode(const x: TCryptoLibByteArray; xOff: Int32; const z: TCryptoLibInt32Array);
begin
...
class procedure TX25519Field.Encode32(n: UInt32; const bs: TCryptoLibByteArray; off: Int32);
begin
  // bs[  off] := Byte(n      );
  // System.Inc(off);
  // bs[off] := Byte(n shr  8);
...
class procedure TX25519Field.Encode128(const x: TCryptoLibInt32Array; xOff: Int32; const bs: TCryptoLibByteArray; off: Int32);
var
...
class procedure TX25519Field.Encode(const x: TCryptoLibInt32Array; const z: TCryptoLibByteArray; zOff: Int32);
begin
...
class procedure TX25519Field.Mul(const x: TCryptoLibInt32Array; y: Int32; const z: TCryptoLibInt32Array);
var
...
var
  ...
  a0, a1, a2, a3, a4, a5, a6, a7, a8, b0, b1, b2, b3, b4, b5, b6, b7, b8, c0, c1, c2, c3, c4, c5, c6, c7, c8, v0, v1, v2, v3, v4, t: Int64;
begin
  x0 := x[0];
  y0 := y[0];
  x1 := x[1];
  ...
  a4 := Int64(x2) * y2;
  a4 := a4 shl 1;
  a4 := a4 + (Int64(x0) * y4 + Int64(x1) * y3 + Int64(x3) * y1 + Int64(x4) * y0);
  ...
  b4 := Int64(u2) * v2;
  b4 := b4 shl 1;
  b4 := b4 + (Int64(u0) * v4 + Int64(u1) * v3 + Int64(u3) * v1 + Int64(u4) * v0);
  ...
  c4 := Int64(x2) * y2;
  c4 := c4 shl 1;
  c4 := c4 + (Int64(x0) * y4 + Int64(x1) * y3 + Int64(x3) * y1 + Int64(x4) * y0);
...
var
  x0, x1, x2, x3, x4, u0, u1, u2, u3, u4, x1_2, x2_2, x3_2, x4_2, u1_2, u2_2, u3_2, u4_2, z8, z9: Int32;
  a0, a1, a2, a3, a4, a5, a6, a7, a8, b0, b1, b2, b3, b4, b5, b6, b7, b8, c0, c1, c2, c3, c4, c5, c6, c7, c8, t: Int64;
begin
  x0 := x[0];
  x1 := x[1];
  x2 := x[2];
...
class procedure TX25519Field.Sqr(const x: TCryptoLibInt32Array; n: Int32; const z: TCryptoLibInt32Array);
begin
{$IFDEF DEBUG}
  System.Assert(n > 0);
{$ENDIF DEBUG}
...
class function TX25519Field.SqrtRatioVar(const u, v, z: TCryptoLibInt32Array): Boolean;
var
