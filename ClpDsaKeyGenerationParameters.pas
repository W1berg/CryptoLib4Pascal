...
type
  TDsaKeyGenerationParameters = class sealed(TKeyGenerationParameters, IDsaKeyGenerationParameters)
  strict private
  var
  ...
  public
    constructor Create(const random: ISecureRandom; const parameters: IDsaParameters);
...
constructor TDsaKeyGenerationParameters.Create(const random: ISecureRandom; const parameters: IDsaParameters);
var
  P: TBigInteger;
begin
  P := parameters.P;
