...
begin
  ...
  begin
    ...
    begin
      raise EArgumentHashLibException.CreateResFmt(@SInvalidKeyLength, [KeyLength.value]);
    end;
    FKey := TConverters.ReadBytesAsUInt64LE(PByte(AValue), 0);
  end;
end;

procedure TXXHash64.TransformBytes(const AData: THashLibByteArray; AIndex, ALength: Int32);
var
...
{$ENDIF DEBUG}
  ...
  begin
    ...
    FState.FV1 := PRIME64_1 * TBits.RotateLeft64(FState.FV1 + PRIME64_2 * TConverters.ReadBytesAsUInt64LE(LPtrMemory, 0), 31);
    FState.FV2 := PRIME64_1 * TBits.RotateLeft64(FState.FV2 + PRIME64_2 * TConverters.ReadBytesAsUInt64LE(LPtrMemory, 8), 31);
    FState.FV3 := PRIME64_1 * TBits.RotateLeft64(FState.FV3 + PRIME64_2 * TConverters.ReadBytesAsUInt64LE(LPtrMemory, 16), 31);
    FState.FV4 := PRIME64_1 * TBits.RotateLeft64(FState.FV4 + PRIME64_2 * TConverters.ReadBytesAsUInt64LE(LPtrMemory, 24), 31);
  ...
  begin
    ...
    repeat
      ...
      LV1 := PRIME64_1 * TBits.RotateLeft64(LV1 + PRIME64_2 * TConverters.ReadPUInt64AsUInt64LE(LPtrADataStartUInt64), 31);
      LV2 := PRIME64_1 * TBits.RotateLeft64(LV2 + PRIME64_2 * TConverters.ReadPUInt64AsUInt64LE(LPtrADataStartUInt64 + 1), 31);
      LV3 := PRIME64_1 * TBits.RotateLeft64(LV3 + PRIME64_2 * TConverters.ReadPUInt64AsUInt64LE(LPtrADataStartUInt64 + 2), 31);
      LV4 := PRIME64_1 * TBits.RotateLeft64(LV4 + PRIME64_2 * TConverters.ReadPUInt64AsUInt64LE(LPtrADataStartUInt64 + 3), 31);
...
begin
  ...
  begin
    ...
    FHash := TBits.RotateLeft64(LV1, 1) + TBits.RotateLeft64(LV2, 7) + TBits.RotateLeft64(LV3, 12) + TBits.RotateLeft64(LV4, 18);
  ...
  begin
    FHash := FHash xor (PRIME64_1 * TBits.RotateLeft64(PRIME64_2 * TConverters.ReadBytesAsUInt64LE(LPtrBuffer, 0), 31));
  ...
  begin
    FHash := FHash xor TConverters.ReadBytesAsUInt32LE(LPtrBuffer, 0) * PRIME64_1;
