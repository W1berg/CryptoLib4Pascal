...
resourcestring
  SWrongInitCipherParameter = 'The Init Parameter does not Contain the Private Key';

type
  TX25519Agreement = class sealed(TInterfacedObject, IX25519Agreement, IRawAgreement)
  ...
  public
    ...
    procedure CalculateAgreement(const publicKey: ICipherParameters; const buf: TCryptoLibByteArray; off: Int32);
...
begin
  ...
  begin
    raise EInvalidParameterCryptoLibException.CreateRes(@SWrongInitCipherParameter);
  end;
end;

procedure TX25519Agreement.CalculateAgreement(const publicKey: ICipherParameters; const buf: TCryptoLibByteArray; off: Int32);
begin
