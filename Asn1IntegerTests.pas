...
begin
  inherited;
  FSuspectKey := DecodeBase64('MIGJAoGBAHNc+iExm94LUrJdPSJ4QJ9tDRuvaNmGVHpJ4X7a5zKI02v+2E7RotuiR2MHDJfVJkb9LUs2kb3XBlyENhtMLsbeH+3Muy3' + 'hGDlh/mLJSh1s4c5jDKBRYOHom7Uc8wP0P2+zBCA+OEdikNDFBaP5PbR2Xq9okG2kPh35M2quAiMTAgMBAAE=');
end;
...
begin
  ...
  i := TDerInteger.Create(rawInt);
  CheckTrue(TBigInteger.Create(DecodeHex('FFFFFFFE10FF000000000000')).Equals(i.Value));
...
begin
  ...
  i := TDerInteger.Create(DecodeHex('ffda47bfc776bcd269da4832626ac332adfca6dd835e8ecd83cd1ebe7d709b0e'));

  en := TDerEnumerated.Create(DecodeHex('005a47bfc776bcd269da4832626ac332adfca6dd835e8ecd83cd1ebe7d709b0e'));

  SetAllowUnsafeProperty(false);

  try

    i := TDerInteger.Create(DecodeHex('ffda47bfc776bcd269da4832626ac332adfca6dd835e8ecd83cd1ebe7d709b'));
  ...
  try
    ...
    en := TDerEnumerated.Create(DecodeHex('ffda47bfc776bcd269da4832626ac332adfca6dd835e8ecd83cd1ebe7d709b0e'));
