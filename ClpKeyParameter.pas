...
type
  TKeyParameter = class sealed(TInterfacedObject, IKeyParameter, ICipherParameters)
  ...
  public
    ...
    constructor Create(const key: TCryptoLibByteArray; keyOff, keyLen: Int32); overload;
...
constructor TKeyParameter.Create(const key: TCryptoLibByteArray; keyOff, keyLen: Int32);
begin
  inherited Create();
