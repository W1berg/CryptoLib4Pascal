...
type
  ...
  /// </summary>
  TECDHCBasicAgreement = class sealed(TInterfacedObject, IECDHCBasicAgreement, IBasicAgreement)
...
function TECDHCBasicAgreement.CalculateAgreement(const pubKey: ICipherParameters): TBigInteger;
var
...
begin
  ...
  begin
    raise EInvalidOperationCryptoLibException.CreateRes(@SInfinityInvalidPublicKey);
  end;
  ...
  begin
    raise EInvalidOperationCryptoLibException.CreateRes(@SInvalidAgreementValue);
