...
type
  ...
  TIESWithCipherParameters = class(TIESParameters, IIESParameters, IIESWithCipherParameters)
  ...
  public
    ...
    /// </param>
    constructor Create(const derivation, encoding: TCryptoLibByteArray; macKeySize, CipherKeySize: Int32);
...
constructor TIESWithCipherParameters.Create(const derivation, encoding: TCryptoLibByteArray; macKeySize, CipherKeySize: Int32);
begin
