...
resourcestring
  SInvalidStrengthValue = 'Strength must be a Positive Value, "defaultStrength"';
...
procedure TCipherKeyGenerator.EngineInit(const parameters: IKeyGenerationParameters);
begin
...
begin
  ...
  begin
    ...
    EngineInit(TKeyGenerationParameters.Create(TSecureRandom.Create() as ISecureRandom, FdefaultStrength) as IKeyGenerationParameters);
  end;
