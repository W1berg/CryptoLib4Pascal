...
type
  TAsymmetricKeyParameter = class abstract(TInterfacedObject, IAsymmetricKeyParameter, ICipherParameters)
...
function TAsymmetricKeyParameter.Equals(const other: IAsymmetricKeyParameter): Boolean;
begin
  if (other = nil) then
  begin
    Result := false;
