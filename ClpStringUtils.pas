...
type
  ...
  public
    ...
    class function SplitString(const Input: string; Delimiter: Char): TCryptoLibStringArray; static;
    class function BeginsWith(const Input, SubString: string; IgnoreCase: Boolean; Offset: Int32 = 1): Boolean; static;

    class function EndsWith(const Input, SubString: string; IgnoreCase: Boolean): Boolean; static;

    class function LastIndexOf(const Input, SubString: string; IgnoreCase: Boolean): Int32; overload; static; inline;

    class function LastIndexOf(const Input, SubString: string; StartIndex, Count: Int32; IgnoreCase: Boolean): Int32; overload; static;

    class function StringToCharArray(const S: string): TCryptoLibCharArray; static;
...
class function TStringUtils.EndsWith(const Input, SubString: string; IgnoreCase: Boolean): Boolean;
var
...
begin
  ...
  if Result then
  begin
    TempString := System.Copy(Input, System.Length(Input) - SubStringLength + 1, SubStringLength);
...
class function TStringUtils.LastIndexOf(const Input, SubString: string; StartIndex, Count: Int32; IgnoreCase: Boolean): Int32;
var
  I, L, LS, M: Int32;
  S: string;
  P: PChar;
...
class function TStringUtils.LastIndexOf(const Input, SubString: string; IgnoreCase: Boolean): Int32;
begin
  Result := LastIndexOf(Input, SubString, System.Length(Input) - 1, System.Length(Input), IgnoreCase);
end;

class function TStringUtils.SplitString(const Input: string; Delimiter: Char): TCryptoLibStringArray;
var
...
class function TStringUtils.StringToCharArray(const S: string): TCryptoLibCharArray;
begin
  Result := nil;
...
class function TStringUtils.BeginsWith(const Input, SubString: string; IgnoreCase: Boolean; Offset: Int32): Boolean;
var
  L: Int32;
