...
type
  ...
  /// </summary>
  TECDHBasicAgreement = class sealed(TInterfacedObject, IECDHBasicAgreement, IBasicAgreement)
...
function TECDHBasicAgreement.CalculateAgreement(const pubKey: ICipherParameters): TBigInteger;
var
