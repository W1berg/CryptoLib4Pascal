...
type
  ...
  public
    constructor Create(const seed: IDerBitString; const pgenCounter: IDerInteger); overload;
    ...
    class function GetInstance(const obj: IAsn1TaggedObject; isExplicit: Boolean): IDHValidationParams; overload; static; inline;

    class function GetInstance(obj: TObject): IDHValidationParams; overload; static; inline;
...
constructor TDHValidationParams.Create(const seed: IDerBitString; const pgenCounter: IDerInteger);
begin
  inherited Create();
...
class function TDHValidationParams.GetInstance(obj: TObject): IDHValidationParams;
begin
  ...
  raise EArgumentCryptoLibException.CreateResFmt(@SInvalidDHValidationParams, [obj.ToString]);
end;

class function TDHValidationParams.GetInstance(const obj: IAsn1TaggedObject; isExplicit: Boolean): IDHValidationParams;
begin
