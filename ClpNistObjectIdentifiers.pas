...
type
  ...
  class var
    ...
    FIsBooted: Boolean;
    FNistAlgorithm, FHashAlgs, FSigAlgs, FIdSha256, FIdSha384, FIdSha512, FIdSha224, FIdSha512_224, FIdSha512_256, FIdSha3_224, FIdSha3_256, FIdSha3_384, FIdSha3_512, FIdShake128, FIdShake256, FIdHMacWithSha3_224, FIdHMacWithSha3_256, FIdHMacWithSha3_384, FIdHMacWithSha3_512, FAES, FIdAES128Ecb,
      FIdAes128Cbc, FIdAes128Ofb, FIdAes128Cfb, FidAes192Ecb, FIdAes192Cbc, FIdAes192Ofb, FIdAes192Cfb, FIdAes256Ecb, FIdAes256Cbc, FIdAes256Ofb, FIdAes256Cfb, FIdDsaWithSha2, FDsaWithSha224, FDsaWithSha256, FDsaWithSha384, FDsaWithSha512, FIdDsaWithSha3_224, FIdDsaWithSha3_256, FIdDsaWithSha3_384,
      FIdDsaWithSha3_512, FIdECDsaWithSha3_224, FIdECDsaWithSha3_256, FIdECDsaWithSha3_384, FIdECDsaWithSha3_512: IDerObjectIdentifier;
  ...
  public
    ...
    class property IdHMacWithSha3_224: IDerObjectIdentifier read GetIdHMacWithSha3_224;
    class property IdHMacWithSha3_256: IDerObjectIdentifier read GetIdHMacWithSha3_256;
    class property IdHMacWithSha3_384: IDerObjectIdentifier read GetIdHMacWithSha3_384;
    class property IdHMacWithSha3_512: IDerObjectIdentifier read GetIdHMacWithSha3_512;
    ...
    class property IdDsaWithSha3_224: IDerObjectIdentifier read GetIdDsaWithSha3_224;
    class property IdDsaWithSha3_256: IDerObjectIdentifier read GetIdDsaWithSha3_256;
    class property IdDsaWithSha3_384: IDerObjectIdentifier read GetIdDsaWithSha3_384;
    class property IdDsaWithSha3_512: IDerObjectIdentifier read GetIdDsaWithSha3_512;

    class property IdECDsaWithSha3_224: IDerObjectIdentifier read GetIdECDsaWithSha3_224;
    class property IdECDsaWithSha3_256: IDerObjectIdentifier read GetIdECDsaWithSha3_256;
    class property IdECDsaWithSha3_384: IDerObjectIdentifier read GetIdECDsaWithSha3_384;
    class property IdECDsaWithSha3_512: IDerObjectIdentifier read GetIdECDsaWithSha3_512;
...
class function TNistObjectIdentifiers.GetIdHMacWithSha3_224: IDerObjectIdentifier;
begin
  result := FIdHMacWithSha3_224;
end;

class function TNistObjectIdentifiers.GetIdHMacWithSha3_256: IDerObjectIdentifier;
begin
  result := FIdHMacWithSha3_256;
end;

class function TNistObjectIdentifiers.GetIdHMacWithSha3_384: IDerObjectIdentifier;
begin
  result := FIdHMacWithSha3_384;
end;

class function TNistObjectIdentifiers.GetIdHMacWithSha3_512: IDerObjectIdentifier;
begin
...
class function TNistObjectIdentifiers.GetIdDsaWithSha3_224: IDerObjectIdentifier;
begin
  result := FIdDsaWithSha3_224;
end;

class function TNistObjectIdentifiers.GetIdDsaWithSha3_256: IDerObjectIdentifier;
begin
  result := FIdDsaWithSha3_256;
end;

class function TNistObjectIdentifiers.GetIdDsaWithSha3_384: IDerObjectIdentifier;
begin
  result := FIdDsaWithSha3_384;
end;

class function TNistObjectIdentifiers.GetIdDsaWithSha3_512: IDerObjectIdentifier;
begin
  result := FIdDsaWithSha3_512;
end;

class function TNistObjectIdentifiers.GetIdECDsaWithSha3_224: IDerObjectIdentifier;
begin
  result := FIdECDsaWithSha3_224;
end;

class function TNistObjectIdentifiers.GetIdECDsaWithSha3_256: IDerObjectIdentifier;
begin
  result := FIdECDsaWithSha3_256;
end;

class function TNistObjectIdentifiers.GetIdECDsaWithSha3_384: IDerObjectIdentifier;
begin
  result := FIdECDsaWithSha3_384;
end;

class function TNistObjectIdentifiers.GetIdECDsaWithSha3_512: IDerObjectIdentifier;
begin
