...
type
  TGenericPolynomialExtensionField = class(TInterfacedObject, IPolynomialExtensionField, IGenericPolynomialExtensionField)
  ...
  public
    constructor Create(const subfield: IFiniteField; const polynomial: IPolynomial);

    function Equals(other: TObject): Boolean; overload; override;
    function Equals(const other: IGenericPolynomialExtensionField): Boolean; reintroduce; overload;
...
constructor TGenericPolynomialExtensionField.Create(const subfield: IFiniteField; const polynomial: IPolynomial);
begin
  Fsubfield := subfield;
  FminimalPolynomial := polynomial;
end;

function TGenericPolynomialExtensionField.Equals(const other: IGenericPolynomialExtensionField): Boolean;
begin
  ...
  Result := (subfield as TObject).Equals(other.subfield as TObject) and (MinimalPolynomial as TObject).Equals(other.MinimalPolynomial as TObject);
end;

function TGenericPolynomialExtensionField.Equals(other: TObject): Boolean;
begin
  Result := Self.Equals((other as TGenericPolynomialExtensionField) as IGenericPolynomialExtensionField);
end;
...
begin
  Result := (subfield as TObject).GetHashCode() xor Int32(TBits.RotateLeft32((MinimalPolynomial as TObject).GetHashCode(), 16));
end;
