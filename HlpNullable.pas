...
resourcestring
  ...
  SUnsupportedType = 'Unsupported Type: Only supports Integers, Int64, Floats and Strings.';
...
begin
  if not System.Assigned(a) then
    ...
    raise EInvalidOperationHashLibException.CreateRes(@SCannotAssignPointerToNullable);
end;
