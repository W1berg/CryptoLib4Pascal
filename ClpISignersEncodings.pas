...
type
  ...
  IDsaEncoding = interface(IInterface)
    ...
    function Decode(const n: TBigInteger; const encoding: TCryptoLibByteArray): TCryptoLibGenericArray<TBigInteger>;
...
type
  IStandardDsaEncoding = interface(IDsaEncoding)
    ...
    function DecodeValue(const n: TBigInteger; const s: IAsn1Sequence; pos: Int32): TBigInteger;
...
type
  IPlainDsaEncoding = interface(IDsaEncoding)
    ...
    function CheckValue(const n, x: TBigInteger): TBigInteger;
    function DecodeValue(const n: TBigInteger; const buf: TCryptoLibByteArray; off, len: Int32): TBigInteger;
    procedure EncodeValue(const n, x: TBigInteger; const buf: TCryptoLibByteArray; off, len: Int32);
