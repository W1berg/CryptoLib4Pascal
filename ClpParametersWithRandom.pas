...
type
  TParametersWithRandom = class(TInterfacedObject, ICipherParameters, IParametersWithRandom)
  ...
  public
    ...
    constructor Create(const parameters: ICipherParameters; const random: ISecureRandom); overload;
...
constructor TParametersWithRandom.Create(const parameters: ICipherParameters; const random: ISecureRandom);
begin
  inherited Create();
