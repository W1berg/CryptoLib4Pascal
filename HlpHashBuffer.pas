...
type
  ...
  public
    ...
    function Feed(AData: PByte; ADataLength: Int32; var AStartIndex: Int32; var ALength: Int32; var AProcessedBytesCount: UInt64): Boolean; overload;

    function Feed(AData: PByte; ADataLength: Int32; ALength: Int32): Boolean; overload;
...
function THashBuffer.Feed(AData: PByte; ADataLength: Int32; ALength: Int32): Boolean;
var
  LLength: Int32;
begin
{$IFDEF DEBUG}
...
function THashBuffer.Feed(AData: PByte; ADataLength: Int32; var AStartIndex, ALength: Int32; var AProcessedBytesCount: UInt64): Boolean;
var
  LLength: Int32;
begin
{$IFDEF DEBUG}
...
{$ENDIF DEBUG}
  ...
  System.Move(AData[AStartIndex], FData[FPosition], LLength * System.SizeOf(Byte));
...
begin
  TArrayUtils.Fill(FData, FPosition, (System.Length(FData) - FPosition) + FPosition, Byte(0));
  FPosition := 0;
  result := FData;
end;
...
begin
  result := Format(SHashBufferMessage, [Self.Length, Self.Position, BoolToStr(Self.IsEmpty, True)]);
end;
