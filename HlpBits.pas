...
type
  ...
  public
    ...
    class procedure ReverseByteArray(ASource, ADestination: Pointer; ASize: Int64); static;
    ...
    class function RotateLeft8(AValue: Byte; ADistance: Int32): Byte; static; inline;
    class function RotateLeft32(AValue: UInt32; ADistance: Int32): UInt32; static; inline;
    class function RotateLeft64(AValue: UInt64; ADistance: Int32): UInt64; static; inline;
    class function RotateRight8(AValue: Byte; ADistance: Int32): Byte; static; inline;
    class function RotateRight32(AValue: UInt32; ADistance: Int32): UInt32; static; inline;
    class function RotateRight64(AValue: UInt64; ADistance: Int32): UInt64; static; inline;
...
class procedure TBits.ReverseByteArray(ASource, ADestination: Pointer; ASize: Int64);
var
...
{$IFDEF FPC}
  Result := SwapEndian(AValue);
{$ELSE}
  Result := UInt16((AValue and UInt32($FF)) shl 8 or (AValue and UInt32($FF00)) shr 8);
{$ENDIF FPC}
...
{$IFDEF FPC}
  Result := SwapEndian(AValue);
{$ELSE}
  Result := ((AValue shl 24) and UInt32($FF000000)) or ((AValue shl 8) and UInt32($00FF0000)) or ((AValue shr 8) and UInt32($0000FF00)) or ((AValue shr 24) and UInt32($000000FF));
{$ENDIF FPC}
...
{$IFDEF FPC}
  Result := SwapEndian(AValue);
{$ELSE}
  Result := ((AValue shl 56) and UInt64($FF00000000000000)) or ((AValue shl 40) and UInt64($00FF000000000000)) or ((AValue shl 24) and UInt64($0000FF0000000000)) or ((AValue shl 8) and UInt64($000000FF00000000)) or ((AValue shr 8) and UInt64($00000000FF000000)) or
    ((AValue shr 24) and UInt64($0000000000FF0000)) or ((AValue shr 40) and UInt64($000000000000FF00)) or ((AValue shr 56) and UInt64($00000000000000FF));
{$ENDIF FPC}
