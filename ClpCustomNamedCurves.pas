...
type
  ...
  class var
    ...
    class procedure DefineCurveWithOid(const name: string; const oid: IDerObjectIdentifier; const holder: IX9ECParametersHolder); static; inline;

    class procedure DefineCurveAlias(const name: string; const oid: IDerObjectIdentifier); static; inline;
  ...
  type
    ...
    /// curve25519
    /// </summary>
    TCurve25519Holder = class sealed(TX9ECParametersHolder, IX9ECParametersHolder)
...
class function TCustomNamedCurves.ConfigureBasepoint(const curve: IECCurve; const encoding: string): IX9ECPoint;
begin
...
class procedure TCustomNamedCurves.DefineCurveWithOid(const name: string; const oid: IDerObjectIdentifier; const holder: IX9ECParametersHolder);
var
  LName: string;
begin
  LName := name;
...
class procedure TCustomNamedCurves.DefineCurveAlias(const name: string; const oid: IDerObjectIdentifier);
var
...
class function TCustomNamedCurves.ConfigureCurve(const curve: IECCurve): IECCurve;
begin
  result := curve;
end;

class function TCustomNamedCurves.ConfigureCurveGlv(const c: IECCurve; const p: IGlvTypeBParameters): IECCurve;
var
...
class function TCustomNamedCurves.GetByOid(const oid: IDerObjectIdentifier): IX9ECParameters;
var
...
class function TCustomNamedCurves.GetOid(const name: string): IDerObjectIdentifier;
begin
...
class function TCustomNamedCurves.GetByName(const name: string): IX9ECParameters;
var
  holder: IX9ECParametersHolder;
begin
...
class function TCustomNamedCurves.GetName(const oid: IDerObjectIdentifier): string;
begin
...
begin
  ...
  FoidToCurve := TDictionary<IDerObjectIdentifier, IX9ECParametersHolder>.Create();
  FoidToName := TDictionary<IDerObjectIdentifier, string>.Create();

  Fnames := TList<string>.Create();

  DefineCurveWithOid('curve25519', TCryptlibObjectIdentifiers.Curvey25519, TCurve25519Holder.Instance);

  DefineCurveWithOid('secp256k1', TSecObjectIdentifiers.SecP256k1, TSecP256K1Holder.Instance);

  DefineCurveWithOid('secp256r1', TSecObjectIdentifiers.SecP256r1, TSecP256R1Holder.Instance);

  DefineCurveWithOid('secp384r1', TSecObjectIdentifiers.SecP384r1, TSecP384R1Holder.Instance);

  DefineCurveWithOid('secp521r1', TSecObjectIdentifiers.SecP521r1, TSecP521R1Holder.Instance);

  DefineCurveWithOid('sect283k1', TSecObjectIdentifiers.SecT283k1, TSecT283K1Holder.Instance);
...
begin
  ...
  { *
    ...
    * }
  G := ConfigureBasepoint(curve, '042AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAD245A20AE19A1B8A086B4E01EDD2C7748D14C923D4D7E6D7C61B229E9C5A27ECED3D9');

  result := TX9ECParameters.Create(curve, G, curve.Order, curve.Cofactor, S);
end;

class function TCustomNamedCurves.TCurve25519Holder.Instance: IX9ECParametersHolder;
begin
