...
type
  ...
  public
    ...
    constructor Create(const beta, lambda: TBigInteger; const splitParams: IScalarSplitParameters);
...
constructor TGlvTypeBParameters.Create(const beta, lambda: TBigInteger; const splitParams: IScalarSplitParameters);
begin
  inherited Create();
  Fbeta := beta;
  Flambda := lambda;
