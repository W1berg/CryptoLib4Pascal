...
resourcestring
  ...
  SArgon2ParameterBuilderNotInitialized = 'Argon2 Parameter Builder Not Initialized';

type
  TArgon2ParametersBuilder = class abstract(TInterfacedObject, IArgon2ParametersBuilder)
  ...
  type
    ...
    public
      constructor Create(AType: TArgon2Type; const ASalt, ASecret, AAdditional: THashLibByteArray; AIterations, AMemory, ALanes: Int32; AVersion: TArgon2Version);
  ...
  public
    ...
    function WithParallelism(AParallelism: Int32): IArgon2ParametersBuilder; virtual;

    function WithSalt(const ASalt: THashLibByteArray): IArgon2ParametersBuilder; virtual;

    function WithSecret(const ASecret: THashLibByteArray): IArgon2ParametersBuilder; virtual;

    function WithAdditional(const AAdditional: THashLibByteArray): IArgon2ParametersBuilder; virtual;

    function WithIterations(AIterations: Int32): IArgon2ParametersBuilder; virtual;

    function WithMemoryAsKB(AMemory: Int32): IArgon2ParametersBuilder; virtual;

    function WithMemoryPowOfTwo(AMemory: Int32): IArgon2ParametersBuilder; virtual;

    function WithVersion(AVersion: TArgon2Version): IArgon2ParametersBuilder; virtual;
...
type
  ...
  /// </summary>
  TPBKDF_Argon2NotBuildInAdapter = class sealed(TKDF, IPBKDF_Argon2, IPBKDF_Argon2NotBuildIn)
  ...
  type
    ...
    var
      ...
      procedure CheckAreBlocksInitialized(const ABlocks: THashLibGenericArray<TBlock>);
  ...
  type
    ...
    var
      ...
      class procedure Rotr64(var ABlock: TBlock; Av, Aw, Ac: Int32); static; inline;
      class procedure F(var ABlock: TBlock; Aa, Ab, Ac, Ad: Int32); static; inline;
      class procedure RoundFunction(var ABlock: TBlock; Av0, Av1, Av2, Av3, Av4, Av5, Av6, Av7, Av8, Av9, Av10, Av11, Av12, Av13, Av14, Av15: Int32); static; inline;
  ...
  var
    ...
    class procedure AddIntToLittleEndian(const AHash: IHash; An: Int32); static; inline;

    class procedure AddByteString(const AHash: IHash; const AOctets: THashLibByteArray); static; inline;

    class function MakeBlake2BInstanceAndInitialize(AHashSize: Int32): IHash; static; inline;

    class function GetStartingIndex(const APosition: TPosition): Int32; static; inline;
    ...
    function IsDataIndependentAddressing(const APosition: TPosition): Boolean; inline;
    procedure NextAddresses(const AFiller: TFillBlock; var AZeroBlock, AInputBlock, AAddressBlock: TBlock); inline;
    function IntToUInt64(Ax: Int32): UInt64; inline;
    procedure InitAddressBlocks(const AFiller: TFillBlock; const APosition: TPosition; var AZeroBlock, AInputBlock, AAddressBlock: TBlock);
    (* 1.2 Computing the index of the reference block
      1.2.1 Taking pseudo-random value from the previous block *)
    function GetPseudoRandom(const AFiller: TFillBlock; const APosition: TPosition; var AAddressBlock, AInputBlock, AZeroBlock: TBlock; APrevOffset: Int32; ADataIndependentAddressing: Boolean): UInt64;
    function GetRefLane(const APosition: TPosition; APseudoRandom: UInt64): Int32; inline;
    function GetRefColumn(const APosition: TPosition; APseudoRandom: UInt64; ASameLane: Boolean): Int32;
    function IsWithXor(const APosition: TPosition): Boolean; inline;
    function GetPrevOffset(ACurrentOffset: Int32): Int32; inline;
    function RotatePrevOffset(ACurrentOffset, APrevOffset: Int32): Int32; inline;
    procedure FillSegment(AIdx: Int32; var APosition: TPosition);
    procedure FillMemoryBlocks(AIdx: Int32; ADataContainer: PDataContainer); inline;
    procedure DoParallelFillMemoryBlocks(ADataContainer: PDataContainer);
{$IFDEF USE_PASMP}
    procedure PasMPFillMemoryBlocksWrapper(const AJob: PPasMPJob; const AThreadIndex: LongInt; const ADataContainer: Pointer; const AFromIndex, AToIndex: TPasMPNativeInt); inline;
{$ENDIF USE_PASMP}
{$IFDEF USE_MTPROCS}
    procedure MTProcsFillMemoryBlocksWrapper(AIdx: PtrInt; ADataContainer: Pointer; AItem: TMultiThreadProcItem); inline;
{$ENDIF USE_MTPROCS}
    (* *
    ...
    *)
    function InitialHash(const AParameters: IArgon2Parameters; AOutputLength: Int32; const APassword: THashLibByteArray): THashLibByteArray; inline;

    function GetInitialHashLong(const AInitialHash, AAppendix: THashLibByteArray): THashLibByteArray; inline;

    // H' - hash - variable length hash function
    function Hash(const AInput: THashLibByteArray; AOutputLength: Int32): THashLibByteArray;
    ...
    *)
    ...
    procedure Initialize(const APassword: THashLibByteArray; AOutputLength: Int32); inline;

    class procedure ValidatePBKDF_Argon2Inputs(const AArgon2Parameters: IArgon2Parameters); static;
  ...
  public
    ...
    /// </param>
    constructor Create(const APassword: THashLibByteArray; const AParameters: IArgon2Parameters);
...
procedure TPBKDF_Argon2NotBuildInAdapter.TBlock.CheckAreBlocksInitialized(const ABlocks: THashLibGenericArray<TBlock>);
var
  LBlock: TBlock;
begin
  ...
  begin
    ...
    begin
      raise EArgumentNilHashLibException.CreateRes(@SBlockInstanceNotInitialized);
    end;
  end;
end;
...
var
  LIdx: Int32;
begin
  CheckAreBlocksInitialized(THashLibGenericArray<TBlock>.Create(Self, AB1, AB2));
...
procedure TPBKDF_Argon2NotBuildInAdapter.TBlock.&Xor(const AB1, AB2, AB3: TBlock);
var
  LIdx: Int32;
begin
  CheckAreBlocksInitialized(THashLibGenericArray<TBlock>.Create(Self, AB1, AB2, AB3));
  for LIdx := 0 to System.Pred(SIZE) do
  begin
...
procedure TPBKDF_Argon2NotBuildInAdapter.TBlock.FromBytes(const AInput: THashLibByteArray);
var
  LIdx: Int32;
  LPtrInput: PByte;
begin
  ...
  begin
    raise EArgumentHashLibException.CreateResFmt(@SInputLengthInvalid, [System.Length(AInput), ARGON2_BLOCK_SIZE]);
  end;
...
begin
  ...
  for LIdx := 0 to System.Pred(SIZE) do
  begin
    result := result + TConverters.ConvertBytesToHexString(TConverters.ReadUInt64AsBytesLE(Fv[LIdx]), False);
  end;
end;

{ TPBKDF_Argon2NotBuildInAdapter.TPosition }

class function TPBKDF_Argon2NotBuildInAdapter.TPosition.CreatePosition(): TPosition;
begin
  result := default (TPosition);
end;

procedure TPBKDF_Argon2NotBuildInAdapter.TPosition.Update(APass, ALane, ASlice, AIndex: Int32);
begin
  FPass := APass;
  FLane := ALane;
  FSlice := ASlice;
...
class procedure TPBKDF_Argon2NotBuildInAdapter.TFillBlock.FBlaMka(var ABlock: TBlock; Ax, Ay: Int32);
var
  Lm: UInt32;
  Lxy: UInt64;
begin
...
class procedure TPBKDF_Argon2NotBuildInAdapter.TFillBlock.Rotr64(var ABlock: TBlock; Av, Aw, Ac: Int32);
var
  LTemp: UInt64;
begin
...
class procedure TPBKDF_Argon2NotBuildInAdapter.TFillBlock.F(var ABlock: TBlock; Aa, Ab, Ac, Ad: Int32);
begin
...
class procedure TPBKDF_Argon2NotBuildInAdapter.TFillBlock.RoundFunction(var ABlock: TBlock; Av0, Av1, Av2, Av3, Av4, Av5, Av6, Av7, Av8, Av9, Av10, Av11, Av12, Av13, Av14, Av15: Int32);
begin
...
begin
  ...
  begin
    Li16 := 16 * Li;
    RoundFunction(FZ, Li16, Li16 + 1, Li16 + 2, Li16 + 3, Li16 + 4, Li16 + 5, Li16 + 6, Li16 + 7, Li16 + 8, Li16 + 9, Li16 + 10, Li16 + 11, Li16 + 12, Li16 + 13, Li16 + 14, Li16 + 15);
  end;
  ...
  begin
    Li2 := 2 * Li;
    RoundFunction(FZ, Li2, Li2 + 1, Li2 + 16, Li2 + 17, Li2 + 32, Li2 + 33, Li2 + 48, Li2 + 49, Li2 + 64, Li2 + 65, Li2 + 80, Li2 + 81, Li2 + 96, Li2 + 97, Li2 + 112, Li2 + 113);
  end;
end;

class function TPBKDF_Argon2NotBuildInAdapter.TFillBlock.CreateFillBlock: TFillBlock;
begin
...
procedure TPBKDF_Argon2NotBuildInAdapter.TFillBlock.FillBlock(var Ax, Ay, ACurrentBlock: TBlock; AWithXor: Boolean);
begin
  R.&Xor(Ax, Ay);
  FZ.CopyBlock(R);
...
constructor TArgon2ParametersBuilder.TArgon2Parameters.Create(AType: TArgon2Type; const ASalt, ASecret, AAdditional: THashLibByteArray; AIterations, AMemory, ALanes: Int32; AVersion: TArgon2Version);
begin
  inherited Create();
...
function TArgon2ParametersBuilder.TArgon2Parameters.GetSecret: THashLibByteArray;
begin
  result := System.Copy(FSecret);
end;

function TArgon2ParametersBuilder.TArgon2Parameters.GetAdditional: THashLibByteArray;
begin
...
function TArgon2ParametersBuilder.WithAdditional(const AAdditional: THashLibByteArray): IArgon2ParametersBuilder;
begin
  FAdditional := System.Copy(AAdditional);
  result := Self as IArgon2ParametersBuilder;
end;

function TArgon2ParametersBuilder.WithIterations(AIterations: Int32): IArgon2ParametersBuilder;
begin
  FIterations := AIterations;
  result := Self as IArgon2ParametersBuilder;
end;

function TArgon2ParametersBuilder.WithMemoryAsKB(AMemory: Int32): IArgon2ParametersBuilder;
begin
  FMemory := AMemory;
  result := Self as IArgon2ParametersBuilder;
end;

function TArgon2ParametersBuilder.WithMemoryPowOfTwo(AMemory: Int32): IArgon2ParametersBuilder;
begin
  FMemory := 1 shl AMemory;
  result := Self as IArgon2ParametersBuilder;
end;

function TArgon2ParametersBuilder.WithParallelism(AParallelism: Int32): IArgon2ParametersBuilder;
begin
  FLanes := AParallelism;
  result := Self as IArgon2ParametersBuilder;
end;

function TArgon2ParametersBuilder.WithSalt(const ASalt: THashLibByteArray): IArgon2ParametersBuilder;
begin
  FSalt := System.Copy(ASalt);
  result := Self as IArgon2ParametersBuilder;
end;

function TArgon2ParametersBuilder.WithSecret(const ASecret: THashLibByteArray): IArgon2ParametersBuilder;
begin
  FSecret := System.Copy(ASecret);
  result := Self as IArgon2ParametersBuilder;
end;

function TArgon2ParametersBuilder.WithVersion(AVersion: TArgon2Version): IArgon2ParametersBuilder;
begin
  FVersion := AVersion;
  result := Self as IArgon2ParametersBuilder;
end;
...
begin
  result := TArgon2Parameters.Create(FType, FSalt, FSecret, FAdditional, FIterations, FMemory, FLanes, FVersion);
end;
...
class procedure TPBKDF_Argon2NotBuildInAdapter.ValidatePBKDF_Argon2Inputs(const AArgon2Parameters: IArgon2Parameters);
begin
  if not(System.Assigned(AArgon2Parameters)) then
  begin
    raise EArgumentNilHashLibException.CreateRes(@SArgon2ParameterBuilderNotInitialized);
  end;
end;

class procedure TPBKDF_Argon2NotBuildInAdapter.AddIntToLittleEndian(const AHash: IHash; An: Int32);
begin
  AHash.TransformBytes(TConverters.ReadUInt32AsBytesLE(UInt32(An)));
end;

class procedure TPBKDF_Argon2NotBuildInAdapter.AddByteString(const AHash: IHash; const AOctets: THashLibByteArray);
begin
  if (AOctets <> nil) then
  begin
...
class function TPBKDF_Argon2NotBuildInAdapter.MakeBlake2BInstanceAndInitialize(AHashSize: Int32): IHash;
begin
  result := TBlake2B.Create(TBlake2BConfig.Create(AHashSize) as IBlake2BConfig);
  result.Initialize;
end;

class function TPBKDF_Argon2NotBuildInAdapter.GetStartingIndex(const APosition: TPosition): Int32;
begin
...
procedure TPBKDF_Argon2NotBuildInAdapter.DoInit(const AParameters: IArgon2Parameters);
var
  LMemoryBlocks: Int32;
begin
  // 2. Align memory size
...
function TPBKDF_Argon2NotBuildInAdapter.InitialHash(const AParameters: IArgon2Parameters; AOutputLength: Int32; const APassword: THashLibByteArray): THashLibByteArray;
var
  LBlake2B: IHash;
begin
...
function TPBKDF_Argon2NotBuildInAdapter.GetInitialHashLong(const AInitialHash, AAppendix: THashLibByteArray): THashLibByteArray;
begin
  System.SetLength(result, ARGON2_PREHASH_SEED_LENGTH);
  System.Move(AInitialHash[0], result[0], ARGON2_PREHASH_DIGEST_LENGTH * System.SizeOf(Byte));
  System.Move(AAppendix[0], result[ARGON2_PREHASH_DIGEST_LENGTH], 4 * System.SizeOf(Byte));
end;

function TPBKDF_Argon2NotBuildInAdapter.Hash(const AInput: THashLibByteArray; AOutputLength: Int32): THashLibByteArray;
var
...
begin
  ...
  begin
    ...
    System.Move(LOutBuffer[0], result[0], (LBlake2BLength div 2) * System.SizeOf(Byte));
    ...
    begin
      ...
      System.Move(LOutBuffer[0], result[LPosition], (LBlake2BLength div 2) * System.SizeOf(Byte));
    ...
    LBlake2B.TransformBytes(LOutBuffer, 0, System.Length(LOutBuffer));
    LOutBuffer := LBlake2B.TransformFinal.GetBytes();
    System.Move(LOutBuffer[0], result[LPosition], LLastLength * System.SizeOf(Byte));
  end;
{$IFDEF DEBUG}
...
procedure TPBKDF_Argon2NotBuildInAdapter.FillFirstBlocks(const AInitialHash: THashLibByteArray);
var
  LZeroBytes, LOneBytes, LInitialHashWithZeros, LInitialHashWithOnes, LBlockHashBytes: THashLibByteArray;
  LIdx: Int32;
begin
  ...
  begin
    TConverters.ReadUInt32AsBytesLE(UInt32(LIdx), LInitialHashWithZeros, ARGON2_PREHASH_DIGEST_LENGTH + 4);
    TConverters.ReadUInt32AsBytesLE(UInt32(LIdx), LInitialHashWithOnes, ARGON2_PREHASH_DIGEST_LENGTH + 4);
...
function TPBKDF_Argon2NotBuildInAdapter.IsDataIndependentAddressing(const APosition: TPosition): Boolean;
begin
  result := (FParameters.&Type = TArgon2Type.a2tARGON2_i) or ((FParameters.&Type = TArgon2Type.a2tARGON2_id) and (APosition.FPass = 0) and (APosition.FSlice < (ARGON2_SYNC_POINTS div 2)));
end;

procedure TPBKDF_Argon2NotBuildInAdapter.NextAddresses(const AFiller: TFillBlock; var AZeroBlock, AInputBlock, AAddressBlock: TBlock);
begin
...
procedure TPBKDF_Argon2NotBuildInAdapter.InitAddressBlocks(const AFiller: TFillBlock; const APosition: TPosition; var AZeroBlock, AInputBlock, AAddressBlock: TBlock);
begin
...
function TPBKDF_Argon2NotBuildInAdapter.GetPseudoRandom(const AFiller: TFillBlock; const APosition: TPosition; var AAddressBlock, AInputBlock, AZeroBlock: TBlock; APrevOffset: Int32; ADataIndependentAddressing: Boolean): UInt64;
begin
...
function TPBKDF_Argon2NotBuildInAdapter.GetRefLane(const APosition: TPosition; APseudoRandom: UInt64): Int32;
var
  LRefLane: Int32;
begin
...
function TPBKDF_Argon2NotBuildInAdapter.GetRefColumn(const APosition: TPosition; APseudoRandom: UInt64; ASameLane: Boolean): Int32;
var
...
begin
  ...
  begin
    ...
    begin
      ...
      LReferenceAreaSize := ((APosition.FSlice) * FSegmentLength) + APosition.FIndex - 1;
    end
    else
    begin
  ...
  LRelativePosition := UInt64(LReferenceAreaSize) - 1 - UInt64((UInt64(LReferenceAreaSize) * LRelativePosition) shr 32);

  result := Int32(UInt64(LStartPosition) + LRelativePosition) mod FLaneLength;
end;

function TPBKDF_Argon2NotBuildInAdapter.IsWithXor(const APosition: TPosition): Boolean;
begin
  result := not((APosition.FPass = 0) or (FParameters.Version = TArgon2Version.a2vARGON2_VERSION_10));
end;

function TPBKDF_Argon2NotBuildInAdapter.GetPrevOffset(ACurrentOffset: Int32): Int32;
begin
...
function TPBKDF_Argon2NotBuildInAdapter.RotatePrevOffset(ACurrentOffset, APrevOffset: Int32): Int32;
begin
...
procedure TPBKDF_Argon2NotBuildInAdapter.Initialize(const APassword: THashLibByteArray; AOutputLength: Int32);
var
...
procedure TPBKDF_Argon2NotBuildInAdapter.FillSegment(AIdx: Int32; var APosition: TPosition);
var
  LAddressBlock, LInputBlock, LZeroBlock, LPrevBlock, LRefBlock, LCurrentBlock: TBlock;
...
begin
  ...
  LCurrentOffset := (APosition.FLane * FLaneLength) + (APosition.FSlice * FSegmentLength) + LStartingIndex;
  ...
  begin
    ...
    InitAddressBlocks(LFiller, APosition, LZeroBlock, LInputBlock, LAddressBlock);
  end;
  ...
  begin
    ...
    LPseudoRandom := GetPseudoRandom(LFiller, APosition, LAddressBlock, LInputBlock, LZeroBlock, LPrevOffset, LDataIndependentAddressing);
    LRefLane := GetRefLane(APosition, LPseudoRandom);
    LRefColumn := GetRefColumn(APosition, LPseudoRandom, LRefLane = APosition.FLane);
...
procedure TPBKDF_Argon2NotBuildInAdapter.FillMemoryBlocks(AIdx: Int32; ADataContainer: PDataContainer);
var
  LPosition: TPosition;
begin
...
procedure TPBKDF_Argon2NotBuildInAdapter.PasMPFillMemoryBlocksWrapper(const AJob: PPasMPJob; const AThreadIndex: LongInt; const ADataContainer: Pointer; const AFromIndex, AToIndex: TPasMPNativeInt);
begin
...
procedure TPBKDF_Argon2NotBuildInAdapter.MTProcsFillMemoryBlocksWrapper(AIdx: PtrInt; ADataContainer: Pointer; AItem: TMultiThreadProcItem);
begin
...
procedure TPBKDF_Argon2NotBuildInAdapter.DoParallelFillMemoryBlocks(ADataContainer: PDataContainer);
...
{$IF DEFINED(USE_PASMP)}
      ...
      GlobalPasMP.Invoke(GlobalPasMP.ParallelFor(ADataContainer, 0, LLanes - 1, PasMPFillMemoryBlocksWrapper));
{$ELSEIF DEFINED(USE_MTPROCS)}
      ProcThreadPool.DoParallel(MTProcsFillMemoryBlocksWrapper, 0, LLanes - 1, ADataContainer);
{$ELSE}
...
function TPBKDF_Argon2NotBuildInAdapter.GetBytes(AByteCount: Int32): THashLibByteArray;
var
...
begin
  ...
  begin
    raise EArgumentHashLibException.CreateResFmt(@SInvalidOutputByteCount, [MIN_OUTLEN]);
  end;
...
constructor TPBKDF_Argon2NotBuildInAdapter.Create(const APassword: THashLibByteArray; const AParameters: IArgon2Parameters);
begin
  inherited Create();
  ...
  begin
    raise EArgumentInvalidHashLibException.CreateResFmt(@SLanesTooSmall, [MIN_PARALLELISM]);
  end
  else if (FParameters.Lanes > MAX_PARALLELISM) then
  begin
    raise EArgumentInvalidHashLibException.CreateResFmt(@SLanesTooBig, [MAX_PARALLELISM]);
  end
  else if (FParameters.Memory < (2 * FParameters.Lanes)) then
  begin
    raise EArgumentInvalidHashLibException.CreateResFmt(@SMemoryTooSmall, [(2 * FParameters.Lanes), (2 * FParameters.Lanes)]);
  end
  else if (FParameters.Iterations < MIN_ITERATIONS) then
  begin
    raise EArgumentInvalidHashLibException.CreateResFmt(@SIterationsTooSmall, [MIN_ITERATIONS]);
  end;
