...
begin
  ...
  TConverters.le64_copy(PCardinal(LBuffer), 0, PByte(result), 0, System.Length(result));
end;
...
begin
  ...
  while LIdx < 19 do
  begin
    FMill[LIdx] := TBits.RotateRight64(LA[(7 * LIdx) mod 19], (LIdx * (LIdx + 1)) shr 1);
    System.Inc(LIdx);
  end;
...
procedure TRadioGatun64.TransformBlock(AData: PByte; ADataLength: Int32; AIndex: Int32);
var
