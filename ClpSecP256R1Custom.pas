...
resourcestring
  SInvalidValueForSecP256R1FieldElement = 'Value Invalid for SecP256R1FieldElement "%s"';
...
type
  TSecP256R1FieldElement = class(TAbstractFpFieldElement, ISecP256R1FieldElement)

  strict private

    function Equals(const other: ISecP256R1FieldElement): Boolean; reintroduce; overload;
...
type
  ...
  type
    TSecP256R1LookupTable = class sealed(TAbstractECLookupTable, ISecP256R1LookupTable)
    ...
    public
      ...
      constructor Create(const outer: ISecP256R1Curve; const table: TCryptoLibUInt32Array; size: Int32);
...
begin
  FP := TCryptoLibUInt32Array.Create($FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $00000000, $00000000, $00000000, $00000001, $FFFFFFFF);
  FPExt := TCryptoLibUInt32Array.Create($00000001, $00000000, $00000000, $FFFFFFFE, $FFFFFFFF, $FFFFFFFF, $FFFFFFFE, $00000001, $FFFFFFFE, $00000001, $FFFFFFFE, $00000001, $00000001, $FFFFFFFE, $00000002, $FFFFFFFE);
end;

class function TSecP256R1Field.FromBigInteger(const x: TBigInteger): TCryptoLibUInt32Array;
var
...
const
  n = Int64(6);
var
  cc, xx08, xx09, xx10, xx11, xx12, xx13, xx14, xx15, t0, t1, t2, t3, t4, t5, t6, t7: Int64;
begin
...
class procedure TSecP256R1Field.MultiplyAddToExt(const x, y, zz: TCryptoLibUInt32Array);
var
  c: UInt32;
begin
...
class procedure TSecP256R1Field.Reduce32(x: UInt32; const z: TCryptoLibUInt32Array);
var
  cc, xx08: Int64;
begin
  cc := 0;
...
class procedure TSecP256R1Field.SquareN(const x: TCryptoLibUInt32Array; n: Int32; const z: TCryptoLibUInt32Array);
var
  tt: TCryptoLibUInt32Array;
begin
{$IFDEF DEBUG}
...
class procedure TSecP256R1Field.SubtractExt(const xx, yy, zz: TCryptoLibUInt32Array);
var
  c: Int32;
begin
...
begin
  result := TBigInteger.Create(1, THex.Decode('FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFF'));
end;
...
begin
  ...
  begin
    raise EArgumentCryptoLibException.CreateResFmt(@SInvalidValueForSecP256R1FieldElement, ['x']);
  end;
  inherited Create();
...
function TSecP256R1FieldElement.Multiply(const b: IECFieldElement): IECFieldElement;
var
  z: TCryptoLibUInt32Array;
begin
  z := TNat256.Create();
...
function TSecP256R1FieldElement.Subtract(const b: IECFieldElement): IECFieldElement;
var
  z: TCryptoLibUInt32Array;
begin
  z := TNat256.Create();
...
function TSecP256R1FieldElement.Divide(const b: IECFieldElement): IECFieldElement;
var
  z: TCryptoLibUInt32Array;
begin
  z := TNat256.Create();
...
function TSecP256R1FieldElement.Equals(const other: ISecP256R1FieldElement): Boolean;
begin
...
constructor TSecP256R1Point.Create(const curve: IECCurve; const x, y: IECFieldElement);
begin
  Create(curve, x, y, false);
end;

constructor TSecP256R1Point.Create(const curve: IECCurve; const x, y: IECFieldElement; withCompression: Boolean);
begin
...
constructor TSecP256R1Point.Create(const curve: IECCurve; const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean);
begin
...
begin
  ...
  result := TSecP256R1Point.Create(Lcurve, X3, Y3, zs, IsCompressed) as IECPoint;
end;
...
begin
  ...
  result := TSecP256R1Point.Create(curve, RawXCoord, RawYCoord.Negate(), RawZCoords, IsCompressed) as IECPoint;
end;
...
begin
  ...
  result := TSecP256R1Point.Create(Lcurve, X3, Y3, TCryptoLibGenericArray<IECFieldElement>.Create(Z3), IsCompressed) as IECPoint;
end;
...
begin
  ...
  Fm_a := FromBigInteger(TBigInteger.Create(1, THex.Decode('FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC')));
  Fm_b := FromBigInteger(TBigInteger.Create(1, THex.Decode('5AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B')));
  Fm_order := TBigInteger.Create(1, THex.Decode('FFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551'));
...
function TSecP256R1Curve.CreateCacheSafeLookupTable(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32): IECLookupTable;
var
...
function TSecP256R1Curve.CreateRawPoint(const x, y: IECFieldElement; withCompression: Boolean): IECPoint;
begin
  result := TSecP256R1Point.Create(Self as IECCurve, x, y, withCompression);
end;

function TSecP256R1Curve.CreateRawPoint(const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean): IECPoint;
begin
...
constructor TSecP256R1Curve.TSecP256R1LookupTable.Create(const outer: ISecP256R1Curve; const table: TCryptoLibUInt32Array; size: Int32);
begin
  inherited Create();
  Fm_outer := outer;
  Fm_table := table;
...
function TSecP256R1Curve.TSecP256R1LookupTable.CreatePoint(const x, y: TCryptoLibUInt32Array): IECPoint;
var
  XFieldElement, YFieldElement: ISecP256R1FieldElement;
  SECP256R1_AFFINE_ZS: TCryptoLibGenericArray<IECFieldElement>;
begin
  SECP256R1_AFFINE_ZS := TCryptoLibGenericArray<IECFieldElement>.Create(TSecP256R1FieldElement.Create(TBigInteger.One) as ISecP256R1FieldElement);

  XFieldElement := TSecP256R1FieldElement.Create(x);
  YFieldElement := TSecP256R1FieldElement.Create(y);
  result := Fm_outer.CreateRawPoint(XFieldElement, YFieldElement, SECP256R1_AFFINE_ZS, false);
end;
...
function TSecP256R1Curve.TSecP256R1LookupTable.LookupVar(index: Int32): IECPoint;
var
  x, y: TCryptoLibUInt32Array;
  pos, J: Int32;
begin
