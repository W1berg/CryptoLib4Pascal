...
type
  IECDsaSigner = interface(IDsaExt)
    ...
    function GetDenominator(coordinateSystem: Int32; const p: IECPoint): IECFieldElement;

    function InitSecureRandom(needed: Boolean; const provided: ISecureRandom): ISecureRandom;
