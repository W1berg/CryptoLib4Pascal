...
type
  ...
  strict private
  const
    DEFAULT_WINDOW_SIZE_CUTOFFS: array [0 .. 5] of Int32 = (13, 41, 121, 337, 897, 2305);
  ...
  type
    ...
    var
      ...
      class function CheckExisting(const existingWNaf: IWNafPreCompInfo; width, reqPreCompLen: Int32; includeNegated: Boolean): Boolean; static; inline;

      class function CheckTable(const table: TCryptoLibGenericArray<IECPoint>; reqLen: Int32): Boolean; static; inline;

    public
      constructor Create(const p: IECPoint; minWidth: Int32; includeNegated: Boolean);
  ...
  type
    TPointMapCallback = class(TInterfacedObject, IPreCompCallback, IPointMapCallback)
    ...
    public
      constructor Create(const p: IECPoint; const pointMap: IECPointMap; const fromWNaf: IWNafPreCompInfo; includeNegated: Boolean);
  ...
  type
    TBasePointCallback = class(TInterfacedObject, IPreCompCallback, IBasePointCallback)
  ...
  class function Trim(const a: TCryptoLibByteArray; length: Int32): TCryptoLibByteArray; overload; static; inline;

  class function Trim(const a: TCryptoLibInt32Array; length: Int32): TCryptoLibInt32Array; overload; static; inline;

  class function ResizeTable(const a: TCryptoLibGenericArray<IECPoint>; length: Int32): TCryptoLibGenericArray<IECPoint>; static; inline;
  ...
  public
    ...
    class function GenerateCompactNaf(const k: TBigInteger): TCryptoLibInt32Array; static;
    class function GenerateCompactWindowNaf(width: Int32; const k: TBigInteger): TCryptoLibInt32Array; static;

    class function GenerateJsf(const g, h: TBigInteger): TCryptoLibByteArray; static;
    class function GenerateNaf(const k: TBigInteger): TCryptoLibByteArray; static;
    // /**
    ...
    // */
    class function GenerateWindowNaf(width: Int32; const k: TBigInteger): TCryptoLibByteArray; static;

    class function GetNafWeight(const k: TBigInteger): Int32; static; inline;

    class function GetWNafPreCompInfo(const p: IECPoint): IWNafPreCompInfo; overload; static; inline;

    class function GetWNafPreCompInfo(const preCompInfo: IPreCompInfo): IWNafPreCompInfo; overload; static; inline;
    ...
    /// the window size to use
    /// </returns>
    class function GetWindowSize(bits, maxWidth: Int32): Int32; overload; static; inline;
    ...
    /// the window size to use
    /// </returns>
    class function GetWindowSize(bits: Int32; const windowSizeCutoffs: array of Int32): Int32; overload; static;
    ...
    /// the window size to use
    /// </returns>
    class function GetWindowSize(bits: Int32; const windowSizeCutoffs: array of Int32; maxWidth: Int32): Int32; overload; static;

    class function Precompute(const p: IECPoint; minWidth: Int32; includeNegated: Boolean): IWNafPreCompInfo; static;

    class procedure ConfigureBasepoint(const p: IECPoint); static;

    class function PrecomputeWithPointMap(const p: IECPoint; const pointMap: IECPointMap; const fromWNaf: IWNafPreCompInfo; includeNegated: Boolean): IWNafPreCompInfo;
...
type
  ...
  type
    ...
    var
      ...
      class function CheckExisting(const existingEndo: IEndoPreCompInfo; const endomorphism: IECEndomorphism): Boolean; static; inline;

    public
      constructor Create(const endomorphism: IECEndomorphism; const p: IECPoint);

      function Precompute(const existing: IPreCompInfo): IPreCompInfo;

    end;

  class function CalculateB(const k, g: TBigInteger; t: Int32): TBigInteger; static;
  ...
  public
    class function MapPoint(const endomorphism: IECEndomorphism; const p: IECPoint): IECPoint; static;

    class function DecomposeScalar(const p: IScalarSplitParameters; const k: TBigInteger): TCryptoLibGenericArray<TBigInteger>; static;
...
type
  ...
  type
    TFixedPointCallback = class(TInterfacedObject, IPreCompCallback, IFixedPointCallback)

    strict private
    var
      Fm_p: IECPoint;

      class function CheckExisting(const existingFP: IFixedPointPreCompInfo; n: Int32): Boolean; static; inline;

      class function CheckTable(const table: IECLookupTable; n: Int32): Boolean; static; inline;
  ...
  public
    ...
    class function GetFixedPointPreCompInfo(const preCompInfo: IPreCompInfo): IFixedPointPreCompInfo; static; inline;

    class function GetCombSize(const c: IECCurve): Int32; static; inline;

    class function Precompute(const p: IECPoint): IFixedPointPreCompInfo; static;
  end;
...
class function TWNafUtilities.ResizeTable(const a: TCryptoLibGenericArray<IECPoint>; length: Int32): TCryptoLibGenericArray<IECPoint>;
begin
  Result := a;
  System.SetLength(Result, length);
end;

class function TWNafUtilities.Trim(const a: TCryptoLibInt32Array; length: Int32): TCryptoLibInt32Array;
begin
  Result := a;
  System.SetLength(Result, length);
end;

class function TWNafUtilities.Trim(const a: TCryptoLibByteArray; length: Int32): TCryptoLibByteArray;
begin
  Result := a;
  System.SetLength(Result, length);
end;
...
class function TWNafUtilities.GetWindowSize(bits: Int32; const windowSizeCutoffs: array of Int32; maxWidth: Int32): Int32;
var
  w: Int32;
begin
  w := 0;
...
class function TWNafUtilities.GetWindowSize(bits: Int32; const windowSizeCutoffs: array of Int32): Int32;
begin
...
begin
  ...
  c.Precompute(p, PRECOMP_NAME, TBasePointCallback.Create(ConfWidth) as IBasePointCallback);
end;

class function TWNafUtilities.GenerateCompactNaf(const k: TBigInteger): TCryptoLibInt32Array;
var
...
class function TWNafUtilities.GenerateCompactWindowNaf(width: Int32; const k: TBigInteger): TCryptoLibInt32Array;
var
...
class function TWNafUtilities.GenerateJsf(const g, h: TBigInteger): TCryptoLibByteArray;
var
...
begin
  ...
  while (((d0 or d1) <> 0) or (k0.BitLength > Offset) or (k1.BitLength > Offset)) do
  begin
...
class function TWNafUtilities.GenerateNaf(const k: TBigInteger): TCryptoLibByteArray;
var
  _3k, diff: TBigInteger;
  digits, i: Int32;
...
class function TWNafUtilities.GenerateWindowNaf(width: Int32; const k: TBigInteger): TCryptoLibByteArray;
var
...
class function TWNafUtilities.GetWNafPreCompInfo(const preCompInfo: IPreCompInfo): IWNafPreCompInfo;
begin
  Result := preCompInfo as IWNafPreCompInfo;
end;

class function TWNafUtilities.GetWNafPreCompInfo(const p: IECPoint): IWNafPreCompInfo;
var
...
class function TWNafUtilities.Precompute(const p: IECPoint; minWidth: Int32; includeNegated: Boolean): IWNafPreCompInfo;
begin
  Result := p.Curve.Precompute(p, PRECOMP_NAME, TWNafCallback.Create(p, minWidth, includeNegated) as IWNafCallback) as IWNafPreCompInfo;
end;

class function TWNafUtilities.PrecomputeWithPointMap(const p: IECPoint; const pointMap: IECPointMap; const fromWNaf: IWNafPreCompInfo; includeNegated: Boolean): IWNafPreCompInfo;
var
  c: IECCurve;
begin
  c := p.Curve;
  Result := c.Precompute(p, PRECOMP_NAME, TPointMapCallback.Create(p, pointMap, fromWNaf, includeNegated) as IPointMapCallback) as IWNafPreCompInfo;
end;
...
class function TWNafUtilities.TWNafCallback.CheckTable(const table: TCryptoLibGenericArray<IECPoint>; reqLen: Int32): Boolean;
begin
  Result := (table <> nil) and (System.length(table) >= reqLen);
end;

class function TWNafUtilities.TWNafCallback.CheckExisting(const existingWNaf: IWNafPreCompInfo; width, reqPreCompLen: Int32; includeNegated: Boolean): Boolean;
begin
  Result := (existingWNaf <> nil) and (existingWNaf.width >= Max(existingWNaf.ConfWidth, width))

    and CheckTable(existingWNaf.PreComp, reqPreCompLen) and ((not includeNegated) or CheckTable(existingWNaf.PreCompNeg, reqPreCompLen));
end;

constructor TWNafUtilities.TWNafCallback.Create(const p: IECPoint; minWidth: Int32; includeNegated: Boolean);
begin
  inherited Create();
  Fm_p := p;
  FminWidth := minWidth;
...
function TWNafUtilities.TWNafCallback.Precompute(const existing: IPreCompInfo): IPreCompInfo;
var
  ...
  reqPreCompLen, iniPreCompLen, curPreCompLen, pos, width, PromotionCountdown, ConfWidth: Int32;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          // */
          if ((not(twiceP.IsInfinity)) and (TECAlgorithms.IsFpCurve(c)) and (c.FieldSize >= 64)) then
          begin
...
function TWNafUtilities.TBasePointCallback.Precompute(const existing: IPreCompInfo): IPreCompInfo;
var
...
class function TWNafUtilities.TPointMapCallback.CheckTable(const table: TCryptoLibGenericArray<IECPoint>; reqLen: Int32): Boolean;
begin
  Result := ((table <> nil) and (System.length(table) >= reqLen));
end;

class function TWNafUtilities.TPointMapCallback.CheckExisting(const existingWNaf: IWNafPreCompInfo; width, reqPreCompLen: Int32; includeNegated: Boolean): Boolean;
begin
  Result := ((existingWNaf <> nil) and (existingWNaf.width >= width) and (CheckTable(existingWNaf.PreComp, reqPreCompLen)) and ((not includeNegated) or (CheckTable(existingWNaf.PreCompNeg, reqPreCompLen))));
end;

constructor TWNafUtilities.TPointMapCallback.Create(const p: IECPoint; const pointMap: IECPointMap; const fromWNaf: IWNafPreCompInfo; includeNegated: Boolean);
begin
  inherited Create();
  Fm_p := p;
  FpointMap := pointMap;
...
function TWNafUtilities.TPointMapCallback.Precompute(const existing: IPreCompInfo): IPreCompInfo;
var
...
class function TEndoUtilities.CalculateB(const k, g: TBigInteger; t: Int32): TBigInteger;
var
...
class function TEndoUtilities.DecomposeScalar(const p: IScalarSplitParameters; const k: TBigInteger): TCryptoLibGenericArray<TBigInteger>;
var
  bits: Int32;
...
class function TEndoUtilities.MapPoint(const endomorphism: IECEndomorphism; const p: IECPoint): IECPoint;
var
  c: IECCurve;
  PreComp: IEndoPreCompInfo;
begin
  c := p.Curve;
  PreComp := c.Precompute(p, PRECOMP_NAME, TEndoCallback.Create(endomorphism, p) as IEndoCallback) as IEndoPreCompInfo;
...
class function TEndoUtilities.TEndoCallback.CheckExisting(const existingEndo: IEndoPreCompInfo; const endomorphism: IECEndomorphism): Boolean;
begin
  Result := ((existingEndo <> nil) and (existingEndo.endomorphism = endomorphism) and (existingEndo.MappedPoint <> nil));
end;

constructor TEndoUtilities.TEndoCallback.Create(const endomorphism: IECEndomorphism; const p: IECPoint);
begin
  inherited Create();
...
function TEndoUtilities.TEndoCallback.Precompute(const existing: IPreCompInfo): IPreCompInfo;
var
...
class function TFixedPointUtilities.TFixedPointCallback.CheckTable(const table: IECLookupTable; n: Int32): Boolean;
begin
  Result := (table <> nil) and (table.Size >= n);
end;

class function TFixedPointUtilities.TFixedPointCallback.CheckExisting(const existingFP: IFixedPointPreCompInfo; n: Int32): Boolean;
begin
...
class function TFixedPointUtilities.GetFixedPointPreCompInfo(const preCompInfo: IPreCompInfo): IFixedPointPreCompInfo;
begin
  Result := preCompInfo as IFixedPointPreCompInfo;
end;

class function TFixedPointUtilities.Precompute(const p: IECPoint): IFixedPointPreCompInfo;
var
  c: IECCurve;
begin
  c := p.Curve;

  Result := c.Precompute(p, PRECOMP_NAME, TFixedPointCallback.Create(p) as IFixedPointCallback) as IFixedPointPreCompInfo;
end;
...
function TFixedPointUtilities.TFixedPointCallback.Precompute(const existing: IPreCompInfo): IPreCompInfo;
var
...
begin
  ...
  tempResult.LookupTable := c.CreateCacheSafeLookupTable(LookupTable, 0, System.length(LookupTable));
