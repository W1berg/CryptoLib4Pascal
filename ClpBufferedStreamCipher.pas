...
type
  ...
  public
    ...
    function DoFinal(const input: TCryptoLibByteArray; inOff, Length: Int32): TCryptoLibByteArray; overload; override;
...
procedure TBufferedStreamCipher.Init(forEncryption: Boolean; const parameters: ICipherParameters);
var
...
function TBufferedStreamCipher.ProcessByte(input: Byte; const output: TCryptoLibByteArray; outOff: Int32): Int32;
begin
...
function TBufferedStreamCipher.ProcessBytes(const input: TCryptoLibByteArray; inOff, Length: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32;
begin
  if (Length < 1) then
  begin
    result := 0;
...
function TBufferedStreamCipher.ProcessBytes(const input: TCryptoLibByteArray; inOff, Length: Int32): TCryptoLibByteArray;
begin
  if (Length < 1) then
  begin
    result := nil;
...
function TBufferedStreamCipher.DoFinal(const input: TCryptoLibByteArray; inOff, Length: Int32): TCryptoLibByteArray;
begin
  if (Length < 1) then
  begin
    result := EmptyBuffer;
