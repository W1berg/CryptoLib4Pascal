...
type
  ...
  public
    ...
    /// </summary>
    function VerifySignature(const &message: TCryptoLibByteArray; const r, s: TBigInteger): Boolean; virtual;
...
function TDsaSigner.CalculateE(const n: TBigInteger; const &message: TCryptoLibByteArray): TBigInteger;
var
  length: Int32;
begin
...
function TDsaSigner.GenerateSignature(const &message: TCryptoLibByteArray): TCryptoLibGenericArray<TBigInteger>;
var
...
procedure TDsaSigner.Init(forSigning: Boolean; const parameters: ICipherParameters);
var
...
function TDsaSigner.InitSecureRandom(needed: Boolean; const provided: ISecureRandom): ISecureRandom;
begin
  if (not needed) then
  begin
    result := nil;
...
function TDsaSigner.VerifySignature(const &message: TCryptoLibByteArray; const r, s: TBigInteger): Boolean;
var
  parameters: IDsaParameters;
