...
type
  TECPublicKeyParameters = class sealed(TECKeyParameters, IECPublicKeyParameters)
  ...
  public
    constructor Create(const q: IECPoint; const parameters: IECDomainParameters); overload;

    constructor Create(const algorithm: string; const q: IECPoint; const parameters: IECDomainParameters); overload;
...
constructor TECPublicKeyParameters.Create(const algorithm: string; const q: IECPoint; const parameters: IECDomainParameters);
begin
...
constructor TECPublicKeyParameters.Create(const q: IECPoint; const parameters: IECDomainParameters);
begin
  Create('EC', q, parameters);
end;

function TECPublicKeyParameters.Equals(const other: IECPublicKeyParameters): Boolean;
begin
