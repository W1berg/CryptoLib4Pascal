...
type
  IHash = interface(IInterface)
    ...
    procedure TransformBytes(const AData: THashLibByteArray; AIndex: Int32; ALength: Int32); overload;
    ...
    function ComputeString(const AData: string; AEncoding: TEncoding): IHashResult;
