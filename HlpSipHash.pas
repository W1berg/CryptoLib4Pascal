...
type
  ...
  public
    ...
    constructor Create(ACompressionRounds: Int32 = 2; AFinalizationRounds: Int32 = 4);
...
procedure TSipHash.TransformBytes(const AData: THashLibByteArray; AIndex, ALength: Int32);
var
