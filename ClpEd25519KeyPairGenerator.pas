...
type
  TEd25519KeyPairGenerator = class(TInterfacedObject, IEd25519KeyPairGenerator, IAsymmetricCipherKeyPairGenerator)
...
procedure TEd25519KeyPairGenerator.Init(const parameters: IKeyGenerationParameters);
begin
