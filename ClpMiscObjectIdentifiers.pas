...
type
  ...
  class var
    ...
    FIsBooted: Boolean;
    Fcryptlib, Fcryptlib_algorithm, Fcryptlib_algorithm_blowfish_ECB, Fcryptlib_algorithm_blowfish_CBC, Fcryptlib_algorithm_blowfish_CFB, Fcryptlib_algorithm_blowfish_OFB, Fblake2, Fid_blake2b160, Fid_blake2b256, Fid_blake2b384, Fid_blake2b512, Fid_blake2s128, Fid_blake2s160, Fid_blake2s224,
      Fid_blake2s256, Fid_scrypt: IDerObjectIdentifier;
    ...
    class function Getcryptlib_algorithm_blowfish_ECB: IDerObjectIdentifier; static; inline;
    class function Getcryptlib_algorithm_blowfish_CBC: IDerObjectIdentifier; static; inline;
    class function Getcryptlib_algorithm_blowfish_CFB: IDerObjectIdentifier; static; inline;
    class function Getcryptlib_algorithm_blowfish_OFB: IDerObjectIdentifier; static; inline;
  ...
  public
    ...
    class property cryptlib_algorithm: IDerObjectIdentifier read Getcryptlib_algorithm;
    class property cryptlib_algorithm_blowfish_ECB: IDerObjectIdentifier read Getcryptlib_algorithm_blowfish_ECB;
    class property cryptlib_algorithm_blowfish_CBC: IDerObjectIdentifier read Getcryptlib_algorithm_blowfish_CBC;
    class property cryptlib_algorithm_blowfish_CFB: IDerObjectIdentifier read Getcryptlib_algorithm_blowfish_CFB;
    class property cryptlib_algorithm_blowfish_OFB: IDerObjectIdentifier read Getcryptlib_algorithm_blowfish_OFB;
...
class function TMiscObjectIdentifiers.Getcryptlib_algorithm: IDerObjectIdentifier;
begin
  result := Fcryptlib_algorithm;
end;

class function TMiscObjectIdentifiers.Getcryptlib_algorithm_blowfish_CBC: IDerObjectIdentifier;
begin
  result := Fcryptlib_algorithm_blowfish_CBC;
end;

class function TMiscObjectIdentifiers.Getcryptlib_algorithm_blowfish_CFB: IDerObjectIdentifier;
begin
  result := Fcryptlib_algorithm_blowfish_CFB;
end;

class function TMiscObjectIdentifiers.Getcryptlib_algorithm_blowfish_ECB: IDerObjectIdentifier;
begin
  result := Fcryptlib_algorithm_blowfish_ECB;
end;

class function TMiscObjectIdentifiers.Getcryptlib_algorithm_blowfish_OFB: IDerObjectIdentifier;
begin
