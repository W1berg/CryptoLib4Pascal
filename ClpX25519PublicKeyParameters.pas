...
type
  TX25519PublicKeyParameters = class sealed(TAsymmetricKeyParameter, IX25519PublicKeyParameters)
  ...
  public
    ...
    function Equals(const other: IX25519PublicKeyParameters): Boolean; reintroduce; overload;
...
constructor TX25519PublicKeyParameters.Create(const buf: TCryptoLibByteArray; off: Int32);
begin
...
procedure TX25519PublicKeyParameters.Encode(const buf: TCryptoLibByteArray; off: Int32);
begin
  System.Move(FData[0], buf[off], KeySize * System.SizeOf(Byte));
end;

function TX25519PublicKeyParameters.Equals(const other: IX25519PublicKeyParameters): Boolean;
begin
