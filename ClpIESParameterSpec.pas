...
type
  ...
  /// </summary>
  TIESParameterSpec = class sealed(TInterfacedObject, IAlgorithmParameterSpec, IIESParameterSpec)
  ...
  public
    ...
    /// </param>
    constructor Create(const derivation, encoding: TCryptoLibByteArray; MacKeySize, CipherKeySize: Int32; const Nonce: TCryptoLibByteArray); overload;
    ...
    /// </param>
    constructor Create(const derivation, encoding: TCryptoLibByteArray; MacKeySize: Int32; CipherKeySize: Int32 = -1; const Nonce: TCryptoLibByteArray = nil; UsePointCompression: Boolean = False); overload;
...
constructor TIESParameterSpec.Create(const derivation, encoding: TCryptoLibByteArray; MacKeySize, CipherKeySize: Int32; const Nonce: TCryptoLibByteArray);
begin
  Create(derivation, encoding, MacKeySize, CipherKeySize, Nonce, False);
end;

constructor TIESParameterSpec.Create(const derivation, encoding: TCryptoLibByteArray; MacKeySize: Int32; CipherKeySize: Int32; const Nonce: TCryptoLibByteArray; UsePointCompression: Boolean);
begin
  inherited Create();
