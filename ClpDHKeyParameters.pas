...
type
  ...
  strict protected
    ...
    constructor Create(isPrivate: Boolean; const parameters: IDHParameters); overload;

    constructor Create(isPrivate: Boolean; const parameters: IDHParameters; const algorithmOid: IDerObjectIdentifier); overload;

  public
    function Equals(const other: IDHKeyParameters): Boolean; reintroduce; overload;
...
constructor TDHKeyParameters.Create(isPrivate: Boolean; const parameters: IDHParameters);
begin
  Create(isPrivate, parameters, TPkcsObjectIdentifiers.DhKeyAgreement);
end;

constructor TDHKeyParameters.Create(isPrivate: Boolean; const parameters: IDHParameters; const algorithmOid: IDerObjectIdentifier);
begin
