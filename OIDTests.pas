...
begin
  ...
  CheckEquals(expected, actual, 'failed "branch" check for ' + stem + '/' + branch);
end;
...
begin
  ...
  CheckEquals(o.Id, encO.Id, Format('Expected %s but got %s. on recodeCheck', [o.Id, encO.Id]));
...
begin
  ...
  DoValidOidCheck('1.1.127.32512.8323072.2130706432.545460846592.139637976727552.35747322042253312.9151314442816847872');
