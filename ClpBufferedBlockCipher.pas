...
type
  ...
  public
    ...
    procedure Init(forEncryption: Boolean; const parameters: ICipherParameters); override;
    ...
    /// </exception>
    function ProcessByte(input: Byte; const output: TCryptoLibByteArray; outOff: Int32): Int32; overload; override;

    function ProcessByte(input: Byte): TCryptoLibByteArray; overload; override;

    function ProcessBytes(const input: TCryptoLibByteArray; inOff, length: Int32): TCryptoLibByteArray; overload; override;
    ...
    /// if the cipher isn't initialised.
    /// </exception>
    function ProcessBytes(const input: TCryptoLibByteArray; inOff, length: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32; overload; override;

    function DoFinal(): TCryptoLibByteArray; overload; override;
    function DoFinal(const input: TCryptoLibByteArray; inOff, inLen: Int32): TCryptoLibByteArray; overload; override;
    ...
    /// </exception>
    function DoFinal(const output: TCryptoLibByteArray; outOff: Int32): Int32; overload; override;
...
function TBufferedBlockCipher.DoFinal(const output: TCryptoLibByteArray; outOff: Int32): Int32;
begin
  try
    if (FbufOff <> 0) then
    begin
      TCheck.DataLength(not Fcipher.IsPartialBlockOkay, SDataNotBlockSizeAligned);
      TCheck.OutputLength(output, outOff, FbufOff, SOutputBufferTooSmallForDoFinal);
...
function TBufferedBlockCipher.DoFinal(const input: TCryptoLibByteArray; inOff, inLen: Int32): TCryptoLibByteArray;
var
  &length, &pos: Int32;
...
procedure TBufferedBlockCipher.Init(forEncryption: Boolean; const parameters: ICipherParameters);
var
...
function TBufferedBlockCipher.ProcessByte(input: Byte; const output: TCryptoLibByteArray; outOff: Int32): Int32;
begin
...
function TBufferedBlockCipher.ProcessBytes(const input: TCryptoLibByteArray; inOff, length: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32;
var
...
begin
  ...
  begin
    ...
    begin
      resultLen := resultLen + Fcipher.ProcessBlock(input, inOff, output, outOff + resultLen);
  ...
  if (FbufOff = System.length(Fbuf)) then
  begin
    resultLen := resultLen + Fcipher.ProcessBlock(Fbuf, 0, output, outOff + resultLen);
    FbufOff := 0;
  end;
  result := resultLen;
end;

function TBufferedBlockCipher.ProcessBytes(const input: TCryptoLibByteArray; inOff, length: Int32): TCryptoLibByteArray;
var
  outLength, &pos: Int32;
  outBytes, tmp: TCryptoLibByteArray;
begin
