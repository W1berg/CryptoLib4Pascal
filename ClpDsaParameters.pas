...
type
  ...
  public
    ...
    /// index)
    /// </param>
    constructor Create(const p, q, g: TBigInteger; const parameters: IDsaValidationParameters); overload;
...
{$ENDIF DELPHI}override;
    ...
    property ValidationParameters: IDsaValidationParameters read GetValidationParameters;
...
constructor TDsaParameters.Create(const p, q, g: TBigInteger; const parameters: IDsaValidationParameters);
begin
  inherited Create();
