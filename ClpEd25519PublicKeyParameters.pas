...
type
  TEd25519PublicKeyParameters = class sealed(TAsymmetricKeyParameter, IEd25519PublicKeyParameters)
  ...
  public
    ...
    function Equals(const other: IEd25519PublicKeyParameters): Boolean; reintroduce; overload;
...
constructor TEd25519PublicKeyParameters.Create(const buf: TCryptoLibByteArray; off: Int32);
begin
...
procedure TEd25519PublicKeyParameters.Encode(const buf: TCryptoLibByteArray; off: Int32);
begin
  System.Move(FData[0], buf[off], KeySize * System.SizeOf(Byte));
end;

function TEd25519PublicKeyParameters.Equals(const other: IEd25519PublicKeyParameters): Boolean;
begin
