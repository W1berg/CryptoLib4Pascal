...
resourcestring
  ...
  SInvalidParameterHKDF = 'HKDF Parameters Required For "HkdfBytesGenerator", "parameters"';
...
type
  ...
  /// </summary>
  THkdfBytesGenerator = class(TInterfacedObject, IDerivationFunction, IHkdfBytesGenerator)
  ...
  public
    ...
    function GenerateBytes(const output: TCryptoLibByteArray; outOff, len: Int32): Int32; virtual;
...
function THkdfBytesGenerator.Extract(const salt, ikm: TCryptoLibByteArray): IKeyParameter;
var
...
function THkdfBytesGenerator.GenerateBytes(const output: TCryptoLibByteArray; outOff, len: Int32): Int32;
var
...
begin
  ...
  begin
    ...
    FhMacHash.Init(TKeyParameter.Create(hkdfParameters.GetIkm()) as IKeyParameter);
  end
  else
  begin
