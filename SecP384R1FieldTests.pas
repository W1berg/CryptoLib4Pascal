...
type
  ...
  var
    ...
    function Nat_ToBigInteger(len: Int32; const x: TCryptoLibUInt32Array): TBigInteger;
...
procedure TTestSecP384R1Field.AssertAreBigIntegersEqual(const a, b: TBigInteger);
begin
...
function TTestSecP384R1Field.Nat_ToBigInteger(len: Int32; const x: TCryptoLibUInt32Array): TBigInteger;
var
  bs, temp: TBytes;
  i: Int32;
  x_i: UInt32;
begin
  ...
  begin
    ...
    begin
      ...
      System.Move(temp[0], bs[(len - 1 - i) shl 2], System.Length(temp) * SizeOf(Byte));
...
var
  ...
  bigX, bigR, bigZ: TBigInteger;
begin
  x := FE(TBigInteger.Create('2fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffd', 16));
