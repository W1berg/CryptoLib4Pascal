...
type
  ...
  class var
    ...
    FIsBooted: Boolean;
    FTeleTrusTAlgorithm, FRipeMD160, FRipeMD128, FRipeMD256, FECSign, FECSignWithSha1, FECSignWithRipeMD160, FEccBrainpool, FEllipticCurve, FVersionOne, FBrainpoolP160R1, FBrainpoolP160T1, FBrainpoolP192R1, FBrainpoolP192T1, FBrainpoolP224R1, FBrainpoolP224T1, FBrainpoolP256R1, FBrainpoolP256T1,
      FBrainpoolP320R1, FBrainpoolP320T1, FBrainpoolP384R1, FBrainpoolP384T1, FBrainpoolP512R1, FBrainpoolP512T1: IDerObjectIdentifier;
  ...
  public
    ...
    class property BrainpoolP160R1: IDerObjectIdentifier read GetBrainpoolP160R1;
    class property BrainpoolP160T1: IDerObjectIdentifier read GetBrainpoolP160T1;
    class property BrainpoolP192R1: IDerObjectIdentifier read GetBrainpoolP192R1;
    class property BrainpoolP192T1: IDerObjectIdentifier read GetBrainpoolP192T1;
    class property BrainpoolP224R1: IDerObjectIdentifier read GetBrainpoolP224R1;
    class property BrainpoolP224T1: IDerObjectIdentifier read GetBrainpoolP224T1;
    class property BrainpoolP256R1: IDerObjectIdentifier read GetBrainpoolP256R1;
    class property BrainpoolP256T1: IDerObjectIdentifier read GetBrainpoolP256T1;
    class property BrainpoolP320R1: IDerObjectIdentifier read GetBrainpoolP320R1;
    class property BrainpoolP320T1: IDerObjectIdentifier read GetBrainpoolP320T1;
    class property BrainpoolP384R1: IDerObjectIdentifier read GetBrainpoolP384R1;
    class property BrainpoolP384T1: IDerObjectIdentifier read GetBrainpoolP384T1;
    class property BrainpoolP512R1: IDerObjectIdentifier read GetBrainpoolP512R1;
    class property BrainpoolP512T1: IDerObjectIdentifier read GetBrainpoolP512T1;
...
begin
  ...
  begin
    ...
    FEccBrainpool := TDerObjectIdentifier.Create(TeleTrusTAlgorithm.ID + '.3.2.8');
