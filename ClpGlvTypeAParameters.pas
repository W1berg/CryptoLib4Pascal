...
type
  ...
  public
    ...
    constructor Create(const I, lambda: TBigInteger; const splitParams: IScalarSplitParameters);
...
constructor TGlvTypeAParameters.Create(const I, lambda: TBigInteger; const splitParams: IScalarSplitParameters);
begin
  inherited Create();
  FI := I;
  Flambda := lambda;
