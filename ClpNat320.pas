...
class procedure TNat320.Copy64(const x: TCryptoLibUInt64Array; xOff: Int32; const z: TCryptoLibUInt64Array; zOff: Int32);
begin
...
class function TNat320.FromBigInteger64(const x: TBigInteger): TCryptoLibUInt64Array;
var
  i: Int32;
  Lx: TBigInteger;
begin
...
class function TNat320.ToBigInteger64(const x: TCryptoLibUInt64Array): TBigInteger;
var
...
begin
  ...
  begin
    ...
    begin
      ...
      System.Move(temp[0], bs[(4 - i) shl 3], System.Length(temp) * System.SizeOf(Byte))
    end;
  end;
