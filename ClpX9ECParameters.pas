...
type
  ...
  public
    ...
    constructor Create(const curve: IECCurve; const g: IECPoint; const n: TBigInteger); overload;
    constructor Create(const curve: IECCurve; const g: IX9ECPoint; const n, h: TBigInteger); overload;
    constructor Create(const curve: IECCurve; const g: IECPoint; const n, h: TBigInteger); overload;
    constructor Create(const curve: IECCurve; const g: IECPoint; const n, h: TBigInteger; const seed: TCryptoLibByteArray); overload;
    constructor Create(const curve: IECCurve; const g: IX9ECPoint; const n, h: TBigInteger; const seed: TCryptoLibByteArray); overload;
...
constructor TX9ECParameters.Create(const curve: IECCurve; const g: IX9ECPoint; const n, h: TBigInteger);
begin
  Create(curve, g, n, h, nil);
end;

constructor TX9ECParameters.Create(const curve: IECCurve; const g: IECPoint; const n: TBigInteger);
begin
...
begin
  inherited Create();
  if ((not(Supports(seq[0], IDerInteger))) or (not(seq[0] as IDerInteger).Value.Equals(TBigInteger.One))) then
  begin
  ...
  x9c := TX9Curve.Create(TX9FieldID.GetInstance(seq[1] as TAsn1Sequence), Fn, Fh, TAsn1Sequence.GetInstance(seq[2] as TAsn1Sequence));
...
constructor TX9ECParameters.Create(const curve: IECCurve; const g: IX9ECPoint; const n, h: TBigInteger; const seed: TCryptoLibByteArray);
var
...
begin
  ...
  begin
    ...
    begin
      FfieldID := TX9FieldID.Create(exponents[4], exponents[1], exponents[2], exponents[3]);
    end
    else
    begin
...
constructor TX9ECParameters.Create(const curve: IECCurve; const g: IECPoint; const n, h: TBigInteger; const seed: TCryptoLibByteArray);
begin
  Create(curve, TX9ECPoint.Create(g) as IX9ECPoint, n, h, seed)
end;

constructor TX9ECParameters.Create(const curve: IECCurve; const g: IECPoint; const n, h: TBigInteger);
begin
  Create(curve, g, n, h, nil);
end;
...
begin
  ...
  v := TAsn1EncodableVector.Create([TDerInteger.Create(TBigInteger.One) as IDerInteger, FfieldID, TX9Curve.Create(Fcurve, Fseed) as IX9Curve, Fg, TDerInteger.Create(Fn) as IDerInteger]);
