...
type
  ...
  public
    ...
    class function CalculateAgreement(const k: TCryptoLibByteArray; kOff: Int32; const u: TCryptoLibByteArray; uOff: Int32; const r: TCryptoLibByteArray; rOff: Int32): Boolean; static; inline;
    ...
    class procedure GeneratePrivateKey(const random: ISecureRandom; const k: TCryptoLibByteArray); static; inline;

    class procedure GeneratePublicKey(const k: TCryptoLibByteArray; kOff: Int32; r: TCryptoLibByteArray; rOff: Int32); static; inline;

    class procedure PointDouble(const x, z: TCryptoLibInt32Array); static;

    class procedure Precompute(); static;

    class procedure ScalarMult(const k: TCryptoLibByteArray; kOff: Int32; const u: TCryptoLibByteArray; uOff: Int32; const r: TCryptoLibByteArray; rOff: Int32); static;

    class procedure ScalarMultBase(const k: TCryptoLibByteArray; kOff: Int32; const r: TCryptoLibByteArray; rOff: Int32); static;
...
class function TX25519.CalculateAgreement(const k: TCryptoLibByteArray; kOff: Int32; const u: TCryptoLibByteArray; uOff: Int32; const r: TCryptoLibByteArray; rOff: Int32): Boolean;
begin
  ScalarMult(k, kOff, u, uOff, r, rOff);
  result := not TArrayUtils.AreAllZeroes(r, rOff, PointSize);
end;

class function TX25519.Decode32(const bs: TCryptoLibByteArray; off: Int32): UInt32;
begin
  // UInt32 n := bs[off];
  // System.Inc(off);
...
class procedure TX25519.DecodeScalar(const k: TCryptoLibByteArray; kOff: Int32; const n: TCryptoLibUInt32Array);
var
  i: Int32;
begin
...
class procedure TX25519.GeneratePrivateKey(const random: ISecureRandom; const k: TCryptoLibByteArray);
begin
  random.NextBytes(k);
...
class procedure TX25519.GeneratePublicKey(const k: TCryptoLibByteArray; kOff: Int32; r: TCryptoLibByteArray; rOff: Int32);
begin
...
class procedure TX25519.ScalarMult(const k: TCryptoLibByteArray; kOff: Int32; const u: TCryptoLibByteArray; uOff: Int32; const r: TCryptoLibByteArray; rOff: Int32);
var
...
class procedure TX25519.ScalarMultBase(const k: TCryptoLibByteArray; kOff: Int32; const r: TCryptoLibByteArray; rOff: Int32);
var
