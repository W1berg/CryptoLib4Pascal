...
type
  ...
  public
    ...
    class procedure ReverseByteArray(Source, Dest: Pointer; Size: Int64); static;
    ...
    class function NegativeLeftShift32(Value: UInt32; ShiftBits: Int32): UInt32; static; inline;
    ...
    class function NegativeRightShift32(Value: UInt32; ShiftBits: Int32): UInt32; static; inline;
    ...
    class function NegativeRightShift64(Value: UInt64; ShiftBits: Int32): UInt64; static; inline;

    class function RotateLeft8(a_value: Byte; a_n: Int32): Byte; static; inline;
    class function RotateLeft32(a_value: UInt32; a_n: Int32): UInt32; static; inline;
    class function RotateLeft64(a_value: UInt64; a_n: Int32): UInt64; static; inline;
    class function RotateRight8(a_value: Byte; a_n: Int32): Byte; static; inline;
    class function RotateRight32(a_value: UInt32; a_n: Int32): UInt32; static; inline;
    class function RotateRight64(a_value: UInt64; a_n: Int32): UInt64; static; inline;
...
{$IFDEF FPC}
  Result := SwapEndian(Value);
{$ELSE}
  Result := UInt16((Value and UInt32($FF)) shl 8 or (Value and UInt32($FF00)) shr 8);
{$ENDIF FPC}
end;
...
{$IFDEF FPC}
  Result := SwapEndian(Value);
{$ELSE}
  Result := (Value and UInt32($000000FF)) shl 24 or (Value and UInt32($0000FF00)) shl 8 or (Value and UInt32($00FF0000)) shr 8 or (Value and UInt32($FF000000)) shr 24;
{$ENDIF FPC}
end;
...
{$IFDEF FPC}
  Result := SwapEndian(Value);
{$ELSE}
  Result := (Value and UInt64($00000000000000FF)) shl 56 or (Value and UInt64($000000000000FF00)) shl 40 or (Value and UInt64($0000000000FF0000)) shl 24 or (Value and UInt64($00000000FF000000)) shl 8 or (Value and UInt64($000000FF00000000)) shr 8 or (Value and UInt64($0000FF0000000000)) shr 24 or
    (Value and UInt64($00FF000000000000)) shr 40 or (Value and UInt64($FF00000000000000)) shr 56;
{$ENDIF FPC}
end;
...
{$ELSE}
  Result := Int32(UInt32(UInt32(UInt32(AValue) shr (AShiftBits and 31)) or (UInt32(Int32(UInt32(0 - UInt32(UInt32(AValue) shr 31)) and UInt32(Int32(0 - (Ord((AShiftBits and 31) <> 0) { and 1 } ))))) shl (32 - (AShiftBits and 31)))));
{$ENDIF FPC}
end;
...
{$ELSE}
  Result := Int64(UInt64(UInt64(UInt64(AValue) shr (AShiftBits and 63)) or (UInt64(Int64(UInt64(0 - UInt64(UInt64(AValue) shr 63)) and UInt64(Int64(0 - (Ord((AShiftBits and 63) <> 0) { and 1 } ))))) shl (64 - (AShiftBits and 63)))));
{$ENDIF FPC}
end;

class function TBits.NegativeLeftShift32(Value: UInt32; ShiftBits: Int32): UInt32;
begin
{$IFDEF DEBUG}
...
class function TBits.NegativeRightShift32(Value: UInt32; ShiftBits: Int32): UInt32;
begin
{$IFDEF DEBUG}
  System.Assert(ShiftBits < 0);
{$ENDIF DEBUG}
...
class function TBits.NegativeRightShift64(Value: UInt64; ShiftBits: Int32): UInt64;
begin
{$IFDEF DEBUG}
  System.Assert(ShiftBits < 0);
{$ENDIF DEBUG}
