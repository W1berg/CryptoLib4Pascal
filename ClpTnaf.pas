...
type
  ...
  class var
    ...
    class function GetAlpha0: TCryptoLibGenericArray<IZTauElement>; static; inline;
    ...
    class function GetAlpha1: TCryptoLibGenericArray<IZTauElement>; static; inline;

    class function GetShiftsForCofactor(const h: TBigInteger): Int32; static; inline;
  ...
  // */
    ...
    // */
    class function Norm(mu: ShortInt; const lambda: IZTauElement): TBigInteger; overload; static; inline;
    // /**
    // * Computes the norm of an element <code>&#955;</code> of
    ...
    // * @return The norm of <code>&#955;</code>.
    // */
    class function Norm(mu: ShortInt; const u, v: TSimpleBigDecimal): TSimpleBigDecimal; overload; static; inline;
    // /**
    ...
    // */
    class function Round(const lambda0, lambda1: TSimpleBigDecimal; mu: ShortInt): IZTauElement; static;
    // /**
    ...
    // */
    class function ApproximateDivisionByN(const k, s, vm: TBigInteger; a: ShortInt; m, c: Int32): TSimpleBigDecimal; static; inline;
    // /**
    ...
    // */
    class function TauAdicNaf(mu: ShortInt; const lambda: IZTauElement): TCryptoLibShortIntArray; static;
    // /**
    ...
    // */
    class function Tau(const p: IAbstractF2mPoint): IAbstractF2mPoint; static; inline;
    // /**
    ...
    // * curve.
    // */
    class function GetMu(const curve: IAbstractF2mCurve): ShortInt; overload; static; inline;

    class function GetMu(const curveA: IECFieldElement): ShortInt; overload; static; inline;
    ...
    // */
    class function GetLucas(mu: ShortInt; k: Int32; doV: Boolean): TCryptoLibGenericArray<TBigInteger>; static;
    // /**
    ...
    // */
    class function GetSi(const curve: IAbstractF2mCurve): TCryptoLibGenericArray<TBigInteger>; overload; static;

    class function GetSi(fieldSize, curveA: Int32; const cofactor: TBigInteger): TCryptoLibGenericArray<TBigInteger>; overload; static;
    ...
    // */
    class function PartModReduction(const k: TBigInteger; m: Int32; a: ShortInt; const s: TCryptoLibGenericArray<TBigInteger>; mu, c: ShortInt): IZTauElement; static;
    ...
    // */
    class function MultiplyTnaf(const p: IAbstractF2mPoint; const lambda: IZTauElement): IAbstractF2mPoint; static; inline;
    ...
    // * @return <code>&#955; * p</code>
    // */
    class function MultiplyFromTnaf(const p: IAbstractF2mPoint; const u: TCryptoLibShortIntArray): IAbstractF2mPoint; static;
    ...
    // * <code>&#955;</code>.
    // */
    class function TauAdicWNaf(mu: ShortInt; const lambda: IZTauElement; Width: ShortInt; const pow2w, tw: TBigInteger; const alpha: TCryptoLibGenericArray<IZTauElement>): TCryptoLibShortIntArray; static;
    ...
    // */
    class function GetPreComp(const p: IAbstractF2mPoint; a: ShortInt): TCryptoLibGenericArray<IAbstractF2mPoint>; static;
    ...
    // */
    class function MultiplyRTnaf(const p: IAbstractF2mPoint; const k: TBigInteger): IAbstractF2mPoint; static; inline;
...
class function TTnaf.ApproximateDivisionByN(const k, s, vm: TBigInteger; a: ShortInt; m, c: Int32): TSimpleBigDecimal;
var
  _k: Int32;
...
begin
  ...
  FAlpha0 := TCryptoLibGenericArray<IZTauElement>.Create(nil, TZTauElement.Create(TBigInteger.One, TBigInteger.Zero), nil, TZTauElement.Create(FMinusThree, FMinusOne), nil, TZTauElement.Create(FMinusOne, FMinusOne), nil, TZTauElement.Create(TBigInteger.One, FMinusOne), nil);

  FAlpha1 := TCryptoLibGenericArray<IZTauElement>.Create(nil, TZTauElement.Create(TBigInteger.One, TBigInteger.Zero), nil, TZTauElement.Create(FMinusThree, TBigInteger.One), nil, TZTauElement.Create(FMinusOne, TBigInteger.One), nil, TZTauElement.Create(TBigInteger.One, TBigInteger.One), nil);

  FAlpha0Tnaf := TCryptoLibMatrixShortIntArray.Create(nil, TCryptoLibShortIntArray.Create(1), nil, TCryptoLibShortIntArray.Create(-1, 0, 1), nil, TCryptoLibShortIntArray.Create(1, 0, 1), nil, TCryptoLibShortIntArray.Create(-1, 0, 0, 1));

  FAlpha1Tnaf := TCryptoLibMatrixShortIntArray.Create(nil, TCryptoLibShortIntArray.Create(1), nil, TCryptoLibShortIntArray.Create(-1, 0, 1), nil, TCryptoLibShortIntArray.Create(1, 0, 1), nil, TCryptoLibShortIntArray.Create(-1, 0, 0, -1));
end;
...
class function TTnaf.GetLucas(mu: ShortInt; k: Int32; doV: Boolean): TCryptoLibGenericArray<TBigInteger>;
var
...
class function TTnaf.GetPreComp(const p: IAbstractF2mPoint; a: ShortInt): TCryptoLibGenericArray<IAbstractF2mPoint>;
var
...
class function TTnaf.GetSi(fieldSize, curveA: Int32; const cofactor: TBigInteger): TCryptoLibGenericArray<TBigInteger>;
var
  mu: ShortInt;
  shifts, index: Int32;
...
class function TTnaf.GetSi(const curve: IAbstractF2mCurve): TCryptoLibGenericArray<TBigInteger>;
var
...
class function TTnaf.MultiplyFromTnaf(const p: IAbstractF2mPoint; const u: TCryptoLibShortIntArray): IAbstractF2mPoint;
var
  curve: IECCurve;
...
class function TTnaf.MultiplyTnaf(const p: IAbstractF2mPoint; const lambda: IZTauElement): IAbstractF2mPoint;
var
...
class function TTnaf.MultiplyRTnaf(const p: IAbstractF2mPoint; const k: TBigInteger): IAbstractF2mPoint;
var
  curve: IAbstractF2mCurve;
  m, a: Int32;
  mu: ShortInt;
...
class function TTnaf.Norm(mu: ShortInt; const lambda: IZTauElement): TBigInteger;
var
...
class function TTnaf.Norm(mu: ShortInt; const u, v: TSimpleBigDecimal): TSimpleBigDecimal;
var
...
class function TTnaf.PartModReduction(const k: TBigInteger; m: Int32; a: ShortInt; const s: TCryptoLibGenericArray<TBigInteger>; mu, c: ShortInt): IZTauElement;
var
...
begin
  ...
  // r0 = n - d0*q0 - 2*s1*q1
  r0 := k.Subtract(d0.Multiply(q.u)).Subtract(TBigInteger.ValueOf(2).Multiply(s[1]).Multiply(q.v));
...
class function TTnaf.Round(const lambda0, lambda1: TSimpleBigDecimal; mu: ShortInt): IZTauElement;
var
...
class function TTnaf.TauAdicNaf(mu: ShortInt; const lambda: IZTauElement): TCryptoLibShortIntArray;
var
...
begin
  ...
  while (not((r0.Equals(TBigInteger.Zero)) and (r1.Equals(TBigInteger.Zero)))) do
  begin
    // If r0 is odd
    if (r0.TestBit(0)) then
    begin
      u[i] := ShortInt(TBigInteger.Two.Subtract((r0.Subtract(r1.ShiftLeft(1))).&Mod(FFour)).Int32Value);
...
class function TTnaf.TauAdicWNaf(mu: ShortInt; const lambda: IZTauElement; Width: ShortInt; const pow2w, tw: TBigInteger; const alpha: TCryptoLibGenericArray<IZTauElement>): TCryptoLibShortIntArray;
var
