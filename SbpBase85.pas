...
resourcestring
  ...
  SUnExpectedCharacter = 'Unexpected Shortcut Character In The Middle Of a Regular Block';
...
type
  ...
  const
    ...
    class procedure WriteDecodedValue(var pOutput: PByte; value: Int64; numBytesToWrite: Int32); static; inline;

    class procedure WriteShortcut(var pOutput: PByte; blockIndex: Int32; value: Int64); static; inline;

    class function GetDecodeBufferLength(textLen: Int32; usingShortcuts: Boolean): Int32; static; inline;
  ...
  var
    ...
    function Decode(const text: TSimpleBaseLibCharArray): TSimpleBaseLibByteArray; overload;

    procedure WriteOutput(var pOutput: PChar; const table: string; input: Int64; stringLength: Int32; usesZeroShortcut, usesSpaceShortcut: Boolean); inline;
...
procedure TBase85.WriteOutput(var pOutput: PChar; const table: string; input: Int64; stringLength: Int32; usesZeroShortcut, usesSpaceShortcut: Boolean);
var
  i: Int32;
  result: Int64;
begin
...
class procedure TBase85.WriteDecodedValue(var pOutput: PByte; value: Int64; numBytesToWrite: Int32);
var
  i: Int32;
  b: Byte;
begin
...
class procedure TBase85.WriteShortcut(var pOutput: PByte; blockIndex: Int32; value: Int64);
begin
...
class function TBase85.GetDecodeBufferLength(textLen: Int32; usingShortcuts: Boolean): Int32;
begin
...
function TBase85.Decode(const text: TSimpleBaseLibCharArray): TSimpleBaseLibByteArray;
var
...
begin
  ...
  begin
    ...
    WriteOutput(pOutput, table, input, stringBlockSize, usesZeroShortcut, usesSpaceShortcut);
  end;
  ...
  begin
    ...
    WriteOutput(pOutput, table, input, remainingBytes + 1, usesZeroShortcut, usesSpaceShortcut);
  end;
