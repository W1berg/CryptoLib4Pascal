...
begin
  inherited;
  FBytes := TSimpleBaseLibMatrixByteArray.Create(TSimpleBaseLibByteArray.Create($86, $4F, $D2, $6F, $B5, $59, $F7, $5B), TSimpleBaseLibByteArray.Create($11, $22, $33), TSimpleBaseLibByteArray.Create(77, 97, 110, 32), TSimpleBaseLibByteArray.Create(0, 0, 0, 0),
    TSimpleBaseLibByteArray.Create($20, $20, $20, $20));
  FStrings := TSimpleBaseLibStringArray.Create('L/669[9<6.', '&L''"', '9jqo^', 'z', 'y');
end;
...
begin
  ...
  begin
    ...
    CheckTrue(TUtilities.AreArraysEqual(expectedOutput, result), Format('Error Decoding "%s"', [actualInput]));
  end;
end;
