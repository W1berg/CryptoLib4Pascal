...
type
  IArgon2ParametersBuilder = interface(IInterface)
    ...
    function WithSecret(const ASecret: THashLibByteArray): IArgon2ParametersBuilder;

    function WithAdditional(const AAdditional: THashLibByteArray): IArgon2ParametersBuilder;
