...
type
  ...
  TMurmur2_64 = class sealed(TMultipleTransformNonBlock, IHash64, IHashWithKey, ITransformBlock)
...
{$ENDIF FPC}
  ...
  strict protected
    function ComputeAggregatedBytes(const AData: THashLibByteArray): IHashResult; override;
...
function TMurmur2_64.ComputeAggregatedBytes(const AData: THashLibByteArray): IHashResult;
var
