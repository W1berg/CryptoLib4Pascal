...
type
  ...
  /// </para>
  /// </summary>
  TPaddedBufferedBlockCipher = class sealed(TBufferedBlockCipher, IPaddedBufferedBlockCipher)
  ...
  public
    ...
    /// the padding type.
    /// </param>
    constructor Create(const cipher: IBlockCipher; const padding: IBlockCipherPadding); overload;
    ...
    /// if the cipher isn't initialised.
    /// </exception>
    function ProcessBytes(const input: TCryptoLibByteArray; inOff, length: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32; override;
...
constructor TPaddedBufferedBlockCipher.Create(const cipher: IBlockCipher; const padding: IBlockCipherPadding);
begin
  inherited Create();
  Fcipher := cipher;
  Fpadding := padding;
...
function TPaddedBufferedBlockCipher.DoFinal(const output: TCryptoLibByteArray; outOff: Int32): Int32;
var
...
begin
  ...
  begin
    ...
    begin
      ...
      raise EDataLengthCryptoLibException.CreateRes(@SIncompleteLastBlockInDecryption);
    end;
...
procedure TPaddedBufferedBlockCipher.Init(forEncryption: Boolean; const parameters: ICipherParameters);
var
...
function TPaddedBufferedBlockCipher.ProcessByte(input: Byte; const output: TCryptoLibByteArray; outOff: Int32): Int32;
var
  resultLen: Int32;
begin
  resultLen := 0;
...
function TPaddedBufferedBlockCipher.ProcessBytes(const input: TCryptoLibByteArray; inOff, length: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32;
var
