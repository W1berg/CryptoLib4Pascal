...
type
  TParametersWithIV = class sealed(TInterfacedObject, IParametersWithIV, ICipherParameters)
  ...
  public
    constructor Create(const parameters: ICipherParameters; const iv: TCryptoLibByteArray); overload;
    constructor Create(const parameters: ICipherParameters; const iv: TCryptoLibByteArray; ivOff, ivLen: Int32); overload;
...
constructor TParametersWithIV.Create(const parameters: ICipherParameters; const iv: TCryptoLibByteArray);
begin
  inherited Create();
...
constructor TParametersWithIV.Create(const parameters: ICipherParameters; const iv: TCryptoLibByteArray; ivOff, ivLen: Int32);
begin
  inherited Create();
