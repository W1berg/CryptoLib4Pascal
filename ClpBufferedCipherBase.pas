...
resourcestring
  ...
  SInputOutputStreamSame = 'Input and Output Streams Must not Point to the Same Stream Instance';
  ...
  SStreamPositionOutOfRange = 'Stream Position (or Stream Length to Process) Is Out Of Range';
...
type
  ...
  public
    ...
    procedure Init(forEncryption: Boolean; const parameters: ICipherParameters); virtual; abstract;
    ...
    function ProcessByte(input: Byte): TCryptoLibByteArray; overload; virtual; abstract;

    function ProcessByte(input: Byte; const output: TCryptoLibByteArray; outOff: Int32): Int32; overload; virtual;

    function ProcessBytes(const input: TCryptoLibByteArray): TCryptoLibByteArray; overload; virtual;

    function ProcessBytes(const input: TCryptoLibByteArray; inOff, length: Int32): TCryptoLibByteArray; overload; virtual; abstract;

    function ProcessBytes(const input, output: TCryptoLibByteArray; outOff: Int32): Int32; overload; virtual;

    function ProcessBytes(const input: TCryptoLibByteArray; inOff: Int32; length: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32; overload; virtual;

    procedure ProcessStream(const inputStream, outputStream: TStream; length: Int64); overload; virtual;

    procedure ProcessStream(const inputStream: TStream; inPos: Int64; const outputStream: TStream; outPos: Int64; length: Int64); overload; virtual;

    function DoFinal(): TCryptoLibByteArray; overload; virtual; abstract;

    function DoFinal(const input: TCryptoLibByteArray): TCryptoLibByteArray; overload; virtual;

    function DoFinal(const input: TCryptoLibByteArray; inOff, length: Int32): TCryptoLibByteArray; overload; virtual; abstract;

    function DoFinal(const output: TCryptoLibByteArray; outOff: Int32): Int32; overload; virtual;

    function DoFinal(const input, output: TCryptoLibByteArray; outOff: Int32): Int32; overload; virtual;

    function DoFinal(const input: TCryptoLibByteArray; inOff, length: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32; overload; virtual;
...
procedure TBufferedCipherBase.SetOnProgress(const value: TBufferedCipherProgressEvent);
begin
  FOnProgress := value;
end;
...
function TBufferedCipherBase.DoFinal(const output: TCryptoLibByteArray; outOff: Int32): Int32;
var
...
function TBufferedCipherBase.DoFinal(const input: TCryptoLibByteArray): TCryptoLibByteArray;
begin
  result := DoFinal(input, 0, System.length(input));
end;

function TBufferedCipherBase.DoFinal(const input: TCryptoLibByteArray; inOff, length: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32;
var
  len: Int32;
begin
...
function TBufferedCipherBase.DoFinal(const input, output: TCryptoLibByteArray; outOff: Int32): Int32;
begin
...
function TBufferedCipherBase.ProcessByte(input: Byte; const output: TCryptoLibByteArray; outOff: Int32): Int32;
var
  outBytes: TCryptoLibByteArray;
begin
...
function TBufferedCipherBase.ProcessBytes(const input: TCryptoLibByteArray): TCryptoLibByteArray;
begin
  result := ProcessBytes(input, 0, System.length(input));
end;

function TBufferedCipherBase.ProcessBytes(const input: TCryptoLibByteArray; inOff, length: Int32; const output: TCryptoLibByteArray; outOff: Int32): Int32;
var
  outBytes: TCryptoLibByteArray;
begin
...
procedure TBufferedCipherBase.ProcessStream(const inputStream: TStream; inPos: Int64; const outputStream: TStream; outPos, length: Int64);
var
...
begin
  ...
  begin
    raise EIndexOutOfRangeCryptoLibException.CreateRes(@SStreamPositionOutOfRange);
  end;
...
procedure TBufferedCipherBase.ProcessStream(const inputStream, outputStream: TStream; length: Int64);
begin
  ProcessStream(inputStream, 0, outputStream, 0, length);
end;

function TBufferedCipherBase.ProcessBytes(const input, output: TCryptoLibByteArray; outOff: Int32): Int32;
begin
