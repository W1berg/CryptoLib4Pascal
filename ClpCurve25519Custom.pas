...
resourcestring
  SInvalidValueForCurve25519FieldElement = 'Value Invalid for Curve25519FieldElement "%s"';
...
type
  ...
  const
    ...
    class function AddPTo(const z: TCryptoLibUInt32Array): UInt32; static; inline;

    class function AddPExtTo(const zz: TCryptoLibUInt32Array): UInt32; static; inline;

    class function SubPFrom(const z: TCryptoLibUInt32Array): Int32; static; inline;

    class function SubPExtFrom(const zz: TCryptoLibUInt32Array): Int32; static; inline;
  ...
  public
    ...
    class procedure AddExt(const xx, yy, zz: TCryptoLibUInt32Array); static; inline;
    class procedure AddOne(const x, z: TCryptoLibUInt32Array); static; inline;
    class function FromBigInteger(const x: TBigInteger): TCryptoLibUInt32Array; static; inline;
    class procedure Half(const x, z: TCryptoLibUInt32Array); static; inline;
    class procedure Multiply(const x, y, z: TCryptoLibUInt32Array); static; inline;
    class procedure MultiplyAddToExt(const x, y, zz: TCryptoLibUInt32Array); static; inline;
    ...
    class procedure Reduce27(x: UInt32; const z: TCryptoLibUInt32Array); static; inline;
    class procedure Square(const x, z: TCryptoLibUInt32Array); static; inline;
    class procedure SquareN(const x: TCryptoLibUInt32Array; n: Int32; const z: TCryptoLibUInt32Array); static; inline;
    class procedure Subtract(const x, y, z: TCryptoLibUInt32Array); static; inline;
    class procedure SubtractExt(const xx, yy, zz: TCryptoLibUInt32Array); static; inline;
...
type
  TCurve25519FieldElement = class(TAbstractFpFieldElement, ICurve25519FieldElement)
  ...
  strict private
    ...
    function Equals(const other: ICurve25519FieldElement): Boolean; reintroduce; overload;
...
type
  ...
  strict protected
    ...
    function CalculateJacobianModifiedW(const z: ICurve25519FieldElement; const ZSquared: TCryptoLibUInt32Array): ICurve25519FieldElement; virtual;
    function GetJacobianModifiedW(): ICurve25519FieldElement; virtual;
    function TwiceJacobianModified(calculateW: Boolean): ICurve25519Point; virtual;
...
type
  ...
  type
    TCurve25519LookupTable = class sealed(TAbstractECLookupTable, ICurve25519LookupTable)
    ...
    public
      ...
      constructor Create(const outer: ICurve25519; const table: TCryptoLibUInt32Array; size: Int32);
  ...
  const
    Curve25519_DEFAULT_COORDS = Int32(TECCurveConstants.COORD_JACOBIAN_MODIFIED);
...
class function TCurve25519Field.AddPExtTo(const zz: TCryptoLibUInt32Array): UInt32;
var
  c: Int64;
begin
...
class function TCurve25519Field.SubPExtFrom(const zz: TCryptoLibUInt32Array): Int32;
var
  c: Int64;
begin
  c := Int64(zz[0]) - FPExt[0];
...
class procedure TCurve25519Field.AddExt(const xx, yy, zz: TCryptoLibUInt32Array);
begin
...
begin
  ...
  FPExt := TCryptoLibUInt32Array.Create($00000169, $00000000, $00000000, $00000000, $00000000, $00000000, $00000000, $00000000, $FFFFFFED, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $3FFFFFFF);
end;

class function TCurve25519Field.FromBigInteger(const x: TBigInteger): TCryptoLibUInt32Array;
var
...
class procedure TCurve25519Field.MultiplyAddToExt(const x, y, zz: TCryptoLibUInt32Array);
begin
...
class procedure TCurve25519Field.Reduce27(x: UInt32; const z: TCryptoLibUInt32Array);
var
  z7, c: UInt32;
begin
{$IFDEF DEBUG}
...
class procedure TCurve25519Field.SquareN(const x: TCryptoLibUInt32Array; n: Int32; const z: TCryptoLibUInt32Array);
var
  tt: TCryptoLibUInt32Array;
begin
{$IFDEF DEBUG}
...
class procedure TCurve25519Field.SubtractExt(const xx, yy, zz: TCryptoLibUInt32Array);
var
  c: Int32;
begin
...
begin
  ...
  FPRECOMP_POW2 := TCryptoLibUInt32Array.Create($4A0EA0B0, $C4EE1B27, $AD2FE478, $2F431806, $3DFBD7A7, $2B4D0099, $4FC1DF0B, $2B832480);
end;
...
begin
  ...
  begin
    raise EArgumentCryptoLibException.CreateResFmt(@SInvalidValueForCurve25519FieldElement, ['x']);
  end;
  inherited Create();
...
function TCurve25519FieldElement.Multiply(const b: IECFieldElement): IECFieldElement;
var
  z: TCryptoLibUInt32Array;
begin
  z := TNat256.Create();
...
var
  x1, x2, x3, x4, x7, x11, x15, x30, x60, x120, x131, x251, t1, t2: TCryptoLibUInt32Array;
begin
...
function TCurve25519FieldElement.Subtract(const b: IECFieldElement): IECFieldElement;
var
  z: TCryptoLibUInt32Array;
begin
  z := TNat256.Create();
...
function TCurve25519FieldElement.Divide(const b: IECFieldElement): IECFieldElement;
var
  z: TCryptoLibUInt32Array;
begin
  z := TNat256.Create();
...
function TCurve25519FieldElement.Equals(const other: ICurve25519FieldElement): Boolean;
begin
...
function TCurve25519Point.CalculateJacobianModifiedW(const z: ICurve25519FieldElement; const ZSquared: TCryptoLibUInt32Array): ICurve25519FieldElement;
var
...
function TCurve25519Point.TwiceJacobianModified(calculateW: Boolean): ICurve25519Point;
var
...
begin
  ...
  result := TCurve25519Point.Create(curve, x3, Y3, TCryptoLibGenericArray<IECFieldElement>.Create(Z3, W3), IsCompressed);
end;
...
var
  ...
  c: UInt32;
  tt1, t2, t3, t4, U2, S2, U1, S1, H, R, G, V, HSquared, Z3Squared: TCryptoLibUInt32Array;
...
constructor TCurve25519Point.Create(const curve: IECCurve; const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean);
begin
  inherited Create(curve, x, y, zs, withCompression);
end;

constructor TCurve25519Point.Create(const curve: IECCurve; const x, y: IECFieldElement; withCompression: Boolean);
begin
...
constructor TCurve25519Point.Create(const curve: IECCurve; const x, y: IECFieldElement);
begin
...
begin
  ...
  result := TCurve25519Point.Create(curve, RawXCoord, RawYCoord.Negate(), RawZCoords, IsCompressed);
end;
...
begin
  ...
  Fm_a := FromBigInteger(TBigInteger.Create(1, THex.decode('2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA984914A144')));
  Fm_b := FromBigInteger(TBigInteger.Create(1, THex.decode('7B425ED097B425ED097B425ED097B425ED097B425ED097B4260B5E9C7710C864')));
  Fm_order := TBigInteger.Create(1, THex.decode('1000000000000000000000000000000014DEF9DEA2F79CD65812631A5CF5D3ED'));
...
function TCurve25519.CreateCacheSafeLookupTable(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32): IECLookupTable;
var
...
function TCurve25519.CreateRawPoint(const x, y: IECFieldElement; withCompression: Boolean): IECPoint;
begin
  result := TCurve25519Point.Create(Self as IECCurve, x, y, withCompression);
end;

function TCurve25519.CreateRawPoint(const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean): IECPoint;
begin
  result := TCurve25519Point.Create(Self as IECCurve, x, y, zs, withCompression);
end;
...
constructor TCurve25519.TCurve25519LookupTable.Create(const outer: ICurve25519; const table: TCryptoLibUInt32Array; size: Int32);
begin
  inherited Create();
  Fm_outer := outer;
  Fm_table := table;
...
function TCurve25519.TCurve25519LookupTable.CreatePoint(const x, y: TCryptoLibUInt32Array): IECPoint;
var
  XFieldElement, YFieldElement: ICurve25519FieldElement;
  CURVE25519_AFFINE_ZS: TCryptoLibGenericArray<IECFieldElement>;
  C_a: TBigInteger;
begin
  C_a := TBigInteger.Create(1, THex.decode('2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA984914A144'));
  CURVE25519_AFFINE_ZS := TCryptoLibGenericArray<IECFieldElement>.Create(TCurve25519FieldElement.Create(TBigInteger.One) as ICurve25519FieldElement, TCurve25519FieldElement.Create(C_a) as ICurve25519FieldElement);

  XFieldElement := TCurve25519FieldElement.Create(x);
  YFieldElement := TCurve25519FieldElement.Create(y);
  result := Fm_outer.CreateRawPoint(XFieldElement, YFieldElement, CURVE25519_AFFINE_ZS, false);
end;
