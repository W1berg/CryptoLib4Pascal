...
type
  ...
  /// </para>
  /// </summary>
  TDHBasicAgreement = class sealed(TInterfacedObject, IDHBasicAgreement, IBasicAgreement)
...
function TDHBasicAgreement.CalculateAgreement(const pubKey: ICipherParameters): TBigInteger;
var
...
begin
  ...
  if (Fkey = nil) then
  begin
    raise EInvalidOperationCryptoLibException.CreateRes(@SAlgorithmNotInitialized);
  end;
