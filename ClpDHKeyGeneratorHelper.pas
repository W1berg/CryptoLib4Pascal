...
type
  ...
  public
    ...
    function CalculatePrivate(const dhParams: IDHParameters; const random: ISecureRandom): TBigInteger;

    function CalculatePublic(const dhParams: IDHParameters; const x: TBigInteger): TBigInteger;
...
function TDHKeyGeneratorHelper.CalculatePrivate(const dhParams: IDHParameters; const random: ISecureRandom): TBigInteger;
var
...
function TDHKeyGeneratorHelper.CalculatePublic(const dhParams: IDHParameters; const x: TBigInteger): TBigInteger;
begin
