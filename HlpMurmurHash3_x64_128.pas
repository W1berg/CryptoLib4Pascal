...
type
  TMurmurHash3_x64_128 = class sealed(THash, IHash128, IHashWithKey, ITransformBlock)
...
procedure TMurmurHash3_x64_128.TransformBytes(const AData: THashLibByteArray; AIndex, ALength: Int32);
var
