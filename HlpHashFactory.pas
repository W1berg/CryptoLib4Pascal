...
type
  ...
  type
    ...
    type
      ...
      public
        ...
        class function CreateCRC(AWidth: Int32; APolynomial, AInitialValue: UInt64; AReflectIn, AReflectOut: Boolean; AOutputXor, ACheckValue: UInt64; const ANames: THashLibStringArray): IHash; overload; static;

        class function CreateCRC(AValue: TCRCStandard): IHash; overload; static;

        class function CreateCRC16(APolynomial, AInitialValue: UInt64; AReflectIn, AReflectOut: Boolean; AOutputXor, ACheckValue: UInt64; const ANames: THashLibStringArray): IHash; static;

        class function CreateCRC32(APolynomial, AInitialValue: UInt64; AReflectIn, AReflectOut: Boolean; AOutputXor, ACheckValue: UInt64; const ANames: THashLibStringArray): IHash; static;

        class function CreateCRC64(APolynomial, AInitialValue: UInt64; AReflectIn, AReflectOut: Boolean; AOutputXor, ACheckValue: UInt64; const ANames: THashLibStringArray): IHash; static;
  ...
  type
    ...
    public
      ...
      /// <returns></returns>
      class function CreateTiger(AHashSize: Int32; ARounds: THashRounds): IHash; static;
      ...
      /// <param name="ARounds">no of rounds (standard rounds are 3, 4 and 5)</param>
      /// <returns></returns>
      class function CreateTiger2(AHashSize: Int32; ARounds: THashRounds): IHash; static;
      ...
      /// <returns></returns>
      class function CreateSnefru(ASecurityLevel: Int32; AHashSize: THashSize): IHash; static;
      ...
      /// <returns></returns>
      class function CreateHaval(ARounds: THashRounds; AHashSize: THashSize): IHash; static;
      ...
      class function CreateBlake2B(const AConfig: IBlake2BConfig = nil; const ATreeConfig: IBlake2BTreeConfig = nil): IHash; static;
      ...
      class function CreateBlake2S(const AConfig: IBlake2SConfig = nil; const ATreeConfig: IBlake2STreeConfig = nil): IHash; static;
      ...
      class function CreateBlake2BP(AHashSize: Int32; const AKey: THashLibByteArray): IHash; static;

      class function CreateBlake2SP(AHashSize: Int32; const AKey: THashLibByteArray): IHash; static;

      class function CreateBlake3_256(const AKey: THashLibByteArray): IHash; static;
  ...
  type
    ...
    public
      ...
      class function CreateCShake_128(const AN, &AS: THashLibByteArray; AXofSizeInBits: UInt64): IHash; static;
      class function CreateCShake_256(const AN, &AS: THashLibByteArray; AXofSizeInBits: UInt64): IHash; static;

      class function CreateBlake2XS(const ABlake2XSConfig: TBlake2XSConfig; AXofSizeInBits: UInt64): IHash; overload; static;

      class function CreateBlake2XS(const AKey: THashLibByteArray; AXofSizeInBits: UInt64): IHash; overload; static;

      class function CreateBlake2XB(const ABlake2XBConfig: TBlake2XBConfig; AXofSizeInBits: UInt64): IHash; overload; static;

      class function CreateBlake2XB(const AKey: THashLibByteArray; AXofSizeInBits: UInt64): IHash; overload; static;

      class function CreateKMAC128XOF(const AKMACKey, ACustomization: THashLibByteArray; AXofSizeInBits: UInt64): IHash; static;

      class function CreateKMAC256XOF(const AKMACKey, ACustomization: THashLibByteArray; AXofSizeInBits: UInt64): IHash; static;

      class function CreateBlake3XOF(const AKey: THashLibByteArray; AXofSizeInBits: UInt64): IHash; overload; static;
  ...
  type
    ...
    public
      ...
      class function CreateHMAC(const AHash: IHash; const AHMACKey: THashLibByteArray = nil): IHMAC; static;
  ...
  type
    ...
    public
      ...
      class function CreateKMAC128(const AKMACKey, ACustomization: THashLibByteArray; AOutputLengthInBits: UInt64): IKMAC; static;

      class function CreateKMAC256(const AKMACKey, ACustomization: THashLibByteArray; AOutputLengthInBits: UInt64): IKMAC; static;
  ...
  type
    ...
    public
      ...
      class function CreateBlake2BMAC(const ABlake2BKey, ASalt, APersonalisation: THashLibByteArray; AOutputLengthInBits: Int32): IBlake2BMAC; static;
  ...
  type
    ...
    public
      ...
      class function CreateBlake2SMAC(const ABlake2SKey, ASalt, APersonalisation: THashLibByteArray; AOutputLengthInBits: Int32): IBlake2SMAC; static;
...
type
  ...
  type
    ...
    public
      ...
      /// </exception>
      class function CreatePBKDF2_HMAC(const AHash: IHash; const APassword, ASalt: THashLibByteArray; AIterations: UInt32): IPBKDF2_HMAC; static;
  ...
  type
    ...
    public
      ...
      /// </exception>
      class function CreatePBKDF_Argon2(const APassword: THashLibByteArray; const AArgon2Parameters: IArgon2Parameters): IPBKDF_Argon2; static;
  ...
  type
    ...
    public
      ...
      /// </exception>
      class function CreatePBKDF_Scrypt(const APasswordBytes, ASaltBytes: THashLibByteArray; ACost, ABlockSize, AParallelism: Int32): IPBKDF_Scrypt; static;
...
class function THashFactory.TChecksum.TCRC.CreateCRC(AWidth: Int32; APolynomial, AInitialValue: UInt64; AReflectIn, AReflectOut: Boolean; AOutputXor, ACheckValue: UInt64; const ANames: THashLibStringArray): IHash;
begin
  Result := HlpCRC.TCRC.Create(AWidth, APolynomial, AInitialValue, AReflectIn, AReflectOut, AOutputXor, ACheckValue, ANames);
end;

class function THashFactory.TChecksum.TCRC.CreateCRC(AValue: TCRCStandard): IHash;
begin
  Result := HlpCRC.TCRC.CreateCRCObject(AValue);
end;

class function THashFactory.TChecksum.TCRC.CreateCRC16(APolynomial, AInitialValue: UInt64; AReflectIn, AReflectOut: Boolean; AOutputXor, ACheckValue: UInt64; const ANames: THashLibStringArray): IHash;
begin
  Result := TCRC16.Create(APolynomial, AInitialValue, AReflectIn, AReflectOut, AOutputXor, ACheckValue, ANames);
end;
...
class function THashFactory.TChecksum.TCRC.CreateCRC32(APolynomial, AInitialValue: UInt64; AReflectIn, AReflectOut: Boolean; AOutputXor, ACheckValue: UInt64; const ANames: THashLibStringArray): IHash;
begin
  Result := TCRC32.Create(APolynomial, AInitialValue, AReflectIn, AReflectOut, AOutputXor, ACheckValue, ANames);
end;
...
class function THashFactory.TChecksum.TCRC.CreateCRC64(APolynomial, AInitialValue: UInt64; AReflectIn, AReflectOut: Boolean; AOutputXor, ACheckValue: UInt64; const ANames: THashLibStringArray): IHash;
begin
  Result := TCRC64.Create(APolynomial, AInitialValue, AReflectIn, AReflectOut, AOutputXor, ACheckValue, ANames);
end;
...
class function THashFactory.TCrypto.CreateHaval(ARounds: THashRounds; AHashSize: THashSize): IHash;
begin
  case ARounds of
...
class function THashFactory.TCrypto.CreateBlake2B(const AConfig: IBlake2BConfig; const ATreeConfig: IBlake2BTreeConfig): IHash;
var
...
begin
  Result := THashFactory.TCrypto.CreateBlake2B(TBlake2BConfig.Create(THashSize.hsHashSize160) as IBlake2BConfig);
end;

class function THashFactory.TCrypto.CreateBlake2B_256: IHash;
begin
  Result := THashFactory.TCrypto.CreateBlake2B(TBlake2BConfig.Create(THashSize.hsHashSize256) as IBlake2BConfig);
end;

class function THashFactory.TCrypto.CreateBlake2B_384: IHash;
begin
  Result := THashFactory.TCrypto.CreateBlake2B(TBlake2BConfig.Create(THashSize.hsHashSize384) as IBlake2BConfig);
end;

class function THashFactory.TCrypto.CreateBlake2B_512: IHash;
begin
  Result := THashFactory.TCrypto.CreateBlake2B(TBlake2BConfig.Create(THashSize.hsHashSize512) as IBlake2BConfig);
end;

class function THashFactory.TCrypto.CreateBlake2S(const AConfig: IBlake2SConfig; const ATreeConfig: IBlake2STreeConfig): IHash;
var
...
begin
  Result := THashFactory.TCrypto.CreateBlake2S(TBlake2SConfig.Create(THashSize.hsHashSize128) as IBlake2SConfig);
end;

class function THashFactory.TCrypto.CreateBlake2S_160: IHash;
begin
  Result := THashFactory.TCrypto.CreateBlake2S(TBlake2SConfig.Create(THashSize.hsHashSize160) as IBlake2SConfig);
end;

class function THashFactory.TCrypto.CreateBlake2S_224: IHash;
begin
  Result := THashFactory.TCrypto.CreateBlake2S(TBlake2SConfig.Create(THashSize.hsHashSize224) as IBlake2SConfig);
end;

class function THashFactory.TCrypto.CreateBlake2S_256: IHash;
begin
  Result := THashFactory.TCrypto.CreateBlake2S(TBlake2SConfig.Create(THashSize.hsHashSize256) as IBlake2SConfig);
end;

class function THashFactory.TCrypto.CreateBlake2BP(AHashSize: Int32; const AKey: THashLibByteArray): IHash;
begin
  Result := TBlake2BP.Create(AHashSize, AKey);
end;

class function THashFactory.TCrypto.CreateBlake2SP(AHashSize: Int32; const AKey: THashLibByteArray): IHash;
begin
  Result := TBlake2SP.Create(AHashSize, AKey);
end;

class function THashFactory.TCrypto.CreateBlake3_256(const AKey: THashLibByteArray): IHash;
begin
  Result := TBlake3.Create(THashSize.hsHashSize256, AKey);
end;

class function THashFactory.TCrypto.CreateSnefru(ASecurityLevel: Int32; AHashSize: THashSize): IHash;
begin
...
class function THashFactory.TCrypto.CreateTiger(AHashSize: Int32; ARounds: THashRounds): IHash;
begin
  case AHashSize of
    16, 20, 24:
...
class function THashFactory.TCrypto.CreateTiger2(AHashSize: Int32; ARounds: THashRounds): IHash;
begin
  case AHashSize of
    16, 20, 24:
...
class function THashFactory.TXOF.CreateCShake_128(const AN, &AS: THashLibByteArray; AXofSizeInBits: UInt64): IHash;
var
  LXof: IXOF;
begin
...
class function THashFactory.TXOF.CreateCShake_256(const AN, &AS: THashLibByteArray; AXofSizeInBits: UInt64): IHash;
var
  LXof: IXOF;
begin
...
class function THashFactory.TXOF.CreateBlake2XS(const ABlake2XSConfig: TBlake2XSConfig; AXofSizeInBits: UInt64): IHash;
var
  LXof: IXOF;
begin
...
class function THashFactory.TXOF.CreateBlake2XS(const AKey: THashLibByteArray; AXofSizeInBits: UInt64): IHash;
var
  LConfig: IBlake2SConfig;
begin
  LConfig := TBlake2SConfig.Create(32);
  LConfig.Key := AKey;
  Result := CreateBlake2XS(TBlake2XSConfig.Create(LConfig, nil), AXofSizeInBits);
end;

class function THashFactory.TXOF.CreateBlake2XB(const ABlake2XBConfig: TBlake2XBConfig; AXofSizeInBits: UInt64): IHash;
var
  LXof: IXOF;
begin
...
class function THashFactory.TXOF.CreateBlake2XB(const AKey: THashLibByteArray; AXofSizeInBits: UInt64): IHash;
var
  LConfig: IBlake2BConfig;
begin
  LConfig := TBlake2BConfig.Create(64);
  LConfig.Key := AKey;
  Result := CreateBlake2XB(TBlake2XBConfig.Create(LConfig, nil), AXofSizeInBits);
end;

class function THashFactory.TXOF.CreateBlake3XOF(const AKey: THashLibByteArray; AXofSizeInBits: UInt64): IHash;
var
  LXof: IXOF;
begin
...
class function THashFactory.TXOF.CreateKMAC128XOF(const AKMACKey, ACustomization: THashLibByteArray; AXofSizeInBits: UInt64): IHash;
begin
  Result := TKMAC128XOF.CreateKMAC128XOF(AKMACKey, ACustomization, AXofSizeInBits);
end;

class function THashFactory.TXOF.CreateKMAC256XOF(const AKMACKey, ACustomization: THashLibByteArray; AXofSizeInBits: UInt64): IHash;
begin
  Result := TKMAC256XOF.CreateKMAC256XOF(AKMACKey, ACustomization, AXofSizeInBits);
end;

{ THashFactory.THMAC }

class function THashFactory.THMAC.CreateHMAC(const AHash: IHash; const AHMACKey: THashLibByteArray): IHMAC;
begin
...
class function THashFactory.TKMAC.CreateKMAC128(const AKMACKey, ACustomization: THashLibByteArray; AOutputLengthInBits: UInt64): IKMAC;
begin
  Result := TKMAC128.CreateKMAC128(AKMACKey, ACustomization, AOutputLengthInBits);
end;

class function THashFactory.TKMAC.CreateKMAC256(const AKMACKey, ACustomization: THashLibByteArray; AOutputLengthInBits: UInt64): IKMAC;
begin
  Result := TKMAC256.CreateKMAC256(AKMACKey, ACustomization, AOutputLengthInBits);
end;

{ THashFactory.TBlake2BMAC }

class function THashFactory.TBlake2BMAC.CreateBlake2BMAC(const ABlake2BKey, ASalt, APersonalisation: THashLibByteArray; AOutputLengthInBits: Int32): IBlake2BMAC;
begin
  Result := TBlake2BMACNotBuildInAdapter.CreateBlake2BMAC(ABlake2BKey, ASalt, APersonalisation, AOutputLengthInBits)
end;

{ THashFactory.TBlake2SMAC }

class function THashFactory.TBlake2SMAC.CreateBlake2SMAC(const ABlake2SKey, ASalt, APersonalisation: THashLibByteArray; AOutputLengthInBits: Int32): IBlake2SMAC;
begin
  Result := TBlake2SMACNotBuildInAdapter.CreateBlake2SMAC(ABlake2SKey, ASalt, APersonalisation, AOutputLengthInBits)
end;

{ TKDF.TPBKDF2_HMAC }

class function TKDF.TPBKDF2_HMAC.CreatePBKDF2_HMAC(const AHash: IHash; const APassword, ASalt: THashLibByteArray; AIterations: UInt32): IPBKDF2_HMAC;
begin
  Result := TPBKDF2_HMACNotBuildInAdapter.Create(AHash, APassword, ASalt, AIterations);
end;

{ TKDF.TPBKDF_Argon2 }

class function TKDF.TPBKDF_Argon2.CreatePBKDF_Argon2(const APassword: THashLibByteArray; const AArgon2Parameters: IArgon2Parameters): IPBKDF_Argon2;
begin
...
class function TKDF.TPBKDF_Scrypt.CreatePBKDF_Scrypt(const APasswordBytes, ASaltBytes: THashLibByteArray; ACost, ABlockSize, AParallelism: Int32): IPBKDF_Scrypt;
begin
  Result := TPBKDF_ScryptNotBuildInAdapter.Create(APasswordBytes, ASaltBytes, ACost, ABlockSize, AParallelism);
end;
