...
type
  ...
  public
    ...
    class function GetByOid(const oid: IDerObjectIdentifier): IX9ECParameters; static;
...
class function TECNamedCurveTable.GetByName(const name: string): IX9ECParameters;
var
  ecP: IX9ECParameters;
begin
...
class function TECNamedCurveTable.GetByOid(const oid: IDerObjectIdentifier): IX9ECParameters;
var
  ecP: IX9ECParameters;
begin
...
class function TECNamedCurveTable.GetOid(const name: string): IDerObjectIdentifier;
var
