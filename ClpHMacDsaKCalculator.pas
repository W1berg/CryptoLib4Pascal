...
type
  ...
  /// RFC 6979.
  /// </summary>
  THMacDsaKCalculator = class(TInterfacedObject, IDsaKCalculator, IHMacDsaKCalculator)
  ...
  public
    ...
    procedure Init(const n: TBigInteger; const random: ISecureRandom); overload; virtual;

    procedure Init(const n, d: TBigInteger; const &message: TCryptoLibByteArray); overload;
...
function THMacDsaKCalculator.BitsToInt(const t: TCryptoLibByteArray): TBigInteger;
begin
...
procedure THMacDsaKCalculator.Init(const n: TBigInteger; const random: ISecureRandom);
begin
  raise EInvalidOperationCryptoLibException.CreateRes(@SUnSupportedOperation);
end;
{$ENDIF}

procedure THMacDsaKCalculator.Init(const n, d: TBigInteger; const &message: TCryptoLibByteArray);
var
...
begin
  ...
  System.Move(dVal[0], x[System.Length(x) - System.Length(dVal)], System.Length(dVal));
  ...
  System.Move(mVal[0], m[System.Length(m) - System.Length(mVal)], System.Length(mVal));
