...
type
  ...
  TPBKDF2_HMACNotBuildInAdapter = class sealed(TKDF, IPBKDF2_HMAC, IPBKDF2_HMACNotBuildIn)
  ...
  var
    ...
    class function GetBigEndianBytes(AInput: UInt32): THashLibByteArray; static; inline;

    class procedure ValidatePBKDF2_HMACInputs(const AHash: IHash; AIterations: UInt32); static;
  public

    constructor Create(const AUnderlyingHash: IHash; const APassword, ASalt: THashLibByteArray; AIterations: UInt32);
...
class procedure TPBKDF2_HMACNotBuildInAdapter.ValidatePBKDF2_HMACInputs(const AHash: IHash; AIterations: UInt32);
begin
...
constructor TPBKDF2_HMACNotBuildInAdapter.Create(const AUnderlyingHash: IHash; const APassword, ASalt: THashLibByteArray; AIterations: UInt32);
begin
  inherited Create();
...
class function TPBKDF2_HMACNotBuildInAdapter.GetBigEndianBytes(AInput: UInt32): THashLibByteArray;
begin
...
function TPBKDF2_HMACNotBuildInAdapter.GetBytes(AByteCount: Int32): THashLibByteArray;
var
