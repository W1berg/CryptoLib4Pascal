...
begin
  inherited;
  FRawData := TSimpleBaseLibStringArray.Create('', 'f', 'fo', 'foo', 'foob', 'fooba', 'foobar', 'foobar1', 'foobar12', 'foobar123', '1234567890123456789012345678901234567890'

    );
  FEncodedData := TSimpleBaseLibStringArray.Create('', 'MY======', 'MZXQ====', 'MZXW6===', 'MZXW6YQ=', 'MZXW6YTB', 'MZXW6YTBOI======', 'MZXW6YTBOIYQ====', 'MZXW6YTBOIYTE===', 'MZXW6YTBOIYTEMY=', 'GEZDGNBVGY3TQOJQGEZDGNBVGY3TQOJQGEZDGNBVGY3TQOJQGEZDGNBVGY3TQOJQ'
