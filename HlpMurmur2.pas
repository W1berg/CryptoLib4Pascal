...
type
  ...
  TMurmur2 = class sealed(TMultipleTransformNonBlock, IHash32, IHashWithKey, ITransformBlock)
...
function TMurmur2.ComputeAggregatedBytes(const AData: THashLibByteArray): IHashResult;
var
