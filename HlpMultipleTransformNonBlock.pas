...
type
  ...
  var
    ...
    function ComputeAggregatedBytes(const AData: THashLibByteArray): IHashResult; virtual; abstract;
  ...
  public
    ...
    function ComputeBytes(const AData: THashLibByteArray): IHashResult; override;
...
procedure TMultipleTransformNonBlock.TransformBytes(const AData: THashLibByteArray; AIndex, ALength: Int32);
begin
{$IFDEF DEBUG}
...
function TMultipleTransformNonBlock.ComputeBytes(const AData: THashLibByteArray): IHashResult;
begin
  Initialize();
