...
begin
  inherited;
  FtestDataBytes := TSimpleBaseLibMatrixByteArray.Create(nil, TSimpleBaseLibByteArray.Create($AB), TSimpleBaseLibByteArray.Create($00, $01, $02, $03), TSimpleBaseLibByteArray.Create($10, $11, $12, $13), TSimpleBaseLibByteArray.Create($AB, $CD, $EF, $BA)

    );

  FtestDataString := TSimpleBaseLibStringArray.Create('', 'AB', '00010203', '10111213', 'ABCDEFBA'
...
begin
  ...
  begin
    ...
    CheckTrue(TUtilities.AreArraysEqual(FtestDataBytes[Idx], result), Format('Decode_LowerCase Failed at Index %d', [Idx]));
  end;
end;
...
begin
  ...
  begin
    ...
    CheckEquals(LowerCase(FtestDataString[Idx]), result, Format('EncodeLower Failed at Index %d', [Idx]));
  end;
end;
...
begin
  ...
  begin
    ...
    CheckEquals(FtestDataString[Idx], result, Format('EncodeUpper Failed at Index %d', [Idx]));
  end;
end;
