...
type
  ...
  /// </para>
  /// </summary>
  TBaseKdfBytesGenerator = class(TInterfacedObject, IBaseKdfBytesGenerator, IDerivationFunction)
  ...
  public
    ...
    /// </exception>
    function GenerateBytes(const output: TCryptoLibByteArray; outOff, length: Int32): Int32; virtual;
...
constructor TBaseKdfBytesGenerator.Create(counterStart: Int32; const digest: IDigest);
begin
  inherited Create();
...
function TBaseKdfBytesGenerator.GenerateBytes(const output: TCryptoLibByteArray; outOff, length: Int32): Int32;
var
