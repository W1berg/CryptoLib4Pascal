...
type
  ...
  /// </para>
  /// </summary>
  TDHBasicKeyPairGenerator = class sealed(TInterfacedObject, IAsymmetricCipherKeyPairGenerator, IDHBasicKeyPairGenerator)
...
begin
  ...
  result := TAsymmetricCipherKeyPair.Create(TDHPublicKeyParameters.Create(y, dhp) as IDHPublicKeyParameters, TDHPrivateKeyParameters.Create(x, dhp) as IDHPrivateKeyParameters);
end;

procedure TDHBasicKeyPairGenerator.Init(const parameters: IKeyGenerationParameters);
begin
