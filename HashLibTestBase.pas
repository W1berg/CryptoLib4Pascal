...
type
  ...
  strict protected
    ...
    property ExpectedString: string read GetExpectedString write SetExpectedString;
  end;
...
type
  ...
  strict protected
    ...
    property PBKDF2_HMACInstance: IPBKDF2_HMAC read GetPBKDF2_HMACInstance write SetPBKDF2_HMACInstance;
...
type
  ...
  const
    ...
    ZeroToOneHundredAndNinetyNineInHex = '000102030405060708090A0B0C0D0E0F' + '101112131415161718191A1B1C1D1E1F' + '202122232425262728292A2B2C2D2E2F' + '303132333435363738393A3B3C3D3E3F' + '404142434445464748494A4B4C4D4E4F' + '505152535455565758595A5B5C5D5E5F' + '606162636465666768696A6B6C6D6E6F' +
      '707172737475767778797A7B7C7D7E7F' + '808182838485868788898A8B8C8D8E8F' + '909192939495969798999A9B9C9D9E9F' + 'A0A1A2A3A4A5A6A7A8A9AAABACADAEAF' + 'B0B1B2B3B4B5B6B7B8B9BABBBCBDBEBF' + 'C0C1C2C3C4C5C6C7';
...
type
  ...
  strict private
  var
    FHashOfEmptyData, FHashOfDefaultData, FHashOfOnetoNine, FHashOfABCDE: string;
  ...
  strict protected
    property HashOfEmptyData: string read GetHashOfEmptyData write SetHashOfEmptyData;
    property HashOfDefaultData: string read GetHashOfDefaultData write SetHashOfDefaultData;
    property HashOfOnetoNine: string read GetHashOfOnetoNine write SetHashOfOnetoNine;
...
type
  ...
  var
    ...
    procedure SetHashOfDefaultDataWithMaxUInt32AsKey(const AValue: string); inline;

  strict protected
    property HashOfDefaultDataWithMaxUInt32AsKey: string read GetHashOfDefaultDataWithMaxUInt32AsKey write SetHashOfDefaultDataWithMaxUInt32AsKey;
  published
...
type
  ...
  var
    ...
    procedure SetHashOfDefaultDataWithMaxUInt64AsKey(const AValue: string); inline;

  strict protected
    property HashOfDefaultDataWithMaxUInt64AsKey: string read GetHashOfDefaultDataWithMaxUInt64AsKey write SetHashOfDefaultDataWithMaxUInt64AsKey;
  published
...
type
  ...
  strict protected
    property HashOfDefaultDataWithExternalKey: string read GetHashOfDefaultDataWithExternalKey write SetHashOfDefaultDataWithExternalKey;
  published
...
type
  ...
  var
    FHMACInstance: IHMAC;
    FHashOfDefaultDataHMACWithShortKey, FHashOfDefaultDataHMACWithLongKey: string;

    function GetHashOfDefaultDataHMACWithShortKey: string; inline;
    function GetHashOfDefaultDataHMACWithLongKey: string; inline;
    procedure SetHashOfDefaultDataHMACWithShortKey(const AValue: string); inline;
  ...
  strict protected
    property HashOfDefaultDataHMACWithShortKey: string read GetHashOfDefaultDataHMACWithShortKey write SetHashOfDefaultDataHMACWithShortKey;

    property HashOfDefaultDataHMACWithLongKey: string read GetHashOfDefaultDataHMACWithLongKey write SetHashOfDefaultDataHMACWithLongKey;
...
type
  ...
  strict protected
    ...
    property HashInstanceWithKey: IHash read GetHashInstanceWithKey write SetHashInstanceWithKey;
...
type
  ...
  strict protected
    property UnkeyedTestVectors: THashLibStringArray read GetUnkeyedTestVectors write SetUnkeyedTestVectors;
    property KeyedTestVectors: THashLibStringArray read GetKeyedTestVectors write SetKeyedTestVectors;
...
type
  ...
  strict protected
    property XofOfEmptyData: string read GetXofOfEmptyData write SetXofOfEmptyData;
...
type
  ...
  var
    ...
    procedure SetXofOfZeroToOneHundredAndNinetyNineInHex(const AValue: string); inline;
  ...
  strict protected
    property XofOfZeroToOneHundredAndNinetyNineInHex: string read GetXofOfZeroToOneHundredAndNinetyNineInHex write SetXofOfZeroToOneHundredAndNinetyNineInHex;

    property XofInstanceShake: IXOF read GetXofInstanceShake write SetXofInstanceShake;

    property XofInstanceTestVector: IXOF read GetXofInstanceTestVector write SetXofInstanceTestVector;
  published
...
procedure TPBKDF2_HMACTestCase.SetPBKDF2_HMACInstance(const AValue: IPBKDF2_HMAC);
begin
...
begin
  ActualString := TConverters.ConvertBytesToHexString(PBKDF2_HMACInstance.GetBytes(ByteCount), False);
...
begin
  ...
  CheckNotEquals(LOriginal.BufferSize, LCopy.BufferSize, Format('Expected %d but got %d.', [LOriginal.BufferSize, LCopy.BufferSize]));
end;
...
begin
  ...
  LChunkedDataBytes := TConverters.ConvertStringToBytes(ChunkedData, TEncoding.UTF8);
...
begin
  LHashInstanceCopy := HashInstance.Clone();
  for LIdx := 0 to System.Pred(System.SizeOf(ChunkSizes) div System.SizeOf(Int32)) do
  begin
    ...
    LTemp := System.Copy(ChunkedData, (LJIdx - LSize) + 1, System.Length(ChunkedData) - ((LJIdx - LSize)));
    HashInstance.TransformString(LTemp, TEncoding.UTF8);

    ActualString := HashInstance.TransformFinal().ToString();
    ExpectedString := LHashInstanceCopy.ComputeString(ChunkedData, TEncoding.UTF8).ToString();
    CheckEquals(ExpectedString, ActualString, Format('Expected %s but got %s.', [ExpectedString, ActualString]));
  end;
end;
...
begin
  ...
  ActualString := HashInstance.ComputeString(DefaultData, TEncoding.UTF8).ToString();
  CheckEquals(ExpectedString, ActualString, Format('Expected %s but got %s.', [ExpectedString, ActualString]));
end;
...
begin
  ExpectedString := HashOfEmptyData;
  ActualString := HashInstance.ComputeString(EmptyData, TEncoding.UTF8).ToString();
  CheckEquals(ExpectedString, ActualString, Format('Expected %s but got %s.', [ExpectedString, ActualString]));
end;
...
begin
  ...
  ActualString := HashInstance.ComputeString(OneToNine, TEncoding.UTF8).ToString();
  CheckEquals(ExpectedString, ActualString, Format('Expected %s but got %s.', [ExpectedString, ActualString]));
end;
...
begin
  ...
  LResultB := HashInstance.ComputeUntyped(BytesABCDE, System.SizeOf(BytesABCDE)).GetBytes();
  CheckTrue(AreEqual(LResultA, LResultB), 'Computation Mismatch In Untyped Interface');
end;

{ THashWithUInt32AsKeyAlgorithmTestCase }

function THashWithUInt32AsKeyAlgorithmTestCase.GetHashOfDefaultDataWithMaxUInt32AsKey: string;
begin
  Result := FHashOfDefaultDataWithMaxUInt32AsKey;
end;

procedure THashWithUInt32AsKeyAlgorithmTestCase.SetHashOfDefaultDataWithMaxUInt32AsKey(const AValue: string);
begin
...
begin
  ...
  ActualString := LIHashWithKey.ComputeString(DefaultData, TEncoding.UTF8).ToString();
  CheckEquals(ExpectedString, ActualString, Format('Expected %s but got %s.', [ExpectedString, ActualString]));
end;

{ THashWithUInt64AsKeyAlgorithmTestCase }

function THashWithUInt64AsKeyAlgorithmTestCase.GetHashOfDefaultDataWithMaxUInt64AsKey: string;
begin
  Result := FHashOfDefaultDataWithMaxUInt64AsKey;
end;

procedure THashWithUInt64AsKeyAlgorithmTestCase.SetHashOfDefaultDataWithMaxUInt64AsKey(const AValue: string);
begin
...
function THashWithExternalKeyAlgorithmTestCase.GetHashOfDefaultDataWithExternalKey: string;
begin
  Result := FHashOfDefaultDataWithExternalKey;
end;

procedure THashWithExternalKeyAlgorithmTestCase.SetHashOfDefaultDataWithExternalKey(const AValue: string);
begin
...
procedure TCryptoAlgorithmTestCase.SetHashOfDefaultDataHMACWithLongKey(const AValue: string);
begin
  FHashOfDefaultDataHMACWithLongKey := AValue;
end;

procedure TCryptoAlgorithmTestCase.SetHashOfDefaultDataHMACWithShortKey(const AValue: string);
begin
...
begin
  ...
  HMACInstance.Key := TConverters.ConvertStringToBytes(HMACShortStringKey, TEncoding.UTF8);
  ActualString := HMACInstance.ComputeString(DefaultData, TEncoding.UTF8).ToString();
  CheckEquals(ExpectedString, ActualString, Format('Expected %s but got %s.', [ExpectedString, ActualString]));
end;
...
begin
  ...
  HMACInstance.Key := TConverters.ConvertStringToBytes(HMACLongStringKey, TEncoding.UTF8);
  ActualString := HMACInstance.ComputeString(DefaultData, TEncoding.UTF8).ToString();
  CheckEquals(ExpectedString, ActualString, Format('Expected %s but got %s.', [ExpectedString, ActualString]));
end;
...
begin
  ...
  (LOriginal as IHMAC).Key := TConverters.ConvertStringToBytes(HMACLongStringKey, TEncoding.UTF8);
  LOriginal.Initialize;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        CheckEquals(LHash0, LHash1, Format('Expected %s but got %s.', [LHash0, LHash1]));
      end;
    end;
...
procedure TKeyedCryptoAlgorithmTestCase.SetHashInstanceWithKey(const AValue: IHash);
begin
...
function TBlakeCryptoAlgorithmTestCase.GetUnkeyedTestVectors: THashLibStringArray;
begin
  Result := FUnkeyedTestVectors;
end;

procedure TBlakeCryptoAlgorithmTestCase.SetKeyedTestVectors(const AValue: THashLibStringArray);
begin
  FKeyedTestVectors := AValue;
end;

procedure TBlakeCryptoAlgorithmTestCase.SetUnkeyedTestVectors(const AValue: THashLibStringArray);
begin
...
var
  ...
  LInput: TBytes;
begin
  for LIdx := System.Low(UnkeyedTestVectors) to System.High(UnkeyedTestVectors) do
  begin
...
begin
  ActualString := XofInstance.ComputeString(EmptyData, TEncoding.UTF8).ToString();
...
begin
  ...
  LExpectedChunk := System.Copy(TConverters.ConvertHexStringToBytes(XofOfEmptyData), 0, 250);

  CheckTrue(AreEqual(LActualChunk, LExpectedChunk), Format('%s Streaming Test 1 Mismatch', [XofInstance.Name]));

  XofInstance.DoOutput(LTempResult, 250, 250);

  LActualChunk := System.Copy(LTempResult, 250, 250);
  LExpectedChunk := System.Copy(TConverters.ConvertHexStringToBytes(XofOfEmptyData), 250, 250);

  CheckTrue(AreEqual(LActualChunk, LExpectedChunk), Format('%s Streaming Test 2 Mismatch', [XofInstance.Name]));

  XofInstance.DoOutput(LTempResult, 500, 250);

  LActualChunk := System.Copy(LTempResult, 500, 250);
  LExpectedChunk := System.Copy(TConverters.ConvertHexStringToBytes(XofOfEmptyData), 500, 250);

  CheckTrue(AreEqual(LActualChunk, LExpectedChunk), Format('%s Streaming Test 3 Mismatch', [XofInstance.Name]));

  XofInstance.DoOutput(LTempResult, 750, 250);

  LActualChunk := System.Copy(LTempResult, 750, 250);
  LExpectedChunk := System.Copy(TConverters.ConvertHexStringToBytes(XofOfEmptyData), 750, 250);

  CheckTrue(AreEqual(LActualChunk, LExpectedChunk), Format('%s Streaming Test 4 Mismatch', [XofInstance.Name]));
  ...
  CheckTrue(AreEqual(LActualChunk, LExpectedChunk), Format('%s Streaming Initialization Test Fail', [XofInstance.Name]));
end;
...
function TCShakeAlgorithmTestCase.GetXofOfZeroToOneHundredAndNinetyNineInHex: string;
begin
...
procedure TCShakeAlgorithmTestCase.SetXofOfZeroToOneHundredAndNinetyNineInHex(const AValue: string);
begin
  FXofOfZeroToOneHundredAndNinetyNineInHex := AValue;
end;

function TCShakeAlgorithmTestCase.ComputeCShake(const ACShake: IHash; const AMsg: TBytes): string;
begin
  ACShake.Initialize;
...
var
  LData: TBytes;
begin
  ExpectedString := XofInstance.ComputeString(EmptyData, TEncoding.UTF8).ToString();
  ActualString := XofInstanceShake.ComputeString(EmptyData, TEncoding.UTF8).ToString();
  CheckEquals(ExpectedString, ActualString, Format('Expected %s but got %s.', [ExpectedString, ActualString]));
...
begin
  ActualString := ComputeCShake(XofInstanceTestVector, TConverters.ConvertHexStringToBytes(ZeroToOneHundredAndNinetyNineInHex));
