...
resourcestring
  SInvalidValueForSecP384R1FieldElement = 'Value Invalid for SecP384R1FieldElement "%s"';
...
type
  TSecP384R1FieldElement = class(TAbstractFpFieldElement, ISecP384R1FieldElement)

  strict private

    function Equals(const other: ISecP384R1FieldElement): Boolean; reintroduce; overload;
...
type
  ...
  type
    TSecP384R1LookupTable = class sealed(TAbstractECLookupTable, ISecP384R1LookupTable)
    ...
    public
      ...
      constructor Create(const outer: ISecP384R1Curve; const table: TCryptoLibUInt32Array; size: Int32);
...
begin
  FP := TCryptoLibUInt32Array.Create($FFFFFFFF, $00000000, $00000000, $FFFFFFFF, $FFFFFFFE, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF);
  FPExt := TCryptoLibUInt32Array.Create($00000001, $FFFFFFFE, $00000000, $00000002, $00000000, $FFFFFFFE, $00000000, $00000002, $00000001, $00000000, $00000000, $00000000, $FFFFFFFE, $00000001, $00000000, $FFFFFFFE, $FFFFFFFD, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF,
    $FFFFFFFF);
  FPExtInv := TCryptoLibUInt32Array.Create($FFFFFFFF, $00000001, $FFFFFFFF, $FFFFFFFD, $FFFFFFFF, $00000001, $FFFFFFFF, $FFFFFFFD, $FFFFFFFE, $FFFFFFFF, $FFFFFFFF, $FFFFFFFF, $00000001, $FFFFFFFE, $FFFFFFFF, $00000001, $00000002);
end;
...
class function TSecP384R1Field.FromBigInteger(const x: TBigInteger): TCryptoLibUInt32Array;
var
...
class procedure TSecP384R1Field.Reduce32(x: UInt32; const z: TCryptoLibUInt32Array);
var
  cc, xx12: Int64;
begin
  cc := 0;
...
{$ENDIF DEBUG}
  ...
  if (((cc <> 0) and (TNat.IncAt(12, z, 5) <> 0)) or ((z[11] = P11) and (TNat.Gte(12, z, FP)))) then
  begin
    AddPInvTo(z);
  end;
end;
...
const
  n: Int64 = 1;
var
  cc, xx16, xx17, xx18, xx19, xx20, xx21, xx22, xx23, t0, t1, t2, t3, t4, t5, t6, t7: Int64;
...
class procedure TSecP384R1Field.SquareN(const x: TCryptoLibUInt32Array; n: Int32; const z: TCryptoLibUInt32Array);
var
  tt: TCryptoLibUInt32Array;
begin
{$IFDEF DEBUG}
...
class procedure TSecP384R1Field.SubtractExt(const xx, yy, zz: TCryptoLibUInt32Array);
var
  c: Int32;
begin
...
begin
  result := TBigInteger.Create(1, THex.Decode('FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFF'));
end;
...
begin
  ...
  begin
    raise EArgumentCryptoLibException.CreateResFmt(@SInvalidValueForSecP384R1FieldElement, ['x']);
  end;
  inherited Create();
...
function TSecP384R1FieldElement.Subtract(const b: IECFieldElement): IECFieldElement;
var
  z: TCryptoLibUInt32Array;
begin
  z := TNat.Create(12);
...
function TSecP384R1FieldElement.Multiply(const b: IECFieldElement): IECFieldElement;
var
  z: TCryptoLibUInt32Array;
begin
  z := TNat.Create(12);
...
function TSecP384R1FieldElement.Divide(const b: IECFieldElement): IECFieldElement;
var
  z: TCryptoLibUInt32Array;
begin
  z := TNat.Create(12);
...
function TSecP384R1FieldElement.Equals(const other: ISecP384R1FieldElement): Boolean;
begin
...
constructor TSecP384R1Point.Create(const curve: IECCurve; const x, y: IECFieldElement);
begin
  Create(curve, x, y, false);
end;

constructor TSecP384R1Point.Create(const curve: IECCurve; const x, y: IECFieldElement; withCompression: Boolean);
begin
...
constructor TSecP384R1Point.Create(const curve: IECCurve; const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean);
begin
...
begin
  ...
  result := TSecP384R1Point.Create(Lcurve, X3, Y3, zs, IsCompressed) as IECPoint;
end;
...
begin
  ...
  result := TSecP384R1Point.Create(curve, RawXCoord, RawYCoord.Negate(), RawZCoords, IsCompressed) as IECPoint;
end;
...
begin
  ...
  result := TSecP384R1Point.Create(Lcurve, X3, Y3, TCryptoLibGenericArray<IECFieldElement>.Create(Z3), IsCompressed) as IECPoint;
end;
...
begin
  ...
  Fm_a := FromBigInteger(TBigInteger.Create(1, THex.Decode('FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFC')));
  Fm_b := FromBigInteger(TBigInteger.Create(1, THex.Decode('B3312FA7E23EE7E4988E056BE3F82D19181D9C6EFE8141120314088F5013875AC656398D8A2ED19D2A85C8EDD3EC2AEF')));
  Fm_order := TBigInteger.Create(1, THex.Decode('FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC7634D81F4372DDF581A0DB248B0A77AECEC196ACCC52973'));
...
function TSecP384R1Curve.CreateCacheSafeLookupTable(const points: TCryptoLibGenericArray<IECPoint>; off, len: Int32): IECLookupTable;
var
...
begin
  ...
  begin
    P := points[off + i];
    TNat.Copy(SECP384R1_FE_INTS, (P.RawXCoord as ISecP384R1FieldElement).x, 0, table, pos);
    pos := pos + SECP384R1_FE_INTS;
    TNat.Copy(SECP384R1_FE_INTS, (P.RawYCoord as ISecP384R1FieldElement).x, 0, table, pos);
    pos := pos + SECP384R1_FE_INTS;
  end;
...
function TSecP384R1Curve.CreateRawPoint(const x, y: IECFieldElement; withCompression: Boolean): IECPoint;
begin
  result := TSecP384R1Point.Create(Self as IECCurve, x, y, withCompression);
end;

function TSecP384R1Curve.CreateRawPoint(const x, y: IECFieldElement; const zs: TCryptoLibGenericArray<IECFieldElement>; withCompression: Boolean): IECPoint;
begin
...
constructor TSecP384R1Curve.TSecP384R1LookupTable.Create(const outer: ISecP384R1Curve; const table: TCryptoLibUInt32Array; size: Int32);
begin
  inherited Create();
  Fm_outer := outer;
  Fm_table := table;
...
function TSecP384R1Curve.TSecP384R1LookupTable.CreatePoint(const x, y: TCryptoLibUInt32Array): IECPoint;
var
  XFieldElement, YFieldElement: ISecP384R1FieldElement;
  SECP384R1_AFFINE_ZS: TCryptoLibGenericArray<IECFieldElement>;
begin
  SECP384R1_AFFINE_ZS := TCryptoLibGenericArray<IECFieldElement>.Create(TSecP384R1FieldElement.Create(TBigInteger.One) as ISecP384R1FieldElement);

  XFieldElement := TSecP384R1FieldElement.Create(x);
  YFieldElement := TSecP384R1FieldElement.Create(y);
  result := Fm_outer.CreateRawPoint(XFieldElement, YFieldElement, SECP384R1_AFFINE_ZS, false);
end;
...
function TSecP384R1Curve.TSecP384R1LookupTable.LookupVar(index: Int32): IECPoint;
var
  x, y: TCryptoLibUInt32Array;
  pos, J: Int32;
begin
