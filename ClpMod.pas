...
type
  ...
  strict private
    ...
    class procedure InversionResult(const p: TCryptoLibUInt32Array; ac: Int32; const a: TCryptoLibUInt32Array; const z: TCryptoLibUInt32Array); static; inline;
    class procedure InversionStep(const p, u: TCryptoLibUInt32Array; uLen: Int32; const x: TCryptoLibUInt32Array; var xc: Int32); static;

  public
    class procedure Invert(const p, x, z: TCryptoLibUInt32Array); static;
    class function Random(const p: TCryptoLibUInt32Array): TCryptoLibUInt32Array; static;
    class procedure Add(const p, x, y, z: TCryptoLibUInt32Array); static; inline;
    class procedure Subtract(const p, x, y, z: TCryptoLibUInt32Array); static; inline;
...
class procedure TMod.InversionResult(const p: TCryptoLibUInt32Array; ac: Int32; const a, z: TCryptoLibUInt32Array);
begin
  if (ac < 0) then
  begin
...
class procedure TMod.InversionStep(const p, u: TCryptoLibUInt32Array; uLen: Int32; const x: TCryptoLibUInt32Array; var xc: Int32);
var
...
class function TMod.Random(const p: TCryptoLibUInt32Array): TCryptoLibUInt32Array;
var
  len: Int32;
  m: UInt32;
