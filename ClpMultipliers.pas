...
type
  TAbstractECMultiplier = class abstract(TInterfacedObject, IAbstractECMultiplier, IECMultiplier)

  strict protected

    function CheckResult(const p: IECPoint): IECPoint; virtual;
    function MultiplyPositive(const p: IECPoint; const k: TBigInteger): IECPoint; virtual; abstract;

  public

    constructor Create();
    function Multiply(const p: IECPoint; const k: TBigInteger): IECPoint; virtual;

  end;

type
  TFixedPointCombMultiplier = class sealed(TAbstractECMultiplier, IFixedPointCombMultiplier)

  strict protected
    function MultiplyPositive(const p: IECPoint; const k: TBigInteger): IECPoint; override;
...
type
  ...
  public
    constructor Create(const curve: IECCurve; const glvEndomorphism: IGlvEndomorphism);
...
type
  ...
  type
    TWTauNafCallback = class(TInterfacedObject, IPreCompCallback, IWTauNafCallback)
  ...
  const
    ...
    // */
    function MultiplyWTnaf(const p: IAbstractF2mPoint; const lambda: IZTauElement; a, mu: ShortInt): IAbstractF2mPoint; inline;
    ...
    // */
    class function MultiplyFromWTnaf(const p: IAbstractF2mPoint; const u: TCryptoLibShortIntArray): IAbstractF2mPoint; static;
  ...
  strict protected
    ...
    // */
    function MultiplyPositive(const point: IECPoint; const k: TBigInteger): IECPoint; override;
...
function TAbstractECMultiplier.Multiply(const p: IECPoint; const k: TBigInteger): IECPoint;
var
  positive: IECPoint;
  sign: Int32;
begin
...
function TFixedPointCombMultiplier.MultiplyPositive(const p: IECPoint; const k: TBigInteger): IECPoint;
var
  c: IECCurve;
  R, add: IECPoint;
...
constructor TGlvMultiplier.Create(const curve: IECCurve; const glvEndomorphism: IGlvEndomorphism);
begin
  inherited Create();
...
function TGlvMultiplier.MultiplyPositive(const p: IECPoint; const k: TBigInteger): IECPoint;
var
  n, a, b: TBigInteger;
...
function TWNafL2RMultiplier.MultiplyPositive(const p: IECPoint; const k: TBigInteger): IECPoint;
var
  width, minWidth, i, wi, digit, zeroes, n, highest, scale, lowBits, i1, i2: Int32;
...
class function TWTauNafMultiplier.MultiplyFromWTnaf(const p: IAbstractF2mPoint; const u: TCryptoLibShortIntArray): IAbstractF2mPoint;
var
...
begin
  ...
  pre := curve.Precompute(p, PRECOMP_NAME, TWTauNafCallback.Create(p, a) as IWTauNafCallback) as IWTauNafPreCompInfo;
...
function TWTauNafMultiplier.MultiplyWTnaf(const p: IAbstractF2mPoint; const lambda: IZTauElement; a, mu: ShortInt): IAbstractF2mPoint;
var
...
begin
  ...
  u := TTnaf.TauAdicWNaf(mu, lambda, TTnaf.width, TBigInteger.ValueOf(TTnaf.Pow2Width), tw, alpha);

  result := MultiplyFromWTnaf(p, u);
end;

function TWTauNafMultiplier.MultiplyPositive(const point: IECPoint; const k: TBigInteger): IECPoint;
var
  p: IAbstractF2mPoint;
  curve: IAbstractF2mCurve;
  m: Int32;
...
constructor TWTauNafMultiplier.TWTauNafCallback.Create(const p: IAbstractF2mPoint; a: ShortInt);
begin
  inherited Create();
  Fm_p := p;
  Fm_a := a;
...
function TWTauNafMultiplier.TWTauNafCallback.Precompute(const existing: IPreCompInfo): IPreCompInfo;
var
